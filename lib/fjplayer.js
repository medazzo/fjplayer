...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AdsManager = __webpack_require__(12);
	...
	function Player(fjID, videoContainerId, playerexpandScreen) {
	    ...
	    this.AdsMgr = new _AdsManager2.default(this, this.video, document.getElementById(this.adsContainerDivId));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Overlays.prototype.StartOverlay = function (self, index) {
	    ...
	    self.OverlayClosingDiv.innerHTML = '<i onmouseover=\"this.style.opacity = 1;\" ' + 'onmouseout=\"this.style.opacity = 0.5\" style=\"padding-left: -5px;cursor: pointer; opacity: 0.5;' + ' float: right; margin: -5px -10px 10px 10px;\" class="fa fa-2x fa-times" ' + 'aria-hidden="true"></i><div style=\"color: rgb(119, 255, 119); font-size: ' + '0.95em; float: right; text-decoration: none;\">Annonce</div>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	AdsManager.prototype.StopAds = function (self, index, adsType) {
	    ...
	    self.logger.info(index, 'stopping  Ads ', item[Const.FJCONFIG_URL], ' @@ ', item[Const.FJCONFIG_SHOW_AT]);
	    // remove the click event
	...
	AdsManager.prototype.StartAds = function (self, index, adsType) {
	    ...
	    if (adsType === self.AdsEnum.PRE) {
	        ...
	        item = self.midAds[index];
	        self.logger.info(index, 'starting MId Ads ', item[Const.FJCONFIG_SRC], ' @@ ', item[Const.FJCONFIG_SHOW_AT]);
	    } else {
	        item = self.postAds[index];
	    ...
	    adsvideo.addEventListener('timeupdate', function (e) {
	        if (item[Const.FJCONFIG_CAN_ESCAPE] === 'true' || item[Const.FJCONFIG_CAN_ESCAPE] === true) {
	            ...
	            infoDiv2.innerHTML = ', it ends after ' + self.player.duration(Math.round(adsvideo.duration - adsvideo.currentTime)) + ' .';
	        }
	    });
