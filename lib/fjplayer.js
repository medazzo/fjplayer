...
/***/ function(module, exports, __webpack_require__) {
	...
	Player.prototype.setUi = function () {
	    ...
	    inHtml = '<figure id=\"' + this.videoFigureId + '\" class=\"fjOvcontainer\" data-fullscreen=\"' + this.fullScreenOnStart + '\">' + '<video id=\"' + this.videoId + '\" class=\"divofVideo\" ';
	    if (this.vwidth != null) {
