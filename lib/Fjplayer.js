...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AudsMenu = __webpack_require__(5);
	
	var _AudsMenu2 = _interopRequireDefault(_AudsMenu);
	...
	function Player(fjID, videoContainerId, playerexpandScreen) {
	    ...
	    // create hidden menus
	    this.AudiosMenu = new _AudsMenu2.default(this.video, this.id, this.audMenuContainerDivId);
	    this.SubsMenu = new _SubsMenu2.default(this.video, this.id, this.subsdMenuContainerDivId);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	AudsMenu.prototype.Setup = function (AudsbuttonDivID) {
	    ...
	    this.SubsbuttonDiv.innerHTML = '<span id=\"' + this.audsBtnId + '\"  ' + '  class=\"fa fa-language\" title=\"audios\" ></span>';
	    ...
	    this.audMenuDiv.innerHTML = '<div class=\"settingMenuSubMenuLeft\" >' + '<ul class=\"subtitles-menu\" id=\"' + self.audMenuListId + '\" >' + '</ul>	' + '</div>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	SubsMenu.prototype.Setup = function (SubsbuttonDivID) {
	    ...
	    this.SubsbuttonDiv.innerHTML = '<span id=\"' + this.subtitlesBtnId + '\"  ' + 'class=\"fa fa-audio-description\" title=\"subtitles\" ></span>';
