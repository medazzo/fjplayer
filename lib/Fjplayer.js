...
/***/ function(module, exports, __webpack_require__) {
	...
	function Player(fjID, videoContainerId, playerexpandScreen) {
	    ...
	    this.OverlaysMgr = new _Overlays2.default(this.video, document.getElementById(this.overlayContainerDivId));
	};
