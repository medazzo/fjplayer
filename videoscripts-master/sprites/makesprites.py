...
THUMB_RATE_SECONDS=11 # every Nth second take a snapshot
THUMB_WIDTH=160 #100-150 is width recommended by JWPlayer; I like smaller files
...
SPRITE_NAME = "thumbs.jpg" #jpg is much smaller than png, so using jpg
