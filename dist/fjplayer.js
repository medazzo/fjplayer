...
*/
(function () {
  var innerGlobal = typeof window != "undefined" ? window : __webpack_require__.g;
  var exportTo = {};
  (function (window, global, module) {
    ...
    */
    ...
    function ra(a, b) {
      ...
      if (pa) pa(a, b);else for (var c in b) {
    ...
    function ya(a, b) {
      var c = a.v.splice(0)[0];
      (c = a.c = a.c || c) ? c.Wd ? a.a = a.h || a.f : void 0 != c.m && a.f < c.m ? (a.a = c.m, a.c = null) : a.a = a.f : a.a = b;
    }
    ...
    function Ba(a, b, c, d) {
      try {
        ...
        return a.a.g = null, ua(a.a, g), Ca(a);
      }
    ...
    function Ea(a) {
      this.next = function (b) {
        ta(a.a);
        a.a.g ? b = Ba(a, a.a.g.next, b, a.a.l) : (a.a.l(b), b = Ca(a));
        return b;
      };

      this["throw"] = function (b) {
        ta(a.a);
        a.a.g ? b = Ba(a, a.a.g["throw"], b, a.a.l) : (ua(a.a, b), b = Ca(a));
        return b;
      };
    ...
    fa("Promise", function (a) {
      ...
      b.prototype.D = function (g) {
        if (g === this) this.g(new TypeError("A Promise cannot resolve to itself"));else if (g instanceof b) this.J(g);else {
          a: switch (_typeof(g)) {
            case "object":
              var h = null != g;
              break a;
      ...
      b.prototype.C = function (g) {
        ...
        "function" == typeof h ? this.M(h, g) : this.h(g);
      };
      ...
      b.all = function (g) {
        ...
        return k.done ? d([]) : new b(function (l, m) {
          ...
          do {
            p.push(void 0), r++, d(k.value).nc(n(p.length - 1), m), k = h.next();
          } while (!k.done);
        });
      };
    ...
    fa("WeakMap", function (a) {
      ...
      b.prototype["delete"] = function (k) {
        return d(k) && Ha(k, g) && Ha(k[g], this.a) ? delete k[g][this.a] : !1;
      };
    ...
    fa("Map", function (a) {
      ...
      function d(h, k) {
        ...
        var m = h.b[l];
        if (m && Ha(h.b, l)) for (var n = 0; n < m.length; n++) {
          var p = m[n];
      ...
      e.prototype.set = function (h, k) {
        ...
        l.aa ? l.aa.value = k : (l.aa = {
          ...
          key: h,
          value: k
        }, l.list.push(l.aa), this.a.Oa.next = l.aa, this.a.Oa = l.aa, this.size++);
        return this;
      };

      e.prototype["delete"] = function (h) {
        h = d(this, h);
        return h.aa && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.b[h.id], h.aa.Oa.next = h.aa.next, h.aa.next.Oa = h.aa.Oa, h.aa.head = null, this.size--, !0) : !1;
      };
    ...
    */
    ...
    Ra.prototype.getBandwidthEstimate = function (a) {
      return 128E3 > this.a ? a : Math.min(Qa(this.b), Qa(this.c));
    };
    ...
    function Va(a, b) {
      ...
      Wa.has(a) || (Wa.add(a), Ua.apply(Sa, ia(c)));
    }
    ...
    if (window.console && window.console.log.bind) {
      var db = {},
          eb = (db[1] = console.error.bind(console), db[2] = console.warn.bind(console), db[3] = console.info.bind(console), db[4] = console.log.bind(console), db[5] = console.debug.bind(console), db[6] = console.debug.bind(console), db);
      Ua = eb[2];
      Ta = eb[1];
    }
    ...
    var ib = function hb(a) {
      ...
      return Fa(hb, function (d) {
        1 == d.a && (c = 0);
        if (3 != d.a) return c < a ? v(d, c, 3) : d.m(0);
        c++;
        return d.m(2);
      });
    },
        lb = function kb(a) {
      var c, d, e, f, g, h;
      return Fa(kb, function (k) {
        1 == k.a && (c = -1, e = d = void 0, f = t(a), g = f.next());

        if (5 != k.a) {
          if (g.done) return -1 == c ? k.m(0) : v(k, {
            ba: c,
            nf: d,
            item: e,
            next: void 0
    ...
    function nb(a, b) {
      ...
      if (ob(a) == ob(b) && (a.byteOffset || 0) == (b.byteOffset || 0)) return !0;

      for (var c = pb(a), d = pb(b), e = t(ib(a.byteLength)), f = e.next(); !f.done; f = e.next()) {
    ...
    function sb(a, b, c, d) {
      ...
      return new d(ob(a), b, Math.min(b + Math.max(c, 0), e) - b);
    }

    K("shaka.util.BufferUtils", mb);
    mb.toDataView = tb;
    mb.toUint8 = pb;
    mb.toArrayBuffer = rb;
    mb.equal = nb;
    ...
    function Cb(a, b) {
      for (var c = new ArrayBuffer(2 * a.length), d = new DataView(c), e = t(lb(a)), f = e.next(); !f.done; f = e.next()) {
        f = f.value, d.setUint16(2 * f.ba, f.item.charCodeAt(0), b);
      }

      return c;
    }

    K("shaka.util.StringUtils", vb);
    ...
    var yb = new ub(function () {
      ...
      for (var b = {
        ...
        if (a(b.Qa)) return function (c) {
          return function (d) {
            for (var e = "", f = 0; f < d.length; f += c.Qa) {
              e += String.fromCharCode.apply(null, d.subarray(f, f + c.Qa));
            }
    ...
    q.ha = function () {
      return this.a < this.P.byteLength;
    };
    ...
    q.Me = function () {
      return this.P.byteLength;
    };

    q.V = function () {
      try {
        var a = this.P.getUint8(this.a);
        this.a += 1;
        return a;
      } catch (b) {
        throw Fb();
    ...
    q.Bb = function () {
      try {
        var a = this.P.getUint16(this.a, this.b);
        this.a += 2;
        return a;
      } catch (b) {
        throw Fb();
    ...
    q.I = function () {
      try {
        var a = this.P.getUint32(this.a, this.b);
        this.a += 4;
        return a;
      } catch (b) {
        throw Fb();
    ...
    q.de = function () {
      try {
        var a = this.P.getInt32(this.a, this.b);
        this.a += 4;
        return a;
      } catch (b) {
        throw Fb();
    ...
    q.gb = function () {
      try {
        if (this.b) {
          var a = this.P.getUint32(this.a, !0);
          var b = this.P.getUint32(this.a + 4, !0);
        } else b = this.P.getUint32(this.a, !1), a = this.P.getUint32(this.a + 4, !1);
      } catch (c) {
        throw Fb();
      }
    ...
    q.Va = function (a) {
      if (this.a + a > this.P.byteLength) throw Fb();
      var b = pb(this.P, this.a, a);
      this.a += a;
      return b;
    };
    ...
    q.fe = function (a) {
      if (this.a < a) throw Fb();
      this.a -= a;
    };

    q.seek = function (a) {
      if (0 > a || a > this.P.byteLength) throw Fb();
      this.a = a;
    };

    q.Ub = function () {
      for (var a = this.a; this.ha() && 0 != this.P.getUint8(this.a);) {
        this.a += 1;
      }

      a = pb(this.P, a, this.a - a);
      this.a += 1;
      return wb(a);
    };
    ...
    K("shaka.util.DataViewReader", Db);
    Db.prototype.readTerminatedString = Db.prototype.Ub;
    Db.prototype.seek = Db.prototype.seek;
    Db.prototype.rewind = Db.prototype.fe;
    Db.prototype.skip = Db.prototype.skip;
    Db.prototype.readBytes = Db.prototype.Va;
    Db.prototype.readUint64 = Db.prototype.gb;
    Db.prototype.readInt32 = Db.prototype.de;
    Db.prototype.readUint32 = Db.prototype.I;
    Db.prototype.readUint16 = Db.prototype.Bb;
    Db.prototype.readUint8 = Db.prototype.V;
    Db.prototype.getLength = Db.prototype.Me;
    Db.prototype.getPosition = Db.prototype.Z;
    Db.prototype.hasMoreData = Db.prototype.ha;
    var Eb = 1;
    Db.Endianness = {
      BIG_ENDIAN: 0,
      LITTLE_ENDIAN: Eb
    ...
    q.Bc = function (a, b, c, d) {
      ...
      if (k) {
        var l = null,
            m = null;
        this.c[g] == Tb && (m = b.I(), l = m >>> 24, m &= 16777215);
        g = e + f;
        c && g > b.P.byteLength && (g = b.P.byteLength);
        d && g > b.P.byteLength ? this.a = !0 : (d = g - b.Z(), b = 0 < d ? b.Va(d) : new Uint8Array(0), b = new Db(b, 0), k({
          parser: this,
          partialOkay: c || !1,
          version: l,
          flags: m,
      ...
      } else b.skip(Math.min(e + f - b.Z(), b.P.byteLength - b.Z()));
    };

    function Ub(a) {
      for (var b = Vb(a); a.reader.ha() && !a.parser.a;) {
        a.parser.Bc(a.start + b, a.reader, a.partialOkay);
      }
    }
    ...
    function Wb(a) {
      ...
      for (var d = c.next(); !d.done && (a.parser.Bc(a.start + b, a.reader, a.partialOkay), !a.parser.a); d = c.next()) {
        ;
      }
    }
    ...
    function Xb(a) {
      return function (b) {
        a(b.reader.Va(b.reader.P.byteLength - b.reader.Z()));
      };
    }
    ...
    K("shaka.util.Mp4Parser", Qb);
    Qb.headerSize = Vb;
    Qb.typeToString = Yb;
    Qb.allData = Xb;
    Qb.sampleDescription = Wb;
    Qb.children = Ub;
    Qb.prototype.parseNext = Qb.prototype.Bc;
    Qb.prototype.parse = Qb.prototype.parse;
    Qb.prototype.stop = Qb.prototype.stop;
    Qb.prototype.fullBox = Qb.prototype.S;
    ...
    M.prototype.tickEvery = M.prototype.xa;
    M.prototype.tickAfter = M.prototype.N;
    M.prototype.tickNow = M.prototype.Yb;
    ...
    function fc() {
      return !!navigator.vendor && navigator.vendor.includes("Apple") && !cc();
    }
    ...
    function bc() {
      if (hc) return hc;
      ic || (ic = new M(function () {
        hc = null;
      }));
      (hc = document.getElementsByTagName("video")[0] || document.getElementsByTagName("audio")[0]) || (hc = document.createElement("video"));
      ic.N(1);
      return hc;
    }
    ...
    function mc(a) {
      ...
      for (var c = b.next(); !c.done; c = b.next()) {
        c = c.value, a[c.ba] = c.item.charCodeAt(0);
      }
    ...
    function pc(a) {
      ...
      for (c = b.next(); !c.done; c = b.next()) {
        c = c.value, d.set(pb(c), e), e += c.byteLength;
      }

      return d;
    }

    K("shaka.util.Uint8ArrayUtils", jc);
    jc.concat = pc;
    jc.toHex = oc;
    jc.fromHex = nc;
    jc.fromBase64 = mc;
    ...
    function qc(a) {
      ...
      var d = !1,
          ...
          f = [],
          g = [];
      new Qb().box("moov", c).box("trak", c).box("mdia", c).box("minf", c).box("stbl", c).S("stsd", function (l) {
        e = l;
        f.push(l);
        Wb(l);
      }).S("encv", b).S("enca", b).S("avc1", function (l) {
        g.push({
          box: l,
          $d: 1701733238
        });
      ...
      if (d) return a;
      if (0 == g.length || !e) throw cb(oc(a)), new L(2, 3, 3019);
      g.reverse();

      for (var h = t(g), k = h.next(); !k.done; k = h.next()) {
        k = k.value, a = rc(a, e, k.box, f, k.$d);
      }
    ...
    function rc(a, b, c, d, e) {
      ...
      c = dc("Xbox One") ? c.start : c.start + c.size;
      f = a.subarray(c);
      ...
      for (d = a.next(); !d.done; d = a.next()) {
        d = d.value, tc(e, d.start, d.size + k.byteLength);
      }
    ...
    function Kc(a, b) {
      ...
      for (var c in a) {
        if ("startTime" != c && "endTime" != c && "payload" != c) if ("nestedCues" == c) {
          if (!xc(a.nestedCues, b.nestedCues, Kc)) return !1;
        } else if ("region" == c || "cellResolution" == c) for (var d in a[c]) {
          if (a[c][d] != b[c][d]) return !1;
        } else if (Array.isArray(a[c])) {
          if (!xc(a[c], b[c])) return !1;
    ...
    var zc = "ltr";
    yc.direction = {
      HORIZONTAL_LEFT_TO_RIGHT: zc,
      HORIZONTAL_RIGHT_TO_LEFT: "rtl"
    };
    var Ec = "horizontal-tb";
    yc.writingMode = {
      HORIZONTAL_TOP_TO_BOTTOM: Ec,
      VERTICAL_LEFT_TO_RIGHT: "vertical-lr",
      VERTICAL_RIGHT_TO_LEFT: "vertical-rl"
    };
    var Fc = 0;
    yc.lineInterpretation = {
      LINE_NUMBER: Fc,
      PERCENTAGE: 1
    };
    var Gc = "start",
    ...
    yc.defaultTextBackgroundColor = Pc;
    var Ic = 400;
    yc.fontWeight = {
      NORMAL: Ic,
      BOLD: 700
    ...
    function Ac() {
      ...
      this.viewportAnchorUnits = this.widthUnits = this.heightUnits = Rc;
      this.scroll = Sc;
    }

    K("shaka.text.CueRegion", Ac);
    var Rc = 1;
    Ac.units = {
      PX: 0,
      PERCENTAGE: Rc,
    ...
    function Tc(a, b, c, d, e) {
      ...
      for (var k = h = !1, l = "white", m = "black", n = Uc(d, e, h, k, l, m); f <= g; f++) {
        for (var p = c[f], r = -1, u = -1, x = 0; x < p.length; x++) {
          if (null != p[x] && "" !== p[x].a.trim()) {
            r = x;
            break;
          }
        }
        ...
        if (-1 === r || -1 === u) p = Vc(d, e), a.nestedCues.push(p);else {
          for (; r <= u; r++) {
            if (x = p[r]) {
              var w = x.g,
                  y = x.c,
                  D = x.f,
                  C = x.b;
              if (w != h || y != k || D != l || C != m) n.payload && a.nestedCues.push(n), n = Uc(d, e, w, y, D, C), h = w, k = y, l = D, m = C;
              n.payload += x.a;
            } else n.payload += " ";
          }

          n.payload && a.nestedCues.push(n);
          f !== g && (n = Vc(d, e), a.nestedCues.push(n));
          n = Uc(d, e, h, k, l, m);
        }
      }
    ...
    function ad(a, b) {
      bd(a) && (a.c[a.b][a.a] = new Wc(b, a.D, a.A, a.v, a.C), a.a++);
    }
    ...
    function cd(a, b, c) {
      var d = new yc(a.f, b, "");
      d.textAlign = a.j === dd ? "left" : a.j === ed ? "right" : Dc;
      if (c = Tc(d, "svc" + c, a.c, a.f, b)) a.f = b;
      return c;
    }
    ...
    function gd(a, b) {
      3 === b.type ? (a.a = 2 * (b.value & 63) - 1, a.b = []) : a.b && (0 < a.a && (a.b.push(b), a.a--), 0 === a.a && (a.c.push(new hd(a.b)), a.b = null, a.a = 0));
    }
    ...
    function id(a) {
      if (!a.ha()) throw new L(2, 2, 3E3);
      return a.b[a.a++];
    }

    hd.prototype.skip = function (a) {
    ...
    function kd(a, b, c, d) {
      if (128 <= c && 135 >= c) d = c & 7, a.b[d] && (a.a = a.b[d]);else {
        if (136 === c) {
          c = id(b).value;
          b = null;
          c = t(ld(a, c));
          ...
          for (var e = c.next(); !e.done; e = c.next()) {
            e = a.b[e.value], e.isVisible() && (b = cd(e, d, a.c)), Zc(e);
          }

          return b;
        }

        if (137 === c) for (b = id(b).value, b = t(ld(a, b)), c = b.next(); !c.done; c = b.next()) {
          c = a.b[c.value], c.isVisible() || (c.f = d), c.g = !0;
        } else {
          if (138 === c) {
            c = id(b).value;
            b = null;
            ...
            for (e = c.next(); !e.done; e = c.next()) {
              e = a.b[e.value], e.isVisible() && (b = cd(e, d, a.c)), e.g = !1;
            }
          ...
          if (139 === c) {
            ...
            for (e = c.next(); !e.done; e = c.next()) {
              e = a.b[e.value], e.isVisible() ? b = cd(e, d, a.c) : e.f = d, e.g = !e.g;
            }

            return b;
          }

          if (140 === c) return b = id(b).value, md(a, b, d);
          if (143 === c) return d = md(a, 255, d), nd(a), d;
          if (144 === c) b.skip(1), d = id(b).value, a.a && (a.a.A = 0 < (d & 128), a.a.D = 0 < (d & 64));else if (145 === c) d = id(b).value, c = id(b).value, b.skip(1), a.a && (b = od((c & 48) >> 4, (c & 12) >> 2, c & 3), a.a.C = od((d & 48) >> 4, (d & 12) >> 2, d & 3), a.a.v = b);else if (146 === c) d = id(b).value, b = id(b).value, a.a && (a = a.a, a.b = d & 15, a.a = b & 63);else if (151 === c) b.skip(1), b.skip(1), d = id(b).value, b.skip(1), a.a && (a.a.j = d & 3);else if (152 <= c && 159 >= c) {
            c = (c & 15) - 8;
            e = null !== a.b[c];
            ...
            var g = id(b).value;
            b = id(b).value;
            e && 0 === (b & 7) || (b = a.b[c], b.b = 0, b.a = 0, b.D = !1, b.A = !1, b.C = "white", b.v = "black");
            b = a.b[c];
            b.g = 0 < (d & 32);
            b.l = (f & 15) + 1;
            b.h = (g & 63) + 1;
    ...
    var ld = function pd(a, b) {
      var d, e;
      return Fa(pd, function (f) {
        1 == f.a && (d = 0);
        if (5 != f.a) return 8 > d ? (e = 1 === (b & 1)) && a.b[d] ? v(f, d, 5) : f.m(5) : f.m(0);
        b >>= 1;
        d++;
        return f.m(2);
      });
    ...
    var rd = new Map([[32, " "], [33, "\xA0"], [37, "\u2026"], [42, "\u0160"], [44, "\u0152"], [48, "\u2588"], [49, "\u2018"], [50, "\u2019"], [51, "\u201C"], [52, "\u201D"], [53, "\u2022"], [57, "\u2122"], [58, "\u0161"], [60, "\u0153"], [61, "\u2120"], [63, "\u0178"], [118, "\u215B"], [119, "\u215C"], [120, "\u215D"], [121, "\u215E"], [122, "\u2502"], [123, "\u2510"], [124, "\u2514"], [125, "\u2500"], [126, "\u2518"], [127, "\u250C"]]),
        qd = "black blue green cyan red magenta yellow white".split(" ");
    ...
    function ud(a, b, c) {
      return Tc(new yc(b, c, ""), "CC" + (a.v << 1 | a.l + 1), a.c, b, c);
    }
    ...
    function wd(a, b, c) {
      if (!(32 > c || 127 < c)) {
        ...
        switch (b) {
          case xd:
            d = yd.has(c) ? yd.get(c) : String.fromCharCode(c);
            break;
          ...
          case Dd:
            a.c[a.a].pop(), d = Ed.get(c);
        }

        d && a.c[a.a].push(new Wc(d, a.h, a.f, a.j, a.g));
      }
    }
    ...
    var xd = 0,
        ...
        Bd = 2,
        Dd = 3,
        yd = new Map([[39, "\u2019"], [42, "\xE1"], [92, "\xE9"], [92, "\xE9"], [94, "\xED"], [95, "\xF3"], [96, "\xFA"], [123, "\xE7"], [124, "\xF7"], [125, "\xD1"], [126, "\xF1"], [127, "\u2588"]]),
        Ad = new Map([[48, "\xAE"], [49, "\xB0"], [50, "\xBD"], [51, "\xBF"], [52, "\u2122"], [53, "\xA2"], [54, "\xA3"], [55, "\u266A"], [56, "\xE0"], [57, "\u2800"], [58, "\xE8"], [59, "\xE2"], [60, "\xEA"], [61, "\xEE"], [62, "\xF4"], [63, "\xFB"]]),
        Cd = new Map([[32, "\xC1"], [33, "\xC9"], [34, "\xD3"], [35, "\xDA"], [36, "\xDC"], [37, "\xFC"], [38, "\u2018"], [39, "\xA1"], [40, "*"], [41, "'"], [42, "\u2500"], [43, "\xA9"], [44, "\u2120"], [45, "\xB7"], [46, "\u201C"], [47, "\u201D"], [48, "\xC0"], [49, "\xC2"], [50, "\xC7"], [51, "\xC8"], [52, "\xCA"], [53, "\xCB"], [54, "\xEB"], [55, "\xCE"], [56, "\xCF"], [57, "\xEF"], [58, "\xD4"], [59, "\xD9"], [60, "\xF9"], [61, "\xDB"], [62, "\xAB"], [63, "\xBB"]]),
        Ed = new Map([[32, "\xC3"], [33, "\xE3"], [34, "\xCD"], [35, "\xCC"], [36, "\xEC"], [37, "\xD2"], [38, "\xF2"], [39, "\xD5"], [40, "\xF5"], [41, "{"], [42, "}"], [43, "\\"], [44, "^"], [45, "_"], [46, "|"], [47, "~"], [48, "\xC4"], [49, "\xE4"], [50, "\xD6"], [51, "\xF6"], [52, "\xDF"], [53, "\xA5"], [54, "\xA4"], [55, "\u2502"], [56, "\xC5"], [57, "\xE5"], [58, "\xD8"], [59, "\xF8"], [60, "\u250C"], [61, "\u2510"], [62, "\u2514"], [63, "\u2518"]]);
    ...
    function Id(a, b, c) {
      ...
      var d = a.a,
          e = null;
      a.b !== Jd && a.b !== Kd && (e = ud(d, a.f, c), c = a.c, c.a = 0 < c.b ? c.b : 0, vd(c, 0, 15), c = a.g, c.a = 0 < c.b ? c.b : 0, vd(c, 0, 15), d.a = 15);
      a.b = Jd;
      d.b = b;
      return e;
    }
    ...
    var Hd = 0,
        ...
        Jd = 3,
        Kd = 4,
        Od = "black green blue cyan red yellow magenta black".split(" "),
        Pd = "white green blue cyan red yellow magenta white_italics".split(" ");
    ...
    function Qd() {
      ...
      this.c = new fd();
      this.g = 0;
      this.l = new Map([["CC1", new Gd(0, 0)], ["CC2", new Gd(0, 1)], ["CC3", new Gd(1, 0)], ["CC4", new Gd(1, 1)]]);
      this.j = this.h = 0;
      this.f = new Map();
      Rd(this);
    }
    ...
    function Rd(a) {
      ...
      for (var b = a.next(); !b.done; b = a.next()) {
        b = b.value, b.b = 2, b.a = b.c, b.h = null, td(b.c), td(b.g), td(b.j);
      }
    }
    ...
    function Sd(a) {
      ...
      for (var d = t(a.b), e = d.next(); !e.done; e = d.next()) {
        (e = Td(a, e.value)) && c.push(e);
      }
      ...
      for (e = d.next(); !e.done; e = d.next()) {
        e = Ud(a, e.value), c.push.apply(c, ia(e));
      }
    ...
    function Td(a, b) {
      ...
      if (255 === b.va && 255 === b.La || !b.va && !b.La || !Vd(b.va) || !Vd(b.La)) return 45 <= ++a.g && Rd(a), null;
      a.g = 0;
      b.va &= 127;
      b.La &= 127;
      if (!b.va && !b.La) return null;
      d = null;
      if (16 === (b.va & 112)) a: {
        var e = b.va;
        d = b.La;
        if (c.h === (e << 8 | d)) c.h = null;else if (c.h = e << 8 | d, 16 === (e & 240) && 64 === (d & 192)) {
          ...
          switch (b.La) {
            ...
            case 45:
              e = c.a;
              c.b !== Jd ? e = null : (g = ud(e, c.f, d), h = e.a - e.b + 1, Fd(e, h - 1, h, e.b), vd(e, 0, h - 1), vd(e, e.a, 15 - e.a), c.f = d, e = g);
              break;
            ...
            case 47:
              e = null, c.b !== Kd && (e = ud(c.c, c.f, d)), g = c.g, c.g = c.c, c.c = g, Ld(c), c.f = d;
          }
        ...
        d = null;
      } else e = b.La, wd(c.a, xd, b.va), wd(c.a, xd, e);
      return d;
    }
      ...
      try {
        for (; b.ha();) {
          var d = id(b).value,
              e = (d & 224) >> 5,
              f = d & 31;
          7 === e && 0 != f && (e = id(b).value & 63);

          if (0 != e) {
            a.f.has(e) || a.f.set(e, new jd(e));
            ...
            for (var g = a.f.get(e), h = b.Z(); b.Z() - h < f;) {
              ...
              if (0 <= l && 31 >= l) {
                ...
                if (g.a) {
                  ...
                  switch (l) {
                    case 8:
                      !bd(r) || 0 >= r.a && 0 >= r.b || (0 >= r.a ? (r.a = r.h - 1, r.b--) : r.a--, r.c[r.b][r.a] = null);
                      break;

                    case 13:
                      r.isVisible() && (e = cd(r, p, g.c));

                      if (r.b + 1 >= r.l) {
                        p = r;

                        for (var u = 0, x = 1; 15 > x; x++, u++) {
                          p.c[u] = p.c[x];
                        }
                    ...
                    case 12:
                      r.isVisible() && (e = cd(r, p, g.c)), Zc(r), p = r, p.b = 0, p.a = 0;
                  }

                  var w = e;
                } else w = null;
              } else if (128 <= l && 159 >= l) w = kd(g, e, l, m);else {
                if (4096 <= l && 4127 >= l) p = l & 255, 8 <= p && 15 >= p ? e.skip(1) : 16 <= p && 23 >= p ? e.skip(2) : 24 <= p && 31 >= p && e.skip(3);else if (4224 <= l && 4255 >= l) p = l & 255, 128 <= p && 135 >= p ? e.skip(4) : 136 <= p && 143 >= p && e.skip(5);else if (32 <= l && 127 >= l) e = l, g.a && (127 === e ? ad(g.a, "\u266A") : ad(g.a, String.fromCharCode(e)));else if (160 <= l && 255 >= l) g.a && ad(g.a, String.fromCharCode(l));else if (4128 <= l && 4223 >= l) {
                  if (e = l & 255, g.a) if (rd.has(e)) {
                    var y = rd.get(e);
                    ad(g.a, y);
                  } else ad(g.a, "_");
                } else 4256 <= l && 4351 >= l && g.a && (160 != (l & 255) ? ad(g.a, "_") : ad(g.a, "[CC]"));
                w = null;
              }
        ...
        if (D instanceof L && 3E3 === D.code) Va("CEA708_INVALID_DATA", "Buffer read out of bounds / invalid CEA-708 Data.");else throw D;
      }
    ...
    var Yd = function Xd(a, b) {
      var d, e, f, g;
      return Fa(Xd, function (h) {
        if (1 == h.a) {
        ...
        if (4 != h.a) {
          ...
          g += b[e++];
          return 4 != f ? h.m(4) : v(h, b.subarray(e, e + g), 4);
        }
    ...
    function ce(a, b, c) {
      ...
      for (var f = t(ib(d)), g = f.next(); !g.done; g = f.next()) {
        g = {
          yd: null,
          sampleSize: null,
          Dc: null
        }, c & 256 && (g.yd = a.I()), c & 512 && (g.sampleSize = a.I()), c & 1024 && a.skip(4), c & 2048 && (g.Dc = 0 == b ? a.I() : a.de()), e.push(g);
      }
    ...
    de.prototype.init = function (a) {
      var b = this,
          c = [],
          d = [];
      new Qb().box("moov", Ub).box("mvex", Ub).S("trex", function (e) {
        var f = e.reader;
        f.skip(4);
        f.skip(4);
        e = f.I();
        ...
        b.a = e;
        b.b = f;
      }).box("trak", Ub).S("tkhd", function (e) {
        var f = e.reader;
        1 == e.version ? (f.skip(8), f.skip(8), e = f.gb()) : (f.skip(4), f.skip(4), e = f.I());
        c.push(e);
      }).box("mdia", Ub).S("mdhd", function (e) {
        e = be(e.reader, e.version);
        d.push(e.timescale);
      }).parse(a, !0);
      if (!c.length || !d.length || c.length != d.length) throw new L(2, 2, 2010);
      c.forEach(function (e, f) {
        b.c.set(e, d[f]);
      });
    };

    de.prototype.parse = function (a) {
      var b = this,
          c = [],
          d = this.a,
          e = this.b,
          ...
          g = null,
          h = 9E4;
      new Qb().box("moof", Ub).box("traf", Ub).S("trun", function (k) {
        f = ce(k.reader, k.version, k.flags).ge;
      }).S("tfhd", function (k) {
        k = $d(k.reader, k.flags);
        d = k.Pd || b.a;
        e = k.Ee || b.b;
        k = k.trackId;
        b.c.has(k) && (h = b.c.get(k));
      }).S("tfdt", function (k) {
        g = ae(k.reader, k.version).cd;
      }).box("mdat", function (k) {
        ...
        for (r.length && (x = r[0].sampleSize || p); k.ha();) {
          var w = k.I();

          if (6 == (k.V() & 31)) {
            var y = 0;
            r.length > u && (y = r[u].Dc || 0);
            y = (l + y) / m;

            for (var D = t(Yd(b.f, k.Va(w - 1))), C = D.next(); !C.done; C = D.next()) {
              c.push({
                lf: C.value,
                pts: y
              });
          ...
          x -= w + 4;
          0 == x && (l = r.length > u ? l + (r[u].yd || n) : l + n, u++, x = r.length > u ? r[u].sampleSize || p : p);
        }
      }).parse(a, !1);
      return c;
    };
    ...
    function fe(a, b) {
      ...
      for (var d = c.next(); !d.done; d = c.next()) {
        ...
        if (181 === f.V() && 49 === f.Bb() && 1195456820 === f.I() && 3 === f.V()) {
          var g = f.V();
    ...
    function ie(a, b) {
      ...
      for (var c = 0, d = t(je(a)), e = d.next(); !e.done; e = d.next()) {
        var f = e.value;
        e = f.start;
        f = f.end;
    ...
    function ke(a, b, c) {
      ...
      a = je(a).findIndex(function (d, e, f) {
    ...
    function je(a) {
      ...
      for (var b = [], c = t(ib(a.length)), d = c.next(); !d.done; d = c.next()) {
        d = d.value, b.push({
          start: a.start(d),
          end: a.end(d)
        });
    ...
    */
    ...
    function me(a) {
      var b;
      a instanceof me ? (ne(this, a.Ca), this.jb = a.jb, this.Ba = a.Ba, oe(this, a.Ab), this.sa = a.sa, pe(this, a.a.clone()), this.ab = a.ab) : a && (b = String(a).match(le)) ? (ne(this, b[1] || "", !0), this.jb = qe(b[2] || ""), this.Ba = qe(b[3] || "", !0), oe(this, b[4]), this.sa = qe(b[5] || "", !0), pe(this, b[6] || "", !0), this.ab = qe(b[7] || "")) : this.a = new re(null);
    }
    ...
    q.toString = function () {
      ...
      if (b = this.sa) this.Ba && "/" != b.charAt(0) && a.push("/"), a.push(se(b, "/" == b.charAt(0) ? ue : ve, !0));
      (b = this.a.toString()) && a.push("?", b);
      (b = this.ab) && a.push("#", se(b, we));
      return a.join("");
    };
    ...
    q.resolve = function (a) {
      ...
      c ? ne(b, a.Ca) : c = !!a.jb;
      c ? b.jb = a.jb : c = !!a.Ba;
      c ? b.Ba = a.Ba : c = null != a.Ab;
      var d = a.sa;
      if (c) oe(b, a.Ab);else if (c = !!a.sa) {
        if ("/" != d.charAt(0)) if (this.Ba && !this.sa) d = "/" + d;else {
      ...
      c ? b.sa = d : c = "" !== a.a.toString();
      c ? pe(b, a.a.clone()) : c = !!a.ab;
      c && (b.ab = a.ab);
      return b;
    };
    ...
    function pe(a, b, c) {
      b instanceof re ? a.a = b : (c || (b = se(b, xe)), a.a = new re(b));
    }
    ...
    function se(a, b, c) {
      return null != a ? (a = encodeURI(a).replace(b, ye), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null;
    }
    ...
    q.add = function (a, b) {
      if (!this.pa && (this.pa = {}, this.pc = 0, this.a)) for (var c = this.a.split("&"), d = 0; d < c.length; d++) {
        var e = c[d].indexOf("="),
            f = null;
      ...
      this.a = null;
      (c = this.pa.hasOwnProperty(a) && this.pa[a]) || (this.pa[a] = c = []);
      c.push(b);
      this.pc++;
      return this;
    };
    ...
    q.toString = function () {
      ...
      for (b in this.pa) {
        for (var c = encodeURIComponent(b), d = this.pa[b], e = 0; e < d.length; e++) {
          var f = c;
    ...
    function Ce(a, b) {
      for (var c = t(De[a]), d = c.next(); !d.done; d = c.next()) {
        d = d.value;
    ...
    Ge.prototype.reject = function () {};

    function He() {}

    K("shaka.dependencies", He);
    ...
    He.add = function (a, b) {
      if (!Je[a]) throw Error(a + " is not supported");
      Ie.set(a, b);
    };
    ...
    He.Allowed = Je;
    Ie.set("muxjs", window.muxjs);

    function Ke() {
      var a = this;
      this.j = Ie.get("muxjs");
      this.a = new this.j.mp4.Transmuxer({
      ...
      this.a.on("data", function (b) {
        a.c = b.captions;
        a.g = b.metadata;
        a.h.push(pc(b.initSegment, b.data));
      });
      this.a.on("done", function () {
        var b = {
          data: pc.apply(jc, ia(a.h)),
          captions: a.c,
          metadata: a.g
        };
        a.b.resolve(b);
    ...
    function Le(a, b) {
      if (!Ie.get("muxjs") || !Me(a)) return !1;
      if (b) return MediaSource.isTypeSupported(Ne(b, a));
      var c = Ne("audio", a),
          d = Ne("video", a);
    ...
    function Qe(a, b, c) {
      a = Pe(a, b);
      return Ie.get("muxjs") && Me(a) ? Ne(c, a) : a;
    }

    function Re(a) {
      var b = [a.mimeType];
      Se.forEach(function (c, d) {
        var e = a[d];
        e && b.push(c + '="' + e + '"');
      });
    ...
    var Se = new Map().set("codecs", "codecs").set("frameRate", "framerate").set("bandwidth", "bitrate").set("width", "width").set("height", "height").set("channelsCount", "channels");
    ...
    function Ve(a) {
      return We[a] || "application/cea-608" == a || "application/cea-708" == a ? !0 : !1;
    }
    ...
    function Xe(a, b, c, d) {
      var e, f, g;
      return J(function (h) {
        if (1 == h.a) return v(h, Promise.resolve(), 2);
        if (!a.j || !a.c) return h["return"]();
        if (null == c || null == d) return a.j.parseInit(pb(b)), h["return"]();
        e = {
          periodStart: a.v,
          segmentStart: c,
          segmentEnd: d
        };
        f = a.j.parseMedia(pb(b), e);
    ...
    Ue.prototype.remove = function (a, b) {
      var c = this;
      return J(function (d) {
        if (1 == d.a) return v(d, Promise.resolve(), 2);
        !c.c || !c.c.remove(a, b) || null == c.a || b <= c.a || a >= c.b || (a <= c.a && b >= c.b ? c.a = c.b = null : a <= c.a && b < c.b ? c.a = b : a > c.a && b >= c.b && (c.b = a));
        z(d);
      });
    };
    ...
    function Ze(a, b, c) {
      a.l = b;
      if (b = a.h.get(b)) for (var d = t(b.keys()), e = d.next(); !e.done; e = d.next()) {
    ...
    function $e(a) {
      ...
      for (var c = a.next(); !c.done; c = a.next()) {
        c = c.value, b.push({
          stream: c.stream,
          cue: new yc(c.startTime, c.endTime, c.text)
        });
      }
    ...
    function af(a, b, c, d, e) {
      ...
      for (var h = b.next(); !h.done; h = b.next()) {
        ...
        k.startTime += e;
        k.endTime += e;
        k.startTime >= a.f && k.startTime < a.g && (g.get(h).get(f).push(k), h == a.l && a.c.append([k]));
      }

      e = t(g.keys());

      for (f = e.next(); !f.done; f = e.next()) {
        for (f = f.value, a.h.has(f) || a.h.set(f, new Map()), b = t(g.get(f).keys()), h = b.next(); !h.done; h = b.next()) {
          h = h.value, k = g.get(f).get(h), a.h.get(f).set(h, k);
        }
      }

      a.a = null == a.a ? Math.max(c, a.f) : Math.min(a.a, Math.max(c, a.f));
      a.b = Math.max(a.b, Math.min(d, a.g));
    }

    K("shaka.text.TextEngine", Ue);
    Ue.prototype.destroy = Ue.prototype.destroy;

    Ue.findParser = function (a) {
      return We[a];
    };
    ...
    Ue.registerParser = function (a, b) {
      We[a] = b;
    };
    ...
    df.prototype.remove = function (a, b) {
      a in this.a && (this.a[a] = this.a[a].filter(function (c) {
        return c != b;
    ...
    q.s = function (a, b, c, d) {
      this.a && (a = new gf(a, b, c, d), this.a.push(b, a));
    };

    q.qa = function (a, b, c, d) {
      function e(g) {
        f.ya(a, b, e);
        c(g);
      }
    ...
    q.ya = function (a, b, c) {
      if (this.a) {
        ...
        for (var e = d.next(); !e.done; e = d.next()) {
          e = e.value, e.target != a || c != e.listener && c || (e.ya(), this.a.remove(b, e));
        }
      }
    };
    ...
    K("shaka.util.EventManager", ff);
    ff.prototype.removeAll = ff.prototype.hb;
    ff.prototype.unlisten = ff.prototype.ya;
    ff.prototype.listenOnce = ff.prototype.qa;
    ff.prototype.listen = ff.prototype.s;
    ff.prototype.release = ff.prototype.release;
    ...
    function rf(a) {
      var b = Pe(a.mimeType, a.codecs),
          c = Re(a);
      return Ve(b) || MediaSource.isTypeSupported(c) || Le(b, a.type);
    }
    ...
    function pf(a) {
      ...
      return J(function (l) {
        if (1 == l.a) {
          ...
          for (c in a.g) {
            for (d = a.g[c], e = d[0], a.g[c] = d.slice(0, 1), e && b.push(e.p["catch"](Mb)), f = t(d.slice(1)), g = f.next(); !g.done; g = f.next()) {
    ...
    q.init = function (a, b) {
      var c = this,
          ...
          l;
      return J(function (m) {
        if (1 == m.a) return d = Fe, v(m, c.A, 2);
        e = {};
        f = t(a.keys());
        ...
        for (g = f.next(); !g.done; e = {
          ...
          e.ma = g.value, h = a.get(e.ma), k = Pe(h.mimeType, h.codecs), e.ma == d.$ ? sf(c, k) : (!b && MediaSource.isTypeSupported(k) || !Le(k, e.ma) || (c.l[e.ma] = new Ke(), k = Ne(e.ma, k)), l = c.j.addSourceBuffer(k), c.b.s(l, "error", function (n) {
            return function () {
              c.g[n.ma][0].p.reject(new L(2, 3, 3014, c.a.error ? c.a.error.code : 0));
            };
          }(e)), c.b.s(l, "updateend", function (n) {
            return function () {
              return tf(c, n.ma);
            };
          }(e)), c.f[e.ma] = l, c.D[e.ma] = k, c.g[e.ma] = []);
        }
    ...
    function sf(a, b) {
      a.c || (a.c = new Ue(a.h));
      "application/cea-608" != b && "application/cea-708" != b && (a.c.j = Ob(We[b]));
    }
    ...
    function vf(a, b) {
      if (b == Ee) var c = a.c.a;else c = wf(a, b), c = !c || 1 == c.length && 1E-6 > c.end(0) - c.start(0) ? null : 1 == c.length && 0 > c.start(0) ? 0 : c.length ? c.start(0) : null;
      return c;
    }

    function xf(a, b) {
      return b == Ee ? a.c.b : ge(wf(a, b));
    }

    function yf(a, b, c) {
      if (b == Ee) return a = a.c, null == a.b || a.b < c ? 0 : a.b - Math.max(c, a.a);
      a = wf(a, b);
      return ie(a, c);
    }
    ...
    q.rc = function () {
      var a = {
        total: je(this.a.buffered),
        audio: je(wf(this, "audio")),
        video: je(wf(this, "video")),
        text: []
      };
    ...
    function zf(a, b, c, d, e, f) {
      ...
      return J(function (u) {
        if (1 == u.a) {
          g = Fe;
          if (b == g.$) return v(u, Xe(a.c, c, d, e), 0);
          if (a.l[b]) return v(u, Oe(a.l[b], c), 10);
          if (f) return a.c || sf(a, "text/vtt"), null == d && null == e ? a.v.init(c) : (h = fe(a.v, c), h.length && (k = a.f[g.Ja].timestampOffset, af(a.c, h, d, e, k))), c = Af(a, c, d, b), v(u, Bf(a, b, function () {
            a.f[b].appendBuffer(c);
          }), 0);
          c = Af(a, c, d, b);
          return v(u, Bf(a, b, function () {
            a.f[b].appendBuffer(c);
          }), 0);
        }
        ...
        l = u.b;
        a.c || sf(a, "text/vtt");
        l.metadata && (m = a.f[b].timestampOffset, a.H(l.metadata, m, e));
        l.captions && l.captions.length && (n = a.f[g.Ja].timestampOffset, p = $e(l.captions), af(a.c, p, d, e, n));
        r = l.data;
        r = Af(a, r, d, b);
        return v(u, Bf(a, b, function () {
          a.f[b].appendBuffer(r);
        }), 0);
      });
    }
    ...
    q.remove = function (a, b, c) {
      ...
      return J(function (f) {
        e = Fe;
        return a == e.$ ? v(f, d.c.remove(b, c), 0) : v(f, Bf(d, a, function () {
          c <= b ? tf(d, a) : d.f[a].remove(b, c);
        }), 0);
      });
    };
    ...
    function Ef(a, b) {
      ...
      return J(function (d) {
        c = Fe;
        return b == c.$ ? a.c ? v(d, a.c.remove(0, Infinity), 0) : d["return"]() : v(d, Bf(a, b, function () {
          var e = a.j.duration;
          0 >= e ? tf(a, b) : a.f[b].remove(0, e);
        }), 0);
      });
    }
    ...
    q.flush = function (a) {
      ...
      return J(function (d) {
        c = Fe;
        return a == c.$ ? d["return"]() : v(d, Bf(b, a, function () {
          b.a.currentTime -= .001;
          tf(b, a);
        }), 0);
      });
    ...
    function Ff(a, b, c, d, e) {
      ...
      return J(function (g) {
        f = Fe;
        return b == f.$ ? (a.c.v = c, Ye(a.c, d, e), g["return"]()) : v(g, Promise.all([Bf(a, b, function () {
    ...
    q.endOfStream = function (a) {
      var b = this;
      return J(function (c) {
        return v(c, Gf(b, function () {
          uf(b) || (a ? b.j.endOfStream(a) : b.j.endOfStream());
        }), 0);
      });
    };
          ...
          case 1:
            ...
            for (e in a.f) {
              d.Fb = new Ge(), f = {
                ...
                p: d.Fb
              }, a.g[e].push(f), c.push(d.Fb), 1 == a.g[e].length && f.start(), d = {
                Fb: d.Fb
              };
            }
    ...
    function If(a, b) {
      ...
      if (c) try {
        ...
        "QuotaExceededError" == d.name ? c.p.reject(new L(2, 3, 3017, b)) : c.p.reject(new L(2, 3, 3015, d)), Hf(a, b);
      }
    }

    function Af(a, b, c, d) {
      var e = a.a.mediaKeys;
      null == c && e && (cc() || dc("Xbox One")) && "mp4" == a.D[d].split(";")[0].split("/")[1] && (b = qc(b));
      return b;
    }

    var qf = window.URL.createObjectURL;
    ...
    function Of(a, b) {
      a = Kf(a);
      b = Kf(b);
      return b == a ? 4 : Lf(b, a) ? 3 : Mf(b, a) ? 2 : Lf(a, b) ? 1 : 0;
    }

    function Pf(a) {
      return a.language ? Kf(a.language) : a.audio && a.audio.language ? Kf(a.audio.language) : a.video && a.video.language ? Kf(a.video.language) : "und";
    }

    function Qf(a, b) {
      for (var c = Kf(a), d = new Set(), e = t(b), f = e.next(); !f.done; f = e.next()) {
        d.add(Kf(f.value));
      }
    ...
    function Vf(a) {
      var b = "",
          c = Infinity;
      ef(a, function (d, e) {
        for (var f = 0, g = 0, h = t(e), k = h.next(); !k.done; k = h.next()) {
    ...
    function Wf(a) {
      var b = "";
      a.video && (b = Te(a.video.codecs));
      var c = "";
      a.audio && (c = Te(a.audio.codecs));
      return b + "-" + c;
    }
    ...
    function Zf(a, b, c, d) {
      return J(function (e) {
        if (1 == e.a) return d ? v(e, bg(c, 0 < c.offlineSessionIds.length), 2) : ($f(c, a), ag(c), e.m(2));
        cg(b, c);
        dg(c);
        eg(c);
        z(e);
    ...
    function $f(a, b) {
      a.variants = a.variants.filter(function (c) {
        return b && b.M && !fg(b, c) ? !1 : !0;
      });
    }

    function bg(a, b) {
      return J(function (c) {
        if (1 == c.a) return v(c, gg(a.variants, b), 2);
        a.variants = a.variants.filter(function (d) {
          var e = d.decodingInfos.some(function (f) {
            return f.supported;
          });
          e || Ya(hg(d));
          return e;
    ...
    function gg(a, b) {
      ...
      return J(function (r) {
        ...
        f = function f(u, x) {
          var w;
          return J(function (y) {
            if (1 == y.a) return A(y, 2), v(y, d.decodingInfo(x), 4);
            if (2 != y.a) return w = y.b, u.decodingInfos.push(w), wa(y, 0);
            E(y);
            JSON.stringify(x);
            z(y);
          });
        ...
        for (h = g.next(); !h.done; h = g.next()) {
          for (k = h.value, l = ig(k, b), m = t(l), n = m.next(); !n.done; n = m.next()) {
            p = n.value, e.push(f(k, p));
          }
        }

        return v(r, Promise.all(e), 0);
      });
    }
    ...
    function ig(a, b) {
      ...
      if (d) {
        ...
        f = Qe(d.mimeType, "vp9" == f ? "vp09.00.10.08" : f, "video");
        e.video = {
          contentType: f,
          width: d.width || 1,
          height: d.height || 1,
      ...
      c && (f = "ac-3" == c.codecs.toLowerCase() && cc() ? "ec-3" : c.codecs, f = Qe(c.mimeType, f, "audio"), e.audio = {
        contentType: f,
      ...
      for (var m = t(g.keys()), n = m.next(); !n.done; n = m.next()) {
        ...
        for (k = r.next(); !k.done; k = r.next()) {
          ...
          if (k.initData && k.initData.length) {
            for (var u = new Set(), x = t(k.initData), w = x.next(); !w.done; w = x.next()) {
    ...
    function cg(a, b) {
      b.variants = b.variants.filter(function (c) {
        var d = c.audio;
        c = c.video;
        return d && a && a.audio && !jg(d, a.audio) || c && a && a.video && !jg(c, a.video) ? !1 : !0;
      });
    }

    function dg(a) {
      a.textStreams = a.textStreams.filter(function (b) {
        return Ve(Pe(b.mimeType, b.codecs));
      });
    }
    ...
    function eg(a) {
      a.imageStreams = a.imageStreams.filter(function (b) {
        ...
        (dc("Web0S") || cc() || ec()) && c.push("image/webp");
    ...
    function kg(a) {
      ...
      h = h[0] || null;
      var k = new Set();
      if (b) for (var l = t(b.roles), m = l.next(); !m.done; m = l.next()) {
        k.add(m.value);
      }
      if (c) for (l = t(c.roles), m = l.next(); !m.done; m = l.next()) {
        k.add(m.value);
      }
      a = {
        id: a.id,
    ...
    function tg(a, b, c, d) {
      ...
      if (b) {
        var h = Qf(Kf(b), a.map(function (k) {
          return k.language;
        }));
        h && (e = a.filter(function (k) {
          return Kf(k.language) == h;
        }));
      }
    ...
    function hg(a) {
      var b = [];
      a.audio && b.push(vg(a.audio));
      a.video && b.push(vg(a.video));
      return b.join(", ");
    }
    ...
    q.chooseVariant = function () {
      ...
      for (var d = a.next(); !d.done; d = a.next()) {
        ...
        e = f * (e.next || {
          bandwidth: Infinity
        }).bandwidth / this.i.bandwidthUpgradeTarget;
        b >= f * d.bandwidth / this.i.bandwidthDowngradeTarget && b <= e && (c = d);
      }
    ...
    q.segmentDownloaded = function (a, b) {
      ...
      if (null != this.f && this.c) a: {
        if (!this.j) {
          ...
          this.j = !0;
        } else if (Date.now() - this.f < 1E3 * this.i.switchInterval) break a;
    ...
    function yg(a) {
      ...
      navigator.connection && navigator.connection.downlink && a.i.useNetworkInformation && (b = 1E6 * navigator.connection.downlink);
      return b;
    }
    ...
    zg.prototype.add = function (a) {
      return Ag(this.a, a) ? (this.b.add(a), !0) : !1;
    };
    ...
    function Ag(a, b) {
      ...
      if (!(c = !!a.audio != !!b.audio || !!a.video != !!b.video || a.language != b.language) && (c = a.audio && b.audio)) {
        c = a.audio;
        var d = b.audio;
        c = !((!(!c.channelsCount || !d.channelsCount || 2 < c.channelsCount || 2 < d.channelsCount) || c.channelsCount == d.channelsCount) && Bg(c, d) && Cg(c.roles, d.roles));
      }

      !c && (c = a.video && b.video) && (c = a.video, d = b.video, c = !(Bg(c, d) && Cg(c.roles, d.roles)));
      return c ? !1 : !0;
    }
    ...
    function Bg(a, b) {
      ...
      for (var e = t(ib(c.length)), f = e.next(); !f.done; f = e.next()) {
        if (f = f.value, c[f] != d[f]) return !1;
      }
    ...
    function Dg(a) {
      this.a = a;
      this.b = new Eg(a.language, "", a.audio && a.audio.channelsCount ? a.audio.channelsCount : 0, "");
    }

    Dg.prototype.create = function (a) {
      var b = this,
    ...
    Eg.prototype.create = function (a) {
      var b = [];
      b = Fg(a, this.c);
      ...
      a = Gg(b, this.f);
      a.length && (b = a);
      this.a && (a = Sf(b, this.a), a.length && (b = a));
      this.b && (a = Hg(b, this.b), a.length && (b = a));
      a = new zg(b[0]);
      b = t(b);

      for (c = b.next(); !c.done; c = b.next()) {
        c = c.value, Ag(a.a, c) && a.add(c);
      }
    ...
    function Ig() {
      this.a = Jg;
      this.b = new Map().set(Jg, 2).set(Kg, 1);
    }

    function Lg(a, b, c) {
      a.b.set(Jg, c).set(Kg, b);
    }
    ...
    function Og(a) {
      ...
      return J(function (d) {
        if (1 == d.a) {
          if (a.a >= a.j) if (a.c) a.a = 1, a.b = a.f;else throw new L(2, 7, 1010);
          b = a.a;
          a.a++;
    ...
    function Qg(a) {
      return new Pg(Promise.reject(a), function () {
        return Promise.resolve();
      });
    }
    ...
    function Rg() {
      ...
      a["catch"](function () {});
      return new Pg(a, function () {
        return Promise.resolve();
      });
    }

    function Sg(a) {
      return new Pg(Promise.resolve(a), function () {
        return Promise.resolve();
      });
    }
    ...
    function Ug(a) {
      return new Pg(Promise.all(a.map(function (b) {
        return b.promise;
      })), function () {
    ...
    Pg.prototype["finally"] = function (a) {
    ...
    Pg.prototype.W = function (a, b) {
      function c(h) {
        return function (k) {
          if (e.a && h) f.reject(g);else {
            var l = h ? a : b;
            l ? d = Vg(l, k, f) : (h ? f.resolve : f.reject)(k);
          }
        };
      }
    ...
    K("shaka.util.AbortableOperation", Pg);
    Pg.prototype.chain = Pg.prototype.W;
    Pg.prototype["finally"] = Pg.prototype["finally"];
    Pg.all = Ug;
    Pg.prototype.abort = Pg.prototype.abort;
    Pg.notAbortable = Tg;
    Pg.completed = Sg;
    Pg.aborted = Rg;
    Pg.failed = Qg;
    ...
    Wg.prototype.addEventListener = function (a, b) {
      this.ic.push(a, b);
    };

    Wg.prototype.removeEventListener = function (a, b) {
      this.ic.remove(a, b);
    };

    Wg.prototype.dispatchEvent = function (a) {
      var b = this.ic.get(a.type) || [],
          c = this.ic.get("All");
      c && (b = b.concat(c));
      b = t(b);
    ...
    function $g(a, b) {
      a.a.push(b["finally"](function () {
        vc(a.a, b);
      }));
    }

    Zg.prototype.destroy = function () {
      for (var a = [], b = t(this.a), c = b.next(); !c.done; c = b.next()) {
    ...
    q.request = function (a, b) {
      ...
      b.headers = b.headers || {};
      b.retryParameters = b.retryParameters ? Xg(b.retryParameters) : Ng();
      b.uris = Xg(b.uris);
      e = hh(this, a, b);
      var f = e.W(function () {
        return ih(c, a, b, new Mg(b.retryParameters, !1), 0, null, d);
      }),
          g = f.W(function (n) {
        return jh(c, a, n);
      }),
      ...
      var m = g.W(function (n) {
        var p = Date.now() - l,
            r = n.response;
        r.timeMs += k;
        r.timeMs += p;
        n.cf || !c.c || r.fromCache || a != kh || c.c(r.timeMs, r.data.byteLength);
        return r;
      }, function (n) {
        n && (n.severity = 2);
        throw n;
      });
      e = new gh(m.promise, function () {
        return m.abort();
      }, d);
      $g(this.h, e);
      return e;
    ...
    function ih(a, b, c, d, e, f, g) {
      a.g && (c.uris[e] = c.uris[e].replace("http://", "https://"));
      var h = new me(c.uris[e]),
          k = h.Ca,
          l = !1;
      k || (k = location.protocol, k = k.slice(0, -1), ne(h, k), c.uris[e] = h.toString());
      k = k.toLowerCase();
      var m = (k = dh[k]) ? k.mf : null;
      if (!m) return Qg(new L(2, 1, 1E3, h));
      var n = k.pf,
          p = null,
          r = null,
          u = !1,
          x;
      return Tg(Og(d)).W(function () {
        if (a.f) return Rg();
        x = Date.now();
        var w = m(c.uris[e], c, b, function (C, B, F) {
          p && p.stop();
          r && r.N(D / 1E3);
          a.c && b == kh && (a.c(C, B), l = !0, g.a = F);
        });
        if (!n) return w;
        ...
        p && p.stop();
        r && r.stop();
        void 0 == w.timeMs && (w.timeMs = Date.now() - x);
        return {
          response: w,
          cf: l
        };
    ...
    K("shaka.net.NetworkingEngine", ah);
    ah.prototype.request = ah.prototype.request;
    ah.prototype.destroy = ah.prototype.destroy;
    ah.makeRequest = eh;

    ah.defaultRetryParameters = function () {
      return Ng();
    };

    ah.prototype.clearAllResponseFilters = ah.prototype.Ce;
    ah.prototype.unregisterResponseFilter = ah.prototype.If;
    ah.prototype.registerResponseFilter = ah.prototype.rf;
    ah.prototype.clearAllRequestFilters = ah.prototype.Be;
    ah.prototype.unregisterRequestFilter = ah.prototype.Hf;
    ah.prototype.registerRequestFilter = ah.prototype.qf;

    ah.unregisterScheme = function (a) {
      delete dh[a];
    };

    ah.registerScheme = bh;
    ah.prototype.setForceHTTPS = ah.prototype.Ed;

    function fh() {
      this.a = 0;
    }

    ah.NumBytesRemainingClass = fh;
    ...
    K("shaka.util.FairPlayUtils", lh);
    lh.initDataTransform = nh;
    lh.defaultGetContentId = mh;

    function oh(a) {
      for (var b = new Map(), c = t(Object.keys(a)), d = c.next(); !d.done; d = c.next()) {
    ...
    function uh(a) {
      return J(function (b) {
        switch (b.a) {
          case 1:
            return a.b.release(), a.b = null, a.j.reject(), a.X.stop(), a.X = null, a.J.stop(), a.J = null, v(b, vh(a), 2);
          ...
          case 2:
            ...
            A(b, 4);
            return v(b, a.a.setMediaKeys(null), 6);
          ...
          case 3:
            a.c = null, a.l.clear(), a.h = null, a.v = [], a.i = null, a.g = function () {}, a.u = null, z(b);
        }
      });
    }
    ...
    function xh(a, b, c) {
      var d, e, f, g, h, k, l, m, n, p, r, u, x, w, y;
      return J(function (D) {
        if (1 == D.a) {
          if (d = Bh(a)) for (e = t(b), f = e.next(); !f.done; f = e.next()) {
            g = f.value, g.video && (g.video.drmInfos = [d]), g.audio && (g.audio.drmInfos = [d]);
          }
          h = b.some(function (C) {
            return C.video && C.video.drmInfos.length || C.audio && C.audio.drmInfos.length ? !0 : !1;
          });
          h || (k = oh(a.i.servers), Ch(b, k));
          l = t(b);

          for (f = l.next(); !f.done; f = l.next()) {
            for (m = f.value, n = Dh(m), p = t(n), r = p.next(); !r.done; r = p.next()) {
              u = r.value, Eh(u, oh(a.i.servers), oh(a.i.advanced || {}));
            }
          }

          return c ? v(D, gg(b, a.A), 2) : (x = Fh(a, b), D.m(2));
        }

        w = h || Object.keys(a.i.servers).length;
        if (!w) return a.M = !0, D["return"](Promise.resolve());
        y = Ah(a, x, b, c);
    ...
    q.Hb = function (a) {
      ...
      return J(function (e) {
        if (1 == e.a) {
          if (!b.h) return b.b.qa(a, "encrypted", function () {
            b.g(new L(2, 6, 6010));
          }), e["return"]();
          b.a = a;
          b.b.qa(b.a, "play", function () {
            for (var f = t(b.C), g = f.next(); !g.done; g = f.next()) {
              Ih(b, g.value);
            }
          ...
          "webkitCurrentPlaybackTargetIsWireless" in b.a && b.b.s(b.a, "webkitcurrentplaybacktargetiswirelesschanged", function () {
            return vh(b);
          });
        ...
        cf(b.F);
        Jh(b);
        b.c.initData.length || b.v.length || (d = function d(f) {
          return Kh(b, f.initDataType, pb(f.initData));
        }, b.b.s(b.a, "encrypted", d));
        z(e);
      });
    };
    ...
    function Lh(a) {
      ...
      return J(function (c) {
        if (1 == c.a) {
          if (!(a.h && a.c && a.c.serverCertificate && a.c.serverCertificate.length)) return c.m(0);
          A(c, 3);
          return v(c, a.h.setServerCertificate(a.c.serverCertificate), 5);
        }
    ...
    function Mh(a, b) {
      var c, d, e;
      return J(function (f) {
        if (1 == f.a) return v(f, Nh(a, b), 2);
        c = f.b;
        if (!c) return f["return"]();
        d = [];
        if (e = a.f.get(c)) e.Ga = new Ge(), d.push(e.Ga);
        d.push(c.remove());
    ...
    function Jh(a) {
      for (var b = (a.c ? a.c.initData : []) || [], c = t(b), d = c.next(); !d.done; d = c.next()) {
        d = d.value, Kh(a, d.initDataType, d.initData);
      }
      ...
      b.length || a.v.length || a.j.resolve();
      return a.j;
    }
    ...
    function Kh(a, b, c) {
      ...
      for (var e = d.next(); !e.done; e = d.next()) {
        if (nb(c, e.value.initData) && !dc("Tizen 2")) return;
      }
    ...
    function Rh(a, b) {
      ...
      if (cc() && b.includes('codecs="ac-3"')) {
        var c = b.replace("ac-3", "ec-3");
        return a.l.has(b) || a.l.has(c);
      }
    ...
    function Fh(a, b) {
      ...
      for (e = d.next(); !e.done; e = d.next()) {
        Eh(e.value, oh(a.i.servers), oh(a.i.advanced || {}));
      }

      f = a.A ? "required" : "optional";
      var g = a.A ? ["persistent-license"] : ["temporary"];
      d = new Map();
      c = t(c);
      ...
      for (e = c.next(); !e.done; e = c.next()) {
        for (e = e.value, f = t([e.audio, e.video]), e = f.next(); !e.done; e = f.next()) {
          if (g = e.value) {
            var h = Th(g),
                k = null;
            "ac-3" == g.codecs.toLowerCase() && cc() && (k = Th(g, "ec-3"));
            var l = t(g.drmInfos);
            ...
            for (e = l.next(); !e.done; e = l.next()) {
              ...
              e = d.get(m.keySystem);
              e.drmInfos.push(m);
              m.initData && m.initData.length && (e.initDataTypes = ia(new Set(m.initData.map(function (p) {
                return p.initDataType;
              }))).concat());
              m.distinctiveIdentifierRequired && (e.distinctiveIdentifier = "required");
    ...
    function Th(a, b) {
      var c = Pe(a.mimeType, b || a.codecs);
      return Le(c) ? Ne(a.type, c) : c;
    }

    function Ah(a, b, c, d) {
      var e, f, g, h, k, l, m, n, p, r, u, x, w;
      return J(function (y) {
        switch (y.a) {
          case 1:
            e = new Map();
            ...
            if (d) {
              a: {
                ...
                if (1 == e.size && e.has("")) throw new L(2, 6, 6E3);
                D = t([!0, !1]);

                for (B = D.next(); !B.done; B = D.next()) {
                  for (B = B.value, F = t(c), C = F.next(); !C.done; C = F.next()) {
          ...
          case 2:
            ...
            for (n = m.next(); !n.done; n = m.next()) {
              p = n.value, a.l.add(p.contentType.toLowerCase());
            }

            r = t(l);

            for (n = r.next(); !n.done; n = r.next()) {
              u = n.value, a.l.add(u.contentType.toLowerCase());
            }
            ...
            if (d) {
              ...
              H = new Set();
              Vh(D, F, C, G, H);
              I = a.A ? "persistent-license" : "temporary";
              B = {
                keySystem: B,
              ...
              for (F = D.next(); !F.done; F = D.next()) {
                F = F.value, F.distinctiveIdentifierRequired && (B.distinctiveIdentifierRequired = F.distinctiveIdentifierRequired), F.persistentStateRequired && (B.persistentStateRequired = F.persistentStateRequired);
              }

              D = B;
            } else D = g.keySystem, B = b.get(g.keySystem), F = [], C = [], G = [], H = new Set(), Vh(B.drmInfos, F, C, G, H), D = {
              keySystem: D,
              licenseServerUri: F[0],
            ...
            a.c = D;
            if (!a.c.licenseServerUri) throw new L(2, 6, 6012, a.c.keySystem);
            return v(y, g.createMediaKeys(), 6);

          case 6:
            return x = y.b, cf(a.F), a.h = x, a.M = !0, v(y, Lh(a), 7);
          ...
          case 4:
            ...
            a.c = null;
            a.l.clear();
            if (w instanceof L) throw w;
            throw new L(2, 6, 6002, w.message);
        }
      });
    }
        ...
        switch (h.a) {
          case 1:
            try {
              ...
              return d = new L(2, 6, 6005, k.message), a.g(d), h["return"](Promise.reject(d));
            }

            a.b.s(c, "message", function (k) {
              a.a && a.i.delayLicenseRequestUntilPlayed && a.a.paused && !a.H ? a.C.push(k) : Ih(a, k);
            });
            a.b.s(c, "keystatuseschange", function (k) {
              return Wh(a, k);
            });
            e = {
              initData: null,
          ...
          case 4:
            f = h.b;
            cf(a.F);
            if (!f) return a.f["delete"](c), a.g(new L(2, 6, 6013)), h["return"](Promise.resolve());
            e.loaded = !0;
            Xh(a) && a.j.resolve();
            return h["return"](c);

          case 2:
            g = E(h), cf(a.F, g), a.f["delete"](c), a.g(new L(2, 6, 6005, g.message));
    ...
    function Oh(a, b, c) {
      var d = a.c.sessionType;

      try {
        var e = a.h.createSession(d);
      } catch (f) {
        a.g(new L(2, 6, 6005, f.message));
        return;
      }

      a.b.s(e, "message", function (f) {
        a.a && a.i.delayLicenseRequestUntilPlayed && a.a.paused && !a.H ? a.C.push(f) : Ih(a, f);
      });
      a.b.s(e, "keystatuseschange", function (f) {
        return Wh(a, f);
      });
      a.f.set(e, {
        initData: c,
      ...
      try {
        ...
        b = f;
        f instanceof L || (b = new L(2, 6, 6016, f));
        a.g(b);
        return;
      }

      a.i.logLicenseExchange && lc(c);
      e.generateRequest(b, c)["catch"](function (f) {
        if (!a.F.a) {
          ...
          a.g(new L(2, 6, 6006, f.message, f, h));
        }
      });
    }

    function Yh(a, b, c) {
      "skd" == b && (b = c.serverCertificate, c = mh(a), a = nh(a, c, b));
      return a;
    }

    function Ih(a, b) {
      var c, d, e, f, g, h, k, l, m, n, p, r, u, x;
      J(function (w) {
        switch (w.a) {
          case 1:
            return c = b.target, a.i.logLicenseExchange && lc(b.message), d = a.f.get(c), e = a.c.licenseServerUri, f = a.i.advanced[a.c.keySystem], "individualization-request" == b.messageType && f && f.individualizationServer && (e = f.individualizationServer), g = eh([e], a.i.retryParameters), g.body = b.message, g.method = "POST", g.licenseRequestType = b.messageType, g.sessionId = c.sessionId, Qh(a.c.keySystem) && Zh(g), h = Date.now(), A(w, 2), l = a.u.xb.request(2, g), v(w, l.promise, 4);
          ...
          case 2:
            return m = E(w), n = new L(2, 6, 6007, m), a.g(n), d && d.Ga && d.Ga.reject(n), w["return"]();

          case 3:
            if (a.F.a) return w["return"]();
            a.D += (Date.now() - h) / 1E3;
            a.i.logLicenseExchange && lc(k.data);
            A(w, 5);
            return v(w, c.update(k.data), 7);
          ...
          case 5:
            return p = E(w), r = new L(2, 6, 6008, p.message), a.g(r), d && d.Ga && d.Ga.reject(r), w["return"]();

          case 6:
            u = new O("drmsessionupdate"), a.u.onEvent(u), d && (d.Ga && d.Ga.resolve(), x = new M(function () {
              d.loaded = !0;
              Xh(a) && a.j.resolve();
            }), x.N($h)), z(w);
        }
    ...
    function Wh(a, b) {
      ...
      c.keyStatuses.forEach(function (g, h) {
        ...
        if (Qh(a.c.keySystem) && 16 == h.byteLength && navigator.userAgent.match(/Edge?\//)) {
          k = tb(h);
      ...
      (0 > f || e && 1E3 > f) && d && !d.Ga && (a.f["delete"](c), c.close()["catch"](function () {}));
      Xh(a) && (a.j.resolve(), a.J.N(ai));
    }
    ...
    function bi() {
      var a, b, c, d, e, f, g, h;
      return J(function (k) {
        return 1 == k.a ? (a = "org.w3.clearkey com.widevine.alpha com.microsoft.playready com.microsoft.playready.recommendation com.apple.fps.3_0 com.apple.fps.2_0 com.apple.fps.1_0 com.apple.fps com.adobe.primetime".split(" "), b = [{
          ...
          return J(function (r) {
            switch (r.a) {
              case 1:
                return A(r, 2), v(r, navigator.requestMediaKeySystemAccess(l, e), 4);

              case 4:
                return m = r.b, p = (n = m.getConfiguration().sessionTypes) ? n.includes("persistent-license") : !1, dc("Tizen 3") && (p = !1), f.set(l, {
                  persistentState: p
          ...
          return g(l);
        }), v(k, Promise.all(h), 2)) : k["return"](ph(f));
      });
    }
    ...
    function ci(a) {
      var b;
      return J(function (c) {
        if (1 == c.a) return b = new Promise(function (d, e) {
          new M(e).N(di);
        }), A(c, 2), v(c, Promise.race([Promise.all([a.close(), a.closed]), b]), 4);
      ...
      return J(function (c) {
        ...
        return v(c, Promise.all(b.map(function (d) {
          ...
          var e = d.next().value,
              f = d.next().value;
          return J(function (g) {
            if (1 == g.a) return A(g, 2), a.ja || a.v.includes(e.sessionId) || "persistent-license" !== f.type ? v(g, ci(e), 5) : v(g, e.remove(), 5);
            if (2 != g.a) return wa(g, 0);
            E(g);
            z(g);
          });
        })), 0);
    ...
    function fg(a, b) {
      var c = b.audio,
          d = b.video;
      if (c && c.encrypted && (c = Th(c), !Rh(a, c)) || d && d.encrypted && (d = Th(d), !Rh(a, d))) return !1;
      var e = Ph(a.c);
      d = Dh(b);
      ...
      for (var c = [], d = t(a), e = d.next(); !e.done; e = d.next()) {
        ...
        for (var f = t(b), g = f.next(); !g.done; g = f.next()) {
          if (g = g.value, e.keySystem == g.keySystem) {
            ...
            var h = e.keyIds && g.keyIds ? new Set(ia(e.keyIds).concat(ia(g.keyIds))) : e.keyIds || g.keyIds;
            c.push({
    ...
    function th(a) {
      a.f.forEach(function (b, c) {
        var d = b.sd,
            e = c.expiration;
        isNaN(e) && (e = Infinity);
        e != d && (a.u.onExpirationUpdated(c.sessionId, e), b.sd = e);
      });
    }
    ...
    function Vh(a, b, c, d, e) {
      ...
      for (var g = a.next(); !g.done; f = {
        ...
        f.ta = g.value;
        b.includes(f.ta.licenseServerUri) || b.push(f.ta.licenseServerUri);
        f.ta.serverCertificate && (c.some(function (l) {
          return function (m) {
            return nb(m, l.ta.serverCertificate);
          };
        }(f)) || c.push(f.ta.serverCertificate));

        if (f.ta.initData) {
          g = {};

          for (var h = t(f.ta.initData), k = h.next(); !k.done; g = {
            ac: g.ac
          }, k = h.next()) {
            g.ac = k.value, d.some(function (l) {
              return function (m) {
                var n = l.ac;
                return m.keyId && m.keyId == n.keyId ? !0 : m.initDataType == n.initDataType && nb(m.initData, n.initData);
              };
            }(g)) || d.push(g.ac);
          }
        }

        if (f.ta.keyIds) for (g = t(f.ta.keyIds), h = g.next(); !h.done; h = g.next()) {
          e.add(h.value);
        }
      }
    }
    ...
    function hi(a, b, c, d) {
      ...
      return J(function (k) {
        if (1 == k.a) {
          if (d && (e = ii[d.toLowerCase()])) return k["return"](e);
          if (f = ji(a)) if (g = ki[f]) return k["return"](g);
          return d ? k.m(2) : v(k, li(a, b, c), 3);
        }

        if (2 != k.a && (d = k.b) && (h = ii[d])) return k["return"](h);
    ...
    function li(a, b, c) {
      var d, e, f;
      return J(function (g) {
        if (1 == g.a) return d = eh([a], c), d.method = "HEAD", v(g, b.request(0, d).promise, 2);
        e = g.b;
    ...
    function ji(a) {
      a = new me(a).sa.split("/").pop().split(".");
      return 1 == a.length ? "" : a.pop().toLowerCase();
    }

    K("shaka.media.ManifestParser", gi);

    gi.unregisterParserByMime = function (a) {
      delete ii[a];
    };

    gi.registerParserByMime = function (a, b) {
      ii[a] = b;
    };

    gi.registerParserByExtension = function (a, b) {
      ki[a] = b;
    };
    ...
    function ni(a, b) {
      return a && b ? a.Pb() == b.Pb() && a.Lb() == b.Lb() && xc(a.ga(), b.ga()) : a == b;
    }

    K("shaka.media.InitSegmentReference", mi);
    mi.prototype.getEndByte = mi.prototype.Lb;
    mi.prototype.getStartByte = mi.prototype.Pb;

    function oi(a, b, c, d, e, f, g, h, k, l) {
      l = void 0 === l ? [] : l;
      this.startTime = a;
      this.endTime = b;
      this.c = c;
    ...
    K("shaka.media.SegmentReference", oi);
    oi.prototype.getEndByte = oi.prototype.Lb;
    oi.prototype.getStartByte = oi.prototype.Pb;
    oi.prototype.getEndTime = oi.prototype.Ke;
    oi.prototype.getStartTime = oi.prototype.Xe;
    oi.prototype.getUris = oi.prototype.ga;
    ...
    q.Ua = function () {
      return Math.max(this.v, this.Ta() - this.h);
    };
    ...
    q.Ta = function () {
      return this.U() || this.eb() ? Math.min(Math.max(0, (Date.now() + this.j) / 1E3 - this.a - this.f) + this.C, this.g) : this.g;
    };

    q.Ob = function (a) {
      var b = Math.max(this.c, this.v);
      return Infinity == this.h ? Math.ceil(1E3 * b) / 1E3 : Math.max(b, Math.min(this.Ta() - this.h + a, this.Ma()));
    };
    ...
    q.Ma = function () {
      return Math.max(0, this.Ta() - (this.U() || this.eb() ? this.Cc : 0));
    };

    q.pe = function () {
      return null == this.f || null != this.b && this.A ? !1 : !0;
    };
    ...
    K("shaka.media.PresentationTimeline", R);
    R.prototype.setAvailabilityTimeOffset = R.prototype.ke;
    R.prototype.usingPresentationStartTime = R.prototype.pe;
    R.prototype.getSeekRangeEnd = R.prototype.Ma;
    R.prototype.getSeekRangeStart = R.prototype.tb;
    R.prototype.getSafeSeekRangeStart = R.prototype.Ob;
    R.prototype.getSegmentAvailabilityEnd = R.prototype.Ta;
    R.prototype.setUserSeekStart = R.prototype.me;
    R.prototype.getSegmentAvailabilityStart = R.prototype.Ua;
    R.prototype.isInProgress = R.prototype.eb;
    R.prototype.isLive = R.prototype.U;
    R.prototype.offset = R.prototype.offset;
    R.prototype.notifyMaxSegmentDuration = R.prototype.pd;
    R.prototype.notifyMinSegmentStartTime = R.prototype.qd;
    R.prototype.notifySegments = R.prototype.yb;
    R.prototype.getDelay = R.prototype.Je;
    R.prototype.setDelay = R.prototype.Cf;
    R.prototype.setSegmentAvailabilityDuration = R.prototype.Hd;
    R.prototype.setStatic = R.prototype.Xb;
    R.prototype.setClockOffset = R.prototype.le;
    R.prototype.getPresentationStartTime = R.prototype.We;
    R.prototype.setDuration = R.prototype.Fa;
    R.prototype.getMaxSegmentDuration = R.prototype.Qe;
    R.prototype.getDuration = R.prototype.getDuration;
    ...
    ti.prototype.release = function () {
      ...
      this.a = this.A = this.v = null;
    };

    ti.prototype.td = function () {
      this.h = !0;
      ui(this);
    };
    ...
    function ui(a) {
      if (0 != a.a.readyState) {
        ...
        if (!a.a.paused || 0 == a.a.currentTime) {
          a.a.readyState != a.l && (a.f = !1, a.l = a.a.readyState);
          var b;
          ...
          if (!(b = !a.c)) {
            ...
            var c = b.g,
                ...
                e = c.a.currentTime,
                f = Date.now() / 1E3;
            if (b.a != e || b.h != d) b.f = f, b.a = e, b.h = d, b.b = !1;
            e = f - b.f;
            if (d = e >= b.j && d && !b.b) b.c(b.a, e), b.b = !0, b.a = c.a.currentTime;
            b = !d;
          }
          ...
          if (b) {
            ...
            e = a.a.currentTime;
            b = a.a.buffered;
            c = ke(b, e, a.i.gapDetectionThreshold);

            if (!(null == c || 0 == c && !a.h || (d = b.start(c), d >= a.A.Ma()))) {
              f = d - e;
              g = f <= g;
              var h = !1;
              .001 > f || (g || a.f || (a.f = !0, e = new O("largegap", {
                currentTime: e,
                gapSize: f
              }), e.cancelable = !0, a.v(e), a.i.jumpLargeGaps && !e.defaultPrevented && (h = !0)), !g && !h) || (0 != c && b.end(c - 1), a.a.currentTime = d);
            }
          }
        }
      }
    ...
    function vi(a, b, c, d) {
      b == HTMLMediaElement.HAVE_NOTHING || a.readyState >= b ? d() : (b = wi.value().get(b), c.qa(a, b, d));
    }

    var wi = new ub(function () {
    ...
    function xi(a, b, c) {
      ...
      this.b = new ff();
      this.c = new yi(a);
      vi(this.a, HTMLMediaElement.HAVE_METADATA, this.b, function () {
        zi(d, d.f);
      });
    }
    ...
    function Bi(a, b) {
      0 < a.a.readyState ? Ci(a.c, b) : vi(a.a, HTMLMediaElement.HAVE_METADATA, a.b, function () {
        zi(a, a.f);
      });
    }

    function zi(a, b) {
      .001 > Math.abs(a.a.currentTime - b) ? Di(a) : (a.b.qa(a.a, "seeking", function () {
        Di(a);
      }), Ci(a.c, 0 == a.a.currentTime ? b : a.a.currentTime));
    }

    function Di(a) {
      a.h = !0;
      a.b.s(a.a, "seeking", function () {
        return a.g();
      });
    }
    ...
    function yi(a) {
      ...
      this.a = new M(function () {
        0 >= b.c ? b.a.stop() : b.b.currentTime != b.f ? b.a.stop() : (b.b.currentTime = b.g, b.c--);
      });
    }
    ...
    function Ei(a) {
      function b() {
        null == c.c ? c.f = !0 : (c.b.qa(c.a, "seeking", function () {
          c.f = !0;
      ...
      this.c = null;
      this.b = new ff();
      vi(this.a, HTMLMediaElement.HAVE_CURRENT_DATA, this.b, function () {
        b();
      });
    }

    Ei.prototype.release = function () {
      this.b && (this.b.release(), this.b = null);
      this.a = null;
    };
    ...
    function Fi(a, b, c, d, e, f) {
      ...
      this.A = e;
      this.j = null;
      this.f = new ti(a, b.presentationTimeline, c, Gi(a, c), f);
      this.b = new xi(a, function () {
        a: {
          var h = g.f;
          h.j = !0;
          h.h = !1;
          ...
          if (.001 < Math.abs(h - k) && (k = Date.now() / 1E3, !g.j || g.j < k - 1)) {
            g.j = k;
            Bi(g.b, h);
            h = void 0;
            break a;
      ...
      this.h = new M(function () {
        if (0 != g.c.readyState && !g.c.paused) {
          var h = Ai(g.b),
              ...
              l = g.a.Ma();
          3 > l - k && (k = l - 3);
          h < k && (h = Hi(g, h), g.c.currentTime = h);
        }
      }).xa(.25);
    }
    ...
    Fi.prototype.g = function () {
      var a = Ai(this.b);
      return 0 < this.c.readyState && !this.c.paused ? Ji(this, a) : a;
    };

    function Ii(a, b) {
      null == b ? b = Infinity > a.a.getDuration() ? a.a.tb() : a.a.Ma() : 0 > b && (b = a.a.Ma() + b);
      return Ki(a, Ji(a, b));
    }
    ...
    function Hi(a, b) {
      var c = Math.max(a.C, a.i.rebufferingGoal),
    ...
    function Gi(a, b) {
      ...
      var c = b.stallSkip,
          d = new pi(new si(a), b.stallThreshold);
      ri(d, function () {
    ...
    q.release = function () {
      this.f || (this.a = [], this.b && this.b.stop(), this.b = null);
    };
    ...
    q.find = function (a) {
      for (var b = this.a.length - 1, c = b; 0 <= c; --c) {
        var d = this.a[c],
            e = c < b ? this.a[c + 1].startTime : d.endTime;
        if (a >= d.startTime && a < e) return c + this.c;
      }
    ...
    q.offset = function (a) {
      if (!this.f) for (var b = t(this.a), c = b.next(); !c.done; c = b.next()) {
        c = c.value, c.startTime += a, c.endTime += a, c.timestampOffset += a;
      }
    };

    q.xc = function (a) {
      !this.f && a.length && (this.a = this.a.filter(function (b) {
        return b.startTime < a[0].startTime;
      }), this.a.push.apply(this.a, ia(a)));
    };
    ...
    q.Sa = function (a, b, c) {
      ...
      if (!this.f) {
        for (; this.a.length;) {
          if (this.a[this.a.length - 1].startTime >= b) this.a.pop();else break;
        }

        for (; this.a.length;) {
          if (this.a[0].endTime <= a) this.a.shift(), c || this.c++;else break;
        }

        0 != this.a.length && (a = this.a[this.a.length - 1], this.a[this.a.length - 1] = new oi(a.startTime, b, a.c, a.da, a.Y, a.b, a.timestampOffset, a.appendWindowStart, a.appendWindowEnd));
      }
    };

    q.Fc = function (a, b) {
      var c = this;
      this.f || (this.b && this.b.stop(), this.b = new M(function () {
        var d = b();
        d ? c.a.push.apply(c.a, ia(d)) : (c.b.stop(), c.b = null);
      }), this.b.xa(a));
    };
    ...
    S.prototype.sb = function (a) {
      ...
      var c = this.get(b + 1),
          d = -1;
      if (c && 0 < c.a.length) for (var e = c.a.length - 1; 0 <= e; --e) {
        var f = c.a[e];
      ...
      return new Li(this, b, d);
    };

    function Mi(a, b, c) {
      return new S([new oi(a, a + b, function () {
        return c;
      }, 0, null, null, a, a, a + b)]);
    }

    K("shaka.media.SegmentIndex", S);
    S.forSingleSegment = Mi;
    S.prototype.getIteratorForTime = S.prototype.sb;
    S.prototype.updateEvery = S.prototype.Fc;
    S.prototype.fit = S.prototype.Sa;
    S.prototype.evict = S.prototype.$a;
    S.prototype.mergeAndEvict = S.prototype.wb;
    S.prototype.merge = S.prototype.xc;
    S.prototype.offset = S.prototype.offset;
    S.prototype.get = S.prototype.get;
    S.prototype.find = S.prototype.find;
    S.prototype.markImmutable = S.prototype.ff;
    ...
    Li.prototype.current = function () {
      var a = this.c.get(this.b);
      a && 0 < a.a.length && a.ga().length && this.a >= a.a.length && (this.b++, this.a = 0, a = this.c.get(this.b));
      return a && 0 < a.a.length ? a.a[this.a] : a;
    };

    Li.prototype.next = function () {
      var a = this.c.get(this.b);
      a && 0 < a.a.length ? (this.a++, a.ga().length && this.a == a.a.length && (this.b++, this.a = 0)) : (this.b++, this.a = 0);
      a = this.current();
      return {
        value: a,
        done: !a
    ...
    K("shaka.media.SegmentIterator", Li);
    Li.prototype.next = Li.prototype.next;
    Li.prototype.current = Li.prototype.current;
    ...
    K("shaka.media.MetaSegmentIndex", Ni);
    Ni.prototype.updateEvery = Ni.prototype.Fc;
    Ni.prototype.fit = Ni.prototype.Sa;
    Ni.prototype.mergeAndEvict = Ni.prototype.wb;
    Ni.prototype.evict = Ni.prototype.$a;
    Ni.prototype.merge = Ni.prototype.xc;
    Ni.prototype.offset = Ni.prototype.offset;
    Ni.prototype.get = Ni.prototype.get;
    Ni.prototype.find = Ni.prototype.find;
    Ni.prototype.release = Ni.prototype.release;
    ...
    Oi.prototype.set = function (a) {
      this.b = a;
      Pi(this);
    };

    Oi.prototype.sc = function () {
      return this.a.sc();
    };
    ...
    Qi.prototype.release = function () {
      ...
      for (var a = t(this.a), b = a.next(); !b.done; b = a.next()) {
        b.value.release();
      }
    ...
    function Ri(a, b) {
      for (var c = t(a.a), d = c.next(); !d.done; d = c.next()) {
        d = d.value;

        for (var e = a.c.currentTime, f = b, g = t(d.g.a), h = g.next(); !h.done; h = g.next()) {
          h = h.value;
          var k = d.f.get(h),
              l = e < h.startTime ? Si : e > h.endTime ? Ti : Ui;
          d.f.set(h, l);

          for (var m = t(d.h), n = m.next(); !n.done; n = m.next()) {
            n = n.value, n.mb == k && n.lb == l && n.cb(h, f);
          }
        }
      }
    }
    ...
    function Vi(a) {
      ...
      this.f = a;
      this.c = new M(function () {
        for (var c = b.f(), d = t(b.a), e = d.next(); !e.done; e = d.next()) {
    ...
    function ej(a, b) {
      ...
      J(function (k) {
        switch (k.a) {
          case 1:
            return c = Fe, A(k, 2), v(k, Ef(a.u.L, c.$), 4);
          ...
          case 2:
            if (d = E(k), a.u) a.u.onError(d);

          case 3:
            e = Pe(b.mimeType, b.codecs);
            sf(a.u.L, e);
            f = a.u.L.h;
            if (g = f.isTextVisible() || a.i.alwaysStreamText) h = fj(b), a.a.set(c.$, h), gj(a, h, 0);
            z(k);
        }
      });
    }
    ...
    function hj(a) {
      var b = a.a.get(Ee);
      b && (bj(b), cj(b)["catch"](function () {}), a.a["delete"](Ee));
      a.c = null;
    }
    ...
    function ij(a, b) {
      ...
      if (c) {
        ...
        if (d) if (b) {
          ...
          e && !c.ib && (jj(a, e, !1, 0, !1), c.ib = d);
        } else if (d = c.ib) c.ib = null, jj(a, d, !0, 0, !1);
      }
    }
    ...
    function kj(a, b, c, d) {
      ...
      d = void 0 === d ? 0 : d;
      a.b = b;
      a.h && (b.video && jj(a, b.video, c, d, !1), b.audio && jj(a, b.audio, c, d, !1));
    }
    ...
    function jj(a, b, c, d, e) {
      ...
      f || b.type != Ee ? f && (f.ib && (b.trickModeVideo ? (f.ib = b, b = b.trickModeVideo) : f.ib = null), f.stream != b || e) && (b.type == Ee && sf(a.u.L, Pe(b.mimeType, b.codecs)), f.stream = b, f.ia = null, c && (f.Ib ? f.Ic = !0 : f.Na ? (f.kb = !0, f.oc = d, f.Ic = !0) : (bj(f), mj(a, f, !0, d)["catch"](function (g) {
        if (a.u) a.u.onError(g);
      }))), nj(a, f)["catch"](function (g) {
        if (a.u) a.u.onError(g);
      })) : ej(a, b);
    }
    ...
    function nj(a, b) {
      ...
      return J(function (e) {
        if (1 == e.a) {
          if (!b.ra) return e["return"]();
          c = b.stream;
          d = b.ra;
          return c.segmentIndex ? e.m(2) : v(e, c.createSegmentIndex(), 2);
        }

        if (b.ra != d || b.stream != c) return e["return"]();
        var f = a.u.uc();
        var g = xf(a.u.L, b.type),
            h = b.stream.segmentIndex.find(b.wa ? b.wa.endTime : f),
            k = null == h ? null : b.stream.segmentIndex.get(h);
        h = k ? k.Y ? k.Y - k.da : null : null;
        k && !h && (h = (k.endTime - k.startTime) * (b.stream.bandwidth || 0) / 8);
        h ? ((k = k.b) && (h += (k.Y ? k.Y - k.da : null) || 0), k = a.u.getBandwidthEstimate(), f = 8 * h / k < (g || 0) - f - Math.max(a.o.minBufferTime || 0, a.i.rebufferingGoal) || b.ra.b.a > h ? !0 : !1) : f = !1;
        f && b.ra.abort();
        z(e);
      });
    }
    ...
    function oj(a, b) {
      b.Ib || b.kb || (b.Na ? (b.kb = !0, b.oc = 0) : null == vf(a.u.L, b.type) ? null == b.Ha && gj(a, b, 0) : (bj(b), mj(a, b, !1, 0)["catch"](function (c) {
        if (a.u) a.u.onError(c);
      })));
    }
    ...
    function dj(a) {
      ...
      return J(function (n) {
        if (1 == n.a) {
          ...
          c = new Map();
          d = new Set();
          a.b.audio && (c.set(b.Xa, a.b.audio), d.add(a.b.audio));
          a.b.video && (c.set(b.Ja, a.b.video), d.add(a.b.video));
          a.c && (c.set(b.$, a.c), d.add(a.c));
          e = a.u.L;
        ...
        cf(a.F);
        var p = a.o.presentationTimeline.getDuration();
        Infinity > p ? a.u.L.Fa(p) : a.u.L.Fa(Math.pow(2, 32));
        g = t(c.keys());

        for (h = g.next(); !h.done; h = g.next()) {
          k = h.value, l = c.get(k), a.a.has(k) || (m = fj(l), a.a.set(k, m), gj(a, m, 0));
        }
    ...
    $i.prototype.Sb = function (a) {
      ...
      return J(function (h) {
        switch (h.a) {
          case 1:
            cf(b.F);
            if (a.Na || null == a.Ha || a.Ib) return h["return"]();
            a.Ha = null;
          ...
          case 5:
            if (c != a.stream) return null == a.Ha && gj(b, a, 0), h["return"]();

          case 4:
            A(h, 6);
            d = pj(b, a);
            null != d && (gj(b, a, d), a.Qb = !1);
            wa(h, 7);
            break;

          case 6:
            return e = E(h), v(h, qj(b, e), 8);

          case 8:
            return h["return"]();

          case 7:
            f = Array.from(b.a.values());

            if (!b.h || !f.every(function (k) {
            ...
            return v(h, b.u.L.endOfStream(), 10);

          case 10:
            cf(b.F), g = b.u.L.getDuration(), 0 != g && g < b.o.presentationTimeline.getDuration() && b.o.presentationTimeline.Fa(g), z(h);
        }
      });
    };

    function pj(a, b) {
      if (rj(b)) return Cf(a.u.L, b.stream.originalId || ""), null;
      b.type == Ee && Df(a.u.L);
      var c = a.u.uc(),
          d = b.wa ? b.wa.endTime : c,
          e = yf(a.u.L, b.type, c),
          f = Math.max(a.o.minBufferTime || 0, a.i.rebufferingGoal, a.i.bufferingGoal) * a.f;
      if (d >= a.o.presentationTimeline.getDuration()) return b.endOfStream = !0, "video" == b.type && (c = a.a.get(Ee)) && rj(c) && (c.endOfStream = !0), null;
      b.endOfStream = !1;
      if (e >= f) return .5;
      e = xf(a.u.L, b.type);
      e = sj(a, b, c, e);
      ...
      for (var h = g.next(); !h.done; h = g.next()) {
        h = h.value, rj(h) || h.ia && !h.ia.current() || (f = Math.min(f, h.wa ? h.wa.endTime : c));
      }

      if (d >= f + a.o.presentationTimeline.a) return 1;
      tj(a, b, c, e)["catch"](function () {});
      return null;
    }

    function sj(a, b, c, d) {
      if (b.ia) return b.ia.current();
      if (b.wa || d) return b.ia = b.stream.segmentIndex.sb(b.wa ? b.wa.endTime : d), b.ia.next().value;
      a = a.i.inaccurateManifestTolerance;
      d = Math.max(c - a, 0);
      var e = null;
      a && (b.ia = b.stream.segmentIndex.sb(d), e = b.ia.next().value);
      e || (b.ia = b.stream.segmentIndex.sb(c), e = b.ia.next().value);
      return e;
    }
      ...
      return J(function (y) {
        switch (y.a) {
          case 1:
            ...
            if (a.i.lowLatencyMode && l && k) return p = new Uint8Array(0), r = function r(D) {
              var C, B, F;
              return J(function (G) {
                if (1 == G.a) return v(G, h, 2);
                cf(a.F);
          ...
          case 6:
            return n = y.b, cf(a.F), a.g ? y["return"]() : b.kb ? (b.Na = !1, gj(a, b, 0), y["return"]()) : v(y, wj(a, b, c, f, d, n[1]), 5);
          ...
          case 2:
            ...
            if (a.g) return y["return"]();
            b.Na = !1;
            if (b.type == e.$ && a.i.ignoreTextStreamFailures) a.a["delete"](e.$), y.m(0);else if (7001 == w.code) b.Na = !1, b.Ha = null, gj(a, b, 0), y.m(0);else if (3017 == w.code) yj(a, b, w), y.m(0);else if (1001 == w.code && w.data && 404 == w.data[1]) b.Na = !1, b.Ha = null, gj(a, b, 1), y.m(0);else return b.Qb = !0, w.severity = 2, v(y, qj(a, w), 0);
        }
      });
    }
    ...
    function yj(a, b, c) {
      if (!Array.from(a.a.values()).some(function (e) {
        return e != b && e.wd;
      })) {
        var d = Math.round(100 * a.f);
        if (20 < d) a.f -= .2;else if (4 < d) a.f -= .04;else {
          b.Qb = !0;
          a.g = !0;
          a.u.onError(c);
          return;
    ...
    function uj(a, b, c) {
      ...
      return J(function (m) {
        ...
        g = c.timestampOffset;
        if (g != b.md || e != b.ld || f != b.kd) h = function h() {
          var n;
          return J(function (p) {
            if (1 == p.a) return A(p, 2), b.ld = e, b.kd = f, b.md = g, v(p, Ff(a.u.L, b.type, g, e, f), 4);
        ...
        !ni(c.b, b.wc) && (b.wc = c.b) && (k = xj(a, b, c.b), l = function l() {
          var n, p, r;
          return J(function (u) {
            switch (u.a) {
              case 1:
                return A(u, 2), v(u, k, 4);

              case 4:
                return n = u.b, cf(a.F), p = b.stream.closedCaptions && 0 < b.stream.closedCaptions.size, v(u, zf(a.u.L, b.type, n, null, null, p), 5);
    ...
    function wj(a, b, c, d, e, f) {
      var g;
      return J(function (h) {
        if (1 == h.a) return g = d.closedCaptions && 0 < d.closedCaptions.size, null != d.emsgSchemeIdUris && 0 < d.emsgSchemeIdUris.length && new Qb().S("emsg", function (k) {
          ...
          if (0 === k.version) {
            ...
            var u = k.reader.I();
            var x = k.reader.I();
            var w = e.startTime + r / p;
          } else p = k.reader.I(), w = k.reader.gb() / p + e.timestampOffset, r = w - e.startTime, u = k.reader.I(), x = k.reader.I(), m = k.reader.Ub(), n = k.reader.Ub();

          k = k.reader.Va(k.reader.P.byteLength - k.reader.Z());
          l.includes(m) && ("urn:mpeg:dash:event:2012" == m ? a.u.kf() : (l = new O(zj, {
            detail: {
              startTime: w,
              endTime: w + u / p,
              schemeIdUri: m,
        ...
        }).parse(f), v(h, Aj(a, b, c), 2);
        if (3 != h.a) return cf(a.F), v(h, zf(a.u.L, b.type, f, e.startTime, e.endTime, g), 3);
        cf(a.F);
        z(h);
      });
    }
    ...
    function Aj(a, b, c) {
      ...
      return J(function (h) {
        if (1 == h.a) {
          d = Math.max(a.i.bufferBehind, a.o.presentationTimeline.a);
          e = vf(a.u.L, b.type);
          if (null == e) return h["return"]();
          f = c - e;
          g = f - d;
          return .01 >= g ? h["return"]() : v(h, a.u.L.remove(b.type, e, e + g), 2);
        }
    ...
    function rj(a) {
      return a && a.type == Ee && ("application/cea-608" == a.stream.mimeType || "application/cea-708" == a.stream.mimeType);
    }

    function xj(a, b, c, d) {
      var e, f, g, h;
      return J(function (k) {
        if (1 == k.a) return e = kh, f = Zi(c.ga(), c.da, c.Y, a.i.retryParameters, d), g = a.u.xb.request(e, f), b.ra = g, v(k, g.promise, 2);
        h = k.b;
        b.ra = null;
    ...
    function mj(a, b, c, d) {
      var e, f;
      return J(function (g) {
        if (1 == g.a) return b.kb = !1, b.Ic = !1, b.oc = 0, b.Ib = !0, b.wa = null, b.wc = null, b.ia = null, d ? (e = a.u.uc(), f = a.u.L.getDuration(), v(g, a.u.L.remove(b.type, e + d, f), 3)) : v(g, Ef(a.u.L, b.type), 4);
        if (3 != g.a) return cf(a.F), c ? v(g, a.u.L.flush(b.type), 3) : g.m(3);
        cf(a.F);
        b.Ib = !1;
        b.endOfStream = !1;
        gj(a, b, 0);
    ...
    function gj(a, b, c) {
      var d = b.type;
      if (d != Ee || a.a.has(d)) b.Ha = new Zb(function () {
        var e;
        return J(function (f) {
          if (1 == f.a) return A(f, 2), v(f, a.Sb(b), 4);
          if (2 != f.a) return wa(f, 0);
          e = E(f);
          if (a.u) a.u.onError(e);
          z(f);
        });
      }).N(c);
    }
    ...
    function bj(a) {
      null != a.Ha && (a.Ha.stop(), a.Ha = null);
    }

    function cj(a) {
      return J(function (b) {
        return a.ra ? v(b, a.ra.abort(), 0) : b.m(0);
      });
    }

    function qj(a, b) {
      return J(function (c) {
        if (1 == c.a) return v(c, Og(a.j), 2);
        cf(a.F);
        a.u.onError(b);
    ...
    function Ej(a) {
      var b, c, d;
      return J(function (e) {
        if (1 == e.a) return a.b && a.b.abort(), Fj(a), v(e, a.l, 2);
        a.a && a.a.Da.fb();
        b = t(a.g);
    ...
    function Dj(a) {
      return J(function (b) {
        if (a.F.a) b = b.m(0);else {
          if (0 == a.g.length || a.a && !a.a.bb) var c = !1;else {
            a.a && (a.a.Da.fb(), a.a = null);
            c = a.g.shift();
            var d = c.create(a.f);
            d ? (c.Da.zb(), a.a = {
              node: d.node,
          ...
          c ? c = Promise.resolve() : a.a ? c = Hj(a) : (a.h.jf(a.c), a.j = new Ge(), c = a.j);
          b = v(b, c, 1);
        }
        return b;
      });
    ...
    function Hj(a) {
      ...
      return J(function (d) {
        switch (d.a) {
          case 1:
            return a.c = a.h.Se(a.c, a.f, a.a.node, a.a.payload), A(d, 2), a.b = a.h.Ge(a.c, a.f, a.a.payload), v(d, a.b.promise, 4);

          case 4:
            a.b = null;
            a.c == a.a.node && (a.a.Da.yc(), a.a = null);
            wa(d, 0);
            break;

          case 2:
            b = E(d);
            if (7001 == b.code) a.a.Da.fb();else a.a.Da.onError(b);
            a.a = null;
            a.b = null;
            c = a;
            return v(d, a.h.handleError(a.f, b), 5);
    ...
    function Ij(a) {
      ...
      for (var b = t(Array.from(a.textTracks)), c = b.next(); !c.done; c = b.next()) {
        c = c.value, c.mode = "disabled", "Shaka Player TextTrack" == c.label && (this.a = c);
      }
    ...
    q.append = function (a) {
      ...
      for (var f = c.next(); !f.done; e = {
        ...
        e.nb = f.value, a.some(function (g) {
          return function (h) {
            return h.startTime == g.nb.startTime && h.endTime == g.nb.endTime && h.text == g.nb.payload ? !0 : !1;
          };
        }(e)) || (f = Kj(e.nb)) && d.push(f);
      }
      ...
      for (e = a.next(); !e.done; e = a.next()) {
        this.a.addCue(e.value);
      }
    };

    q.destroy = function () {
      this.a && (Jj(this.a, function () {
        return !0;
    ...
    K("shaka.text.SimpleTextDisplayer", Ij);
    Ij.prototype.setTextVisibility = Ij.prototype.setTextVisibility;
    Ij.prototype.isTextVisible = Ij.prototype.isTextVisible;
    Ij.prototype.destroy = Ij.prototype.destroy;
    Ij.prototype.append = Ij.prototype.append;
    ...
    q.append = function (a) {
      ...
      for (var d = a.next(); !d.done; c = {
        ...
        c.Zb = d.value, b.some(function (e) {
          return function (f) {
            return Kc(f, e.Zb);
          };
        }(c)) || this.c.push(c.Zb);
    ...
    function Oj(a) {
      function b(g) {
        return a.c.includes(g) && a.h && g.startTime <= c && g.endTime > c;
      }

      for (var c = a.a.currentTime, d = t(a.f.keys()), e = d.next(); !e.done; e = d.next()) {
        if (e = e.value, !b(e)) {
          var f = a.f.get(e);
          a.b.removeChild(f);
          a.f["delete"](e);
      ...
      e = t(Array.from(a.b.childNodes));

      for (f = e.next(); !f.done; f = e.next()) {
        f = f.value, d.has(f) || a.b.removeChild(f);
      }

      d = a.c.filter(function (g) {
        return b(g) && !a.f.has(g);
      }).sort(function (g, h) {
        return g.startTime != h.startTime ? g.startTime - h.startTime : g.endTime - h.endTime;
      });
      d = t(d);

      for (e = d.next(); !e.done; e = d.next()) {
        e = e.value, f = Pj(a, a.b, e, !1), a.f.set(e, f);
      }
    }
    ...
    function Pj(a, b, c, d) {
      ...
      if ("br" != e) for (Qj(a, f, c, d), c = t(c.nestedCues), d = c.next(); !d.done; d = c.next()) {
        Pj(a, f, d.value, !0);
      }
      b.appendChild(f);
      return f;
    ...
    function Qj(a, b, c, d) {
      ...
      e.opacity = c.opacity;
      e.paddingLeft = Rj(c.linePadding, c, a.g);
      e.paddingRight = Rj(c.linePadding, c, a.g);
      ...
      e.fontSize = Rj(c.fontSize, c, a.g);
      ...
      c.position && (c.writingMode == Ec ? e.paddingLeft = c.position : e.paddingTop = c.position);
      ...
      c.size && (c.writingMode == Ec ? e.width = c.size + "%" : e.height = c.size + "%");
    }
    ...
    K("shaka.text.UITextDisplayer", Nj);
    Nj.prototype.setTextVisibility = Nj.prototype.setTextVisibility;
    Nj.prototype.isTextVisible = Nj.prototype.isTextVisible;
    Nj.prototype.remove = Nj.prototype.remove;
    Nj.prototype.destroy = Nj.prototype.destroy;
    Nj.prototype.append = Nj.prototype.append;
    ...
    function Sj(a) {
      ...
      for (var d = c.next(); !d.done; d = c.next()) {
        ...
        a += e(d.startTime) + " --\x3e " + e(d.endTime) + "\n";
        a += d.payload + "\n\n";
      }
    ...
    function Uj(a, b, c, d, e) {
      ...
      for (h in b) {
        var k = e + "." + h,
            l = f ? d[e] : c[h];
        f || h in c ? void 0 === b[h] ? void 0 === l || f ? delete a[h] : a[h] = Xg(l) : l.constructor == Object && b[h] && b[h].constructor == Object ? (a[h] || (a[h] = Xg(l)), k = Uj(a[h], b[h], l, d, k), g = g && k) : _typeof(b[h]) != _typeof(l) || null == b[h] || "function" != typeof b[h] && b[h].constructor != l.constructor ? (Ta("Invalid config, wrong type for " + k), g = !1) : ("function" == typeof c[h] && c[h].length != b[h].length && Ua("Unexpected number of arguments for " + k), a[h] = b[h]) : (Ta("Invalid config, unrecognized key " + k), g = !1);
      }
    ...
    K("shaka.util.ConfigUtils", Tj);
    Tj.convertToConfigObject = Vj;
    Tj.mergeConfigObjects = Uj;
    ...
    function Xj() {
      ...
      if (navigator.userAgent.match(/Edge\//) || cc() || ec()) d.gapDetectionThreshold = .5;
      if (dc("Web0S") || cc() || ec()) d.stallSkip = 0;
      var e = {
        ...
        downloadSizeCallback: function downloadSizeCallback(g) {
          var h;
          return J(function (k) {
            if (1 == k.a) return navigator.storage && navigator.storage.estimate ? v(k, navigator.storage.estimate(), 3) : k["return"](!0);
            h = k.b;
      ...
      e.trackSelectionCallback = function (g) {
        return J(function (h) {
          return h["return"](Yj(g, f.preferredAudioLanguage));
        });
      };
    ...
    function Yj(a, b) {
      var c = a.filter(function (h) {
        return "variant" == h.type;
          ...
          d = [],
          e = Qf(b, c.map(function (h) {
        return h.language;
      }));
      e && (d = c.filter(function (h) {
        return Kf(h.language) == e;
      }));
      ...
      for (g = d.next(); !g.done; g = d.next()) {
        g = g.value, g.type != Ee && "image" != g.type || c.push(g);
      }

      return c;
    }

    K("shaka.util.PlayerConfiguration", Wj);
    Wj.mergeConfigObjects = Zj;
    ...
    function dk(a) {
      ...
      for (var c = [], d = t(a.b), e = d.next(); !e.done; e = d.next()) {
        c.push(b(e.value));
      }
    ...
    function hk() {
      this.h = this.j = this.C = this.v = this.D = this.f = this.A = this.g = this.c = this.H = this.J = this.M = this.l = this.T = NaN;
      this.b = new ak();
      this.a = new ek();
    }
    ...
    function U(a, b) {
      ...
      this.T = !1;
      this.b = new ff();
      this.Wc = this.l = this.Ra = this.o = this.jc = this.j = this.c = this.kc = this.C = this.Ya = this.A = this.Aa = this.v = this.D = this.h = this.K = null;
      this.bd = 1E9;
      this.i = jk(this);
      this.$c = {
        width: Infinity,
      ...
      this.ka = this.i.preferredTextLanguage;
      this.fc = this.i.preferredTextRole;
      this.ec = this.i.preferForcedSubs;
      this.Xc = [];
      b && b(this);
      this.K = kk(this);
      this.K.Ed(this.i.streaming.forceHTTPS);
      this.H = null;
      lk && (this.H = Ob(lk));
      this.b.s(window, "online", function () {
        c.xd();
      });
      this.na = {
        name: "detach"
      ...
      var d = new Map();
      d.set(this.Ka, function (e, f) {
        return Tg(mk(c, e, f));
      });
      d.set(this.na, function (e) {
        e.B && (c.b.ya(e.B, "error"), e.B = null);
        c.a = null;
        e = Promise.resolve();
        return Tg(e);
      });
      d.set(this.M, function (e) {
        return Tg(nk(c, e));
      });
      d.set(this.za, function (e) {
        e = ok(c, e);
        return Tg(e);
      });
      d.set(this.dd, function (e, f) {
        var g = pk(c, e, f);
        return Tg(g);
      });
      d.set(this.Jc, function (e) {
        return qk(c, e);
      });
      d.set(this.Yc, function (e) {
        e = rk(c, e);
        return Tg(e);
      });
      ...
      d.set(this.Ia, function (e, f) {
        return uk(c, e, f);
      });
      this.X = new Bj(this.na, {
        Se: function Se(e, f, g, h) {
          var k = null;
          e == c.na && (k = g == c.na ? c.na : c.Ka);
          e == c.Ka && (k = g == c.na || f.B != h.B ? c.na : g == c.Ka ? c.Ka : g == c.za || g == c.J ? c.za : g == c.Ia ? c.ed : null);
          e == c.za && (k = g == c.J && f.B == h.B ? c.dd : c.M);
          e == c.dd && (k = vk(c.J, c.Jc, c.M, g, f, h));
          e == c.Jc && (k = vk(c.J, c.Yc, c.M, g, f, h));
          e == c.Yc && (k = vk(c.J, c.J, c.M, g, f, h));
          e == c.ed && (k = g == c.Ia && f.B == h.B ? c.Ia : c.M);
          if (e == c.J || e == c.Ia) k = c.M;
          e == c.M && (k = h.B && f.B == h.B ? c.Ka : c.na);
          return k;
        },
        Ge: function Ge(e, f, g) {
          c.dispatchEvent(wk(xk, {
            state: e.name
          }));
          return d.get(e)(f, g);
        },
        handleError: function handleError(e) {
          return J(function (f) {
            return 1 == f.a ? v(f, nk(c, e), 2) : f["return"](e.B ? c.Ka : c.na);
          });
        },
        jf: function jf(e) {
          c.dispatchEvent(wk(yk, {
            state: e.name
          }));
        }
      });
    ...
    q.Hb = function (a, b) {
      b = void 0 === b ? !0 : b;
      if (this.g == zk) return Promise.reject(Ak());
      var c = Cj();
      c.B = a;
      $b() || (b = !1);
      var d = b ? this.za : this.Ka,
          e = Gj(this.X, function () {
        return {
          node: d,
          payload: c,
          bb: !1
    ...
    q.Kd = function (a) {
      ...
      $b() || (a = !1);
      var c = Cj(),
          d = Gj(this.X, function (e) {
        var f = e.B && a ? b.za : e.B ? b.Ka : b.na;
        c.B = e.B;
        return {
          node: f,
          payload: c,
    ...
    q.load = function (a, b, c) {
      var d = this;
      if (this.g == zk) return Promise.reject(Ak());
      this.dispatchEvent(wk(Ck));
      var e = Cj();
      e.uri = a;
      e.Id = Date.now() / 1E3;
      c && (e.mimeType = c);
      void 0 !== b && (e.startTime = b);
      var f = Dk(this, e) ? this.Ia : this.J,
          g = Gj(this.X, function (h) {
    ...
    function Dk(a, b) {
      ...
      if (c) {
        if ("" == (b.B || bc()).canPlayType(c)) return !1;
        if (!$b() || !(c in ii || ji(d) in ki) || a.i.streaming.preferNativeHls) return !0;
        if (fc()) return a.i.streaming.useNativeHlsOnSafari;
      }
    ...
    function mk(a, b, c) {
      null == b.B && (b.B = c.B, a.b.s(b.B, "error", function () {
        var d = Fk(a);
        d && Gk(a, d);
      }));
      a.a = b.B;
    ...
    function nk(a, b) {
      ...
      return J(function (n) {
        switch (n.a) {
          case 1:
            return a.g != zk && (a.g = ik), c = a.Xc.map(function (p) {
              return p();
            }), a.Xc = [], v(n, Promise.all(c), 2);

          case 2:
            a.dispatchEvent(wk(Hk));
            b.mimeType = null;
            b.startTime = null;
            b.uri = null;
            b.B && (a.b.ya(b.B, "loadedmetadata"), a.b.ya(b.B, "playing"), a.b.ya(b.B, "pause"), a.b.ya(b.B, "ended"), a.b.ya(b.B, "ratechange"));
            a.Aa && (a.Aa.release(), a.Aa = null);
            a.Ya && (a.Ya.stop(), a.Ya = null);
          ...
          case 7:
            ...
            return v(n, a.D.destroy(), 10);

          case 10:
            a.D = null;

          case 9:
            if (a.H) a.H.onAssetUnload();
          ...
          case 12:
            for (b.B.removeAttribute("src"), b.B.load(); b.B.lastChild;) {
              b.B.removeChild(b.B.firstChild);
            }
    ...
    function ok(a, b) {
      var c, d, e, f;
      return J(function (g) {
        if (1 == g.a) return c = new ee(), d = a.i.textDisplayFactory, e = Ob(d), a.Zc = d, f = Jk(b.B, c, e, function (h, k, l) {
          h = t(h);

          for (var m = h.next(); !m.done; m = h.next()) {
            if (m = m.value, m.data && m.cueTime && m.frames) {
              for (var n = m.cueTime + k, p = l, r = t(m.frames), u = r.next(); !u.done; u = r.next()) {
                Kk(a, n, p, "ID3", u.value);
              }

              if (a.H) a.H.onHlsTimedMetadata(m, n);
            }
          }
        }), v(g, f.A, 2);
        a.D = f;
    ...
    function pk(a, b, c) {
      var d, e, f, g;
      return J(function (h) {
        if (1 == h.a) return b.mimeType = c.mimeType, b.uri = c.uri, d = b.uri, e = a.K, a.Ra = d, f = a, v(h, hi(d, e, a.i.manifest.retryParameters, b.mimeType), 2);
        f.jc = h.b;
        a.j = Ob(a.jc);
        g = Xg(a.i.manifest);
        c.B && "AUDIO" === c.B.nodeName && (g.disableVideo = !0);
        a.j.configure(g);
        z(h);
      });
    }
    ...
    function qk(a, b) {
      var c = b.uri,
          d = a.K;
      a.kc = new Vi(function () {
        return a.zd();
      });
      Wi(a.kc, function (g) {
        Lk(a, Mk, g);
        if (a.H) a.H.onDashTimedMetadata(g);
      });
      var e = {
        networkingEngine: d,
        filter: function filter(g) {
          return J(function (h) {
            return h["return"](a.qc(g));
          });
        },
        makeTextStreamsForClosedCaptions: function makeTextStreamsForClosedCaptions(g) {
          return Nk(a, g);
        },
        onTimelineRegionAdded: function onTimelineRegionAdded(g) {
          var h = a.kc;
        ...
        isAutoLowLatencyMode: function isAutoLowLatencyMode() {
          return a.i.streaming.autoLowLatencyMode;
        },
        enableLowLatencyMode: function enableLowLatencyMode() {
          ...
          f = Date.now() / 1E3;
      return new Pg(function () {
        var g, h, k, l;
        return J(function (m) {
          if (1 == m.a) return g = a, v(m, a.j.start(c, e), 2);
          g.o = m.b;
          h = wk(Ok);
          a.dispatchEvent(h);
          if (0 == a.o.variants.length) throw new L(2, 4, 4036);
          Pk(a.o);
          k = Date.now() / 1E3;
          l = k - f;
          a.f.A = l;
    ...
    function rk(a, b) {
      var c, d;
      return J(function (e) {
        return 1 == e.a ? (c = Date.now() / 1E3, d = !0, a.h = Qk(a, {
          xb: a.K,
          ...
          onEvent: function onEvent(f) {
            a.dispatchEvent(f);
            f.type == Tk && d && (d = !1, a.f.f = Date.now() / 1E3 - c);
          }
        }), a.i.useMediaCapabilities || ag(a.o), a.h.configure(a.i.drm), v(e, yh(a.h, a.o.variants, a.o.offlineSessionIds, a.i.useMediaCapabilities), 2)) : 3 != e.a ? v(e, a.h.Hb(b.B), 3) : v(e, a.qc(a.o), 0);
      });
    }
      ...
      return J(function (r) {
        switch (r.a) {
          case 1:
            ...
            a.A = new Oi({
              vc: function vc() {
                return b.B.playbackRate;
              },
              sc: function sc() {
                return b.B.defaultPlaybackRate;
              },
              Gd: function Gd(u) {
                b.B.playbackRate = u;
              },
            ...
            a.b.s(d, "pause", f);
            a.b.s(d, "ended", f);
            a.b.s(d, "ratechange", g);
            h = a.i.abrFactory;
            a.l && a.Wc == h || (a.Wc = h, a.l = Ob(h), "function" != typeof a.l.playbackRateChanged && (Hb("AbrManager", "Please use an AbrManager with playbackRateChanged function."), a.l.playbackRateChanged = function () {}), a.l.configure(a.i.abr));
            a.ja = new Eg(a.i.preferredAudioLanguage, a.i.preferredVariantRole, a.i.preferredAudioChannelCount);
            a.ka = a.i.preferredTextLanguage;
            Wk(a.o.presentationTimeline, a.i.playRangeStart, a.i.playRangeEnd);
            a.l.init(function (u, x, w) {
              x = void 0 === x ? !1 : x;
              w = void 0 === w ? 0 : w;
              a.c && u != a.c.b && (fk(a.f.a, u, !0), kj(a.c, u, x, w), Xk(a));
            });
            a.v = Yk(a, b.startTime);
            a.Aa = Zk(a);
            k = Math.max(a.o.minBufferTime, a.i.streaming.rebufferingGoal);
            $k(a, k);
            Rf(a.o, a.i.preferredAudioChannelCount);
            a.c = al(a);
            a.c.configure(a.i.streaming);
            a.g = bl;
            a.dispatchEvent(wk(cl));
            l = dl(a) ? a.l.chooseVariant() : null;
            fk(a.f.a, l, !0);
            kj(a.c, l, !1, 0);
            (m = tg(a.o.textStreams, a.ka, a.fc, a.ec)[0] || null) && gk(a.f.a, m, !0);
            m ? (l.audio && el(a, l.audio, m) && (a.T = !0), a.T && a.D.h.setTextVisibility(!0), fl(a)) : a.T = !1;
            m && (a.i.streaming.alwaysStreamText || a.jd()) && lj(a.c, m);
          ...
          case 2:
            return v(r, a.c.start(), 4);

          case 4:
            a.i.abr.enabled && (a.l.enable(), hl(a)), cg(a.c ? a.c.b : null, a.o), il(a.o), jl(a), Xk(a), dl(a), a.o.variants.some(function (u) {
              return u.primary;
            }), a.b.qa(d, "loadedmetadata", function () {
              a.f.g = Date.now() / 1E3 - c.Id;
            }), z(r);
        }
      });
    }
    ...
    function tk(a, b) {
      var c, d, e, f;
      return J(function (g) {
        return 1 == g.a ? (c = Fe, d = Date.now() / 1E3, e = !0, a.h = Qk(a, {
          xb: a.K,
          ...
          onExpirationUpdated: function onExpirationUpdated(h, k) {
            Sk(a, h, k);
          },
          onEvent: function onEvent(h) {
            a.dispatchEvent(h);
            h.type == Tk && e && (e = !1, a.f.f = Date.now() / 1E3 - d);
          }
        }), a.h.configure(a.i.drm), f = {
          id: 0,
          language: "und",
          primary: !1,
          audio: null,
          ...
          decodingInfos: []
        }, v(g, yh(a.h, [f], []), 2)) : v(g, a.h.Hb(b.B), 0);
      });
    }
    ...
    function uk(a, b, c) {
      ...
      a.Ra = b.uri;
      a.v = new Ei(b.B);
      null != b.startTime && a.v.l(b.startTime);
      a.A = new Oi({
        vc: function vc() {
          return b.B.playbackRate;
        },
      ...
      $k(a, a.i.streaming.rebufferingGoal);
      a.b.s(b.B, "playing", d);
      a.b.s(b.B, "pause", d);
      a.b.s(b.B, "ended", d);
      a.b.s(b.B, "ratechange", function () {
        return Vk(a);
      });
      "none" != a.a.preload && a.b.qa(a.a, "loadedmetadata", function () {
        a.f.g = Date.now() / 1E3 - c.Id;
      });
      a.a.audioTracks && (a.b.s(a.a.audioTracks, "addtrack", function () {
        return jl(a);
      }), a.b.s(a.a.audioTracks, "removetrack", function () {
        return jl(a);
      }), a.b.s(a.a.audioTracks, "change", function () {
        return jl(a);
      }));
      a.a.textTracks && (a.b.s(a.a.textTracks, "addtrack", function (g) {
        jl(a);
        kl(a, g);
      }), a.b.s(a.a.textTracks, "removetrack", function () {
        return jl(a);
      }), a.b.s(a.a.textTracks, "change", function () {
        return jl(a);
      }));
      b.B.src = b.uri;
      (cc() || dc("Web0S")) && b.B.load();
      a.g = ll;
      a.dispatchEvent(wk(cl));
      var e = new Ge();
      vi(a.a, HTMLMediaElement.HAVE_METADATA, a.b, function () {
        e.resolve();
      });
      var f = !1;
      a.Xc.push(function () {
      ...
      vi(a.a, HTMLMediaElement.HAVE_CURRENT_DATA, a.b, function () {
        var g;
        return J(function (h) {
          if (1 == h.a) {
            ...
            }) ? h.m(2) : v(h, new Promise(function (k) {
              a.b.qa(a.a.textTracks, "change", k);
              new M(k).N(1);
            }), 2);
          }
      ...
      a.a.error ? e.reject(Fk(a)) : "none" == a.a.preload && (Ua('With <video preload="none">, the browser will not load anything until play() is called. We are unable to measure load latency in a meaningful way, and we cannot provide track info yet. Please do not use preload="none" with Shaka Player.'), e.resolve());
      a.b.qa(a.a, "error", function () {
        e.reject(Fk(a));
      });
      return new Pg(e, function () {
    ...
    function ol(a) {
      var b = a.i.preferredTextLanguage,
          c = a.i.preferForcedSubs;

      if ("" != b) {
        a.Cd(b, "", c);
        var d = a.i.preferredTextRole;
        "" != d && a.Cd(b, d, c);
      }
    }
    ...
    function kl(a, b) {
      var c = b.track;
      "metadata" == c.kind && (c.mode = "hidden", a.b.s(c, "cuechange", function () {
        if (c.activeCues) for (var d = t(c.activeCues), e = d.next(); !e.done; e = d.next()) {
          if (e = e.value, Kk(a, e.startTime, e.endTime, e.type, e.value), a.H) a.H.onCueMetadataChange(e.value);
        }
      }), new M(function () {
        var d = pl(a);
        d = t(d);
    ...
    function Qk(a, b) {
      return new rh(b, a.i.drm.updateExpirationTime);
    }

    function kk(a) {
      return new ah(function (b, c) {
        a.l && a.l.segmentDownloaded(b, c);
      });
    }

    function Yk(a, b) {
      return new Fi(a.a, a.o, a.i.streaming, b, function () {
        a.Aa && Ri(a.Aa, !0);
        if (a.c) for (var c = a.c, d = c.u.uc(), e = c.i.smallGapLimit, f = t(c.a.keys()), g = f.next(); !g.done; g = f.next()) {
          g = g.value;
          var h = c.a.get(g);
          h.ia = null;
          var k = c.u.L;
          g == Ee ? (k = k.c, k = null == k.a || null == k.b ? !1 : d >= k.a && d < k.b) : (k = wf(k, g), k = he(k, d, e));
          if (!k && (null != xf(c.u.L, g) && oj(c, h), h.ra && (h.ra.abort(), h.ra = null), g === Ee)) for (g = c.u.L.v.a, g.g = 0, g.b = [], g.a = [], h = g.c, h.c = [], h.b = [], h.a = 0, Rd(g), g = t(g.f.values()), h = g.next(); !h.done; h = g.next()) {
            nd(h.value);
          }
        }
        a.C && rl(a);
    ...
    function rl(a) {
      switch (a.g) {
        case ll:
          if (a.a.ended) var b = !0;else {
            var c = ge(a.a.buffered);
            b = null != c && c >= a.a.duration - 1;
          }
          break;

        case bl:
          a: if (a.a.ended || uf(a.D)) b = !0;else {
            if (a.o.presentationTimeline.U()) {
              c = a.o.presentationTimeline.Ta();
              var d = ge(a.a.buffered);
      ...
      d = ie(a.a.buffered, a.a.currentTime);
      c = a.C;
      var e = b,
          f = c.b.get(c.a);
      b = c.a;
    ...
    q.configure = function (a, b) {
      2 == arguments.length && "string" == typeof a && (a = Vj(a, b));
    ...
    function ul(a) {
      ...
      a.K && a.K.Ed(a.i.streaming.forceHTTPS);

      if (a.D && (b = a.i.textDisplayFactory, a.Zc != b)) {
        var c = Ob(b),
            d = a.D,
            e = d.h;
        d.h = c;
        ...
        d.c && (d.c.c = c);
        a.Zc = b;
        a.c && (b = a.c, (c = b.a.get(Ee)) && jj(b, c.stream, !0, 0, !0));
      }

      a.l && (a.l.configure(a.i.abr), a.i.abr.enabled ? a.l.enable() : a.l.disable(), hl(a));
      a.C && (b = a.i.streaming.rebufferingGoal, a.o && (b = Math.max(b, a.o.minBufferTime)), Lg(a.C, b, Math.min(.5, b / 2)));
      a.o && Wk(a.o.presentationTimeline, a.i.playRangeStart, a.i.playRangeEnd);
    }
    ...
    q.U = function () {
      return this.o ? this.o.presentationTimeline.U() : this.a && this.a.src ? Infinity == this.a.duration : !1;
    };

    q.eb = function () {
      return this.o ? this.o.presentationTimeline.eb() : !1;
    };

    q.df = function () {
      if (this.o) {
        var a = this.o.variants;
    ...
    q.zd = function () {
      if (this.o) {
        var a = this.o.presentationTimeline;
        return {
          start: a.tb(),
          end: a.Ma()
        };
    ...
    q.Mb = function () {
      return this.h ? this.h.Mb() : Infinity;
    };
    ...
    q.Ff = function (a) {
      0 == a ? Ua("A trick play rate of 0 is unsupported!") : (this.a.paused && this.a.play(), this.A.set(a), this.g == bl && (this.l.playbackRateChanged(a), ij(this.c, 1 < Math.abs(a))));
    };

    q.ze = function () {
      var a = this.A.sc();
      this.g == ll && this.A.set(a);
      this.g == bl && (this.A.set(a), this.l.playbackRateChanged(a), ij(this.c, !1));
    };

    q.gd = function () {
      if (this.o) {
        for (var a = this.c ? this.c.b : null, b = [], c = t(this.o.variants), d = c.next(); !d.done; d = c.next()) {
          if (d = d.value, rg(d)) {
            var e = kg(d);
            e.active = d == a;
            b.push(e);
      ...
      return this.a && this.a.audioTracks ? Array.from(this.a.audioTracks).map(function (f) {
        return pg(f);
      }) : [];
    };
    ...
    q.ub = function () {
      if (this.o) {
        for (var a = this.c ? this.c.c : null, b = [], c = t(this.o.textStreams), d = c.next(); !d.done; d = c.next()) {
          d = d.value;
          var e = lg(d);
          e.active = d == a;
          b.push(e);
      ...
      return this.a && this.a.src && this.a.textTracks ? nl(this).map(function (f) {
        var g = qg(f);
    ...
    q.Le = function () {
      return this.o ? this.o.imageStreams.map(function (a) {
        return mg(a);
      }) : [];
    };
    ...
    q.af = function (a, b) {
      var c = this,
          ...
          D;
      return J(function (C) {
        if (1 == C.a) return c.o ? (d = c.o.imageStreams.find(function (B) {
          return B.id == a;
        })) ? d.segmentIndex ? C.m(3) : v(C, d.createSegmentIndex(), 3) : C["return"](null) : C.m(2);
        ...
        if (2 != C.a) {
          ...
          u = r = 0;
          x = l * m;
          1 < x && (w = b - f.startTime, y = f.endTime - f.startTime, D = Math.floor(w * x / y), r = D % l / l * h, u = D % m / m * k);
          return C["return"]({
            height: p,
            positionX: r,
            positionY: u,
    ...
    q.ie = function (a) {
      if (this.o && this.c) {
        var b = this.o.textStreams.find(function (d) {
          return d.id == a.id;
        });
        b && b != this.c.c && (gk(this.f.a, b, !1), lj(this.c, b), xl(this), this.ka = b.language);
      } else if (this.a && this.a.src && this.a.textTracks) {
        b = nl(this);
        b = t(b);

        for (var c = b.next(); !c.done; c = b.next()) {
          c = c.value, ng(c) == a.id ? c.mode = this.T ? "showing" : "hidden" : c.mode = "disabled";
        }
    ...
    q.je = function (a, b, c) {
      ...
      if (this.o && this.c) {
        this.i.abr.enabled && Ua("Changing tracks while abr manager is enabled will likely result in the selected track being overriden. Consider disabling abr before calling selectVariantTrack().");
        var d = this.o.variants.find(function (e) {
          return e.id == a.id;
        });
        d && rg(d) && (yl(this, d, !1, b, c), this.ja = new Dg(d), dl(this));
      } else if (this.a && this.a.audioTracks) for (b = Array.from(this.a.audioTracks), b = t(b), c = b.next(); !c.done; c = b.next()) {
        if (c = c.value, ng(c) == a.id) {
          zl(this, c);
          break;
        }
      }
    ...
    q.He = function () {
      return Array.from(Bl(this.gd()));
    };

    q.Ze = function () {
      return Array.from(Bl(this.ub()));
    };

    q.Bd = function (a, b) {
      if (this.o && this.v) {
        this.ja = new Eg(a, b || "", 0, "");

        if (!this.i.abr.enabled) {
          var c = function c(k, l) {
            return k.video || l.video ? k.video && l.video ? Math.abs((k.video.height || 0) - (l.video.height || 0)) + Math.abs((k.video.width || 0) - (l.video.width || 0)) : Infinity : 0;
              ...
              d = this.c.b,
              e = this.ja.create(this.o.variants),
              f = null;
        ...
        e = Array.from(this.a.audioTracks);
        c = Kf(a);
        f = d = null;
        e = t(e);
        ...
        for (g = e.next(); !g.done; g = e.next()) {
          g = g.value;
          var h = pg(g);
          Kf(h.language) == c && (d = g, b ? h.roles.includes(b) && (f = g) : 0 == h.roles.length && (f = g));
        }

        f ? zl(this, f) : d && zl(this, d);
      }
    };
    ...
    q.Cd = function (a, b, c) {
      ...
      if (this.o && this.v) {
        if (this.ka = a, this.fc = b || "", this.ec = c, (a = tg(this.o.textStreams, this.ka, this.fc, this.ec)[0] || null) && a != this.c.c && (gk(this.f.a, a, !1), this.i.streaming.alwaysStreamText || this.jd())) lj(this.c, a), xl(this);
      } else {
        var d = Kf(a);
        (a = this.ub().find(function (e) {
          return Kf(e.language) == d && (!b || e.roles.includes(b)) && e.forced == c;
        })) && this.ie(a);
      }
    };
    ...
    q.xf = function (a) {
      if (this.o && this.v) {
        for (var b = null, c = t(this.o.variants), d = c.next(); !d.done; d = c.next()) {
        ...
        null != b && (this.ja = new Eg(b.language, "", 0, a), wl(this));
      }
    };

    q.jd = function () {
      var a = this.T;
      return this.D ? this.D.h.isTextVisible() : this.a && this.a.src && this.a.textTracks ? nl(this).some(function (b) {
    ...
    q.Df = function (a) {
      ...
      if (this.T != a) {
        this.T = a;
        if (this.g == bl) this.D.h.setTextVisibility(a), this.i.streaming.alwaysStreamText || (a ? this.c.c || (a = tg(this.o.textStreams, this.ka, this.fc, this.ec), 0 < a.length && (lj(this.c, a[0]), xl(this))) : hj(this.c));else if (this.a && this.a.src && this.a.textTracks) {
          var b = nl(this);
          b = t(b);
    ...
    q.Ve = function () {
      ...
      var a = this.X.f,
          b = 0;
      if (this.v) b = this.v.g();else if (a) {
        if (null == a.startTime) return new Date();
        b = a.startTime;
      }
      return this.o ? new Date(1E3 * (this.o.presentationTimeline.f + b)) : this.a && this.a.getStartDate ? (a = this.a.getStartDate(), isNaN(a.getTime()) ? null : new Date(a.getTime() + 1E3 * b)) : null;
    };

    q.Ud = function () {
      if (!this.U()) return null;
      if (this.o) return new Date(1E3 * this.o.presentationTimeline.f);
    ...
    q.rc = function () {
      ...
      this.g == ll && (a.total = je(this.a.buffered));
      return a;
    };

    q.getStats = function () {
      if (this.g != bl && this.g != ll) return {
        width: NaN,
        height: NaN,
        streamBandwidth: NaN,
        decodedFrames: NaN,
      ...
      a.getVideoPlaybackQuality && (a = a.getVideoPlaybackQuality(), c = this.f, b = Number(a.totalVideoFrames), c.M = Number(a.droppedVideoFrames), c.J = b, this.f.H = Number(a.corruptedVideoFrames));
      this.h ? (a = this.h, a = a.D ? a.D : NaN) : a = NaN;
      this.f.D = a;

      if (this.g == bl) {
        if (a = this.c.b) this.f.j = (this.A ? this.A.b : 1) * a.bandwidth;
        a && a.video && (c = this.f, b = a.video.height || NaN, c.T = a.video.width || NaN, c.l = b);
        this.U() && (a = this.Ud().valueOf() + 1E3 * this.zd().end, this.f.v = (Date.now() - a) / 1E3);
        this.o && this.o.presentationTimeline && (this.f.C = this.o.presentationTimeline.a);
    ...
    q.addTextTrack = function (a, b, c, d, e, f, g) {
      ...
      if (this.g != bl && this.g != ll) throw new L(1, 7, 7004);
      ...
      if (this.g == ll) {
        if ("text/vtt" != d) throw new L(1, 2, 2013, d);
        g && (c = "forced");
        ...
        d.kind = c;
        d.srclang = b;
        this.a.getAttribute("crossorigin") || this.a.setAttribute("crossorigin", "anonymous");
        this.a.appendChild(d);
        if (a = this.ub().find(function (k) {
          return k.language == b && k.label == (f || "") && k.kind == c;
        })) return jl(this), a;
        throw new L(1, 2, 2012);
      }

      h = this.o.presentationTimeline.getDuration();
      if (Infinity == h) throw new L(1, 4, 4033);
      a = {
        id: this.bd++,
        originalId: null,
        createSegmentIndex: function createSegmentIndex() {
      ...
      if (!Ve(Pe(a.mimeType, a.codecs))) throw new L(2, 2, 2014, d);
      this.o.textStreams.push(a);
      jl(this);
      return lg(a);
    };

    q.ve = function (a, b, c, d, e, f, g) {
      g = void 0 === g ? !1 : g;
      var h = this,
          k,
          l,
      ...
      return J(function (B) {
        switch (B.a) {
          case 1:
            if (h.g != bl && h.g != ll) throw new L(1, 7, 7004);
            ...
            A(B, 4);
            return v(B, li(a, h.K, h.i.streaming.retryParameters), 6);
          ...
          case 2:
            ...
            return v(B, Cl(a, h.K, h.i.streaming.retryParameters), 9);

          case 9:
            l = B.b, m = Dl(h, l, d), n = new Blob([m], {
              type: "text/vtt"
            }), a = qf(n), d = "text/vtt";
          ...
          case 8:
            ...
            p.kind = c;
            p.srclang = b;
            h.a.getAttribute("crossorigin") || h.a.setAttribute("crossorigin", "anonymous");
            h.a.appendChild(p);
            r = h.ub();
            if (u = r.find(function (F) {
              return F.language == b && F.label == (f || "") && F.kind == c;
            })) return jl(h), B["return"](u);
            throw new L(1, 2, 2012);

          case 7:
            x = Fe;
            w = h.o.presentationTimeline.getDuration();
            if (Infinity == w) throw new L(1, 4, 4033);
            y = {
              id: h.bd++,
              originalId: null,
              createSegmentIndex: function createSegmentIndex() {
            ...
            D = Pe(y.mimeType, y.codecs);
            C = Ve(D);
            if (!C) throw new L(2, 2, 2014, d);
            h.o.textStreams.push(y);
            jl(h);
            return B["return"](lg(y));
        }
      });
    };
    ...
    function Cl(a, b, c) {
      var d, e, f;
      return J(function (g) {
        if (1 == g.a) return d = kh, e = eh([a], c), e.method = "GET", v(g, b.request(d, e).promise, 2);
        f = g.b;
    ...
    function Dl(a, b, c) {
      ...
      if (d) return c = d(), a = {
        periodStart: 0,
        segmentStart: 0,
        segmentEnd: a.a.duration
      }, b = pb(b), b = c.parseMedia(b, a), Sj(b);
      throw new L(2, 2, 2014, c);
    }
    ...
    q.xd = function () {
      if (this.g == bl) {
        var a = this.c;
        if (a.F.a) a = !1;else if (a.g) a = !1;else {
          for (var b = t(a.a.values()), c = b.next(); !c.done; c = b.next()) {
            c = c.value, c.Qb && (c.Qb = !1, gj(a, c, .1));
          }
    ...
    function jk(a) {
      ...
      b.streaming.failureCallback = function (c) {
        ...
        a.U() && d.includes(c.code) && (c.severity = 1, a.xd());
      };

      b.textDisplayFactory = function () {
        return a.lc ? new Nj(a.a, a.lc) : new Ij(a.a);
      };
    ...
    function Nk(a, b) {
      for (var c = new Set(), d = t(b.textStreams), e = d.next(); !e.done; e = d.next()) {
      ...
      for (e = d.next(); !e.done; e = d.next()) {
        if ((e = e.value.video) && e.closedCaptions) for (var f = t(e.closedCaptions.keys()), g = f.next(); !g.done; g = f.next()) {
    ...
    function El(a, b) {
      var c;
      return J(function (d) {
        if (1 == d.a) return c = a.c ? a.c.b : null, v(d, Zf(a.h, c, b, a.i.useMediaCapabilities), 2);
        il(b);
        z(d);
      });
    }
    ...
    function vl(a, b) {
      if (a.g != zk) {
        for (var c = a.i.restrictions, d = a.$c, e = !1, f = t(b.variants), g = f.next(); !g.done; g = f.next()) {
          g = g.value;
          var h = g.allowedByApplication;
          g.allowedByApplication = Yf(g, c, d);
          h != g.allowedByApplication && (e = !0);
        }

        e && a.c && jl(a);
        if ((c = a.h ? a.h.c : null) && a.h.h) for (d = t(b.variants), e = d.next(); !e.done; e = d.next()) {
          for (e = e.value, e = t((e.video ? e.video.drmInfos : []).concat(e.audio ? e.audio.drmInfos : [])), f = e.next(); !f.done; f = e.next()) {
            if (f = f.value, f.keySystem == c.keySystem) for (f = t(f.initData || []), g = f.next(); !g.done; g = f.next()) {
              g = g.value, Kh(a.h, g.initDataType, g.initData);
            }
          }
        }
        Fl(a, b);
    ...
    function gl(a, b) {
      var c, d, e, f, g;
      return J(function (h) {
        if (1 == h.a) return c = a.audio, d = a.video, e = function e(k, l) {
          var m, n;
          return J(function (p) {
            if (1 == p.a) return k ? v(p, k.createSegmentIndex(), 2) : p["return"](null);
        ...
        if (3 != h.a) return f = h.b, v(h, e(d, b), 3);
        g = h.b;
    ...
    function Vk(a) {
      ...
      0 != b && (a.A && a.A.set(b), b = wk(Hl), a.dispatchEvent(b));
    }

    function Uk(a) {
      if (a.f && a.C) {
        var b = a.f.b;
        a.C.a == Kg ? bk(b, "buffering") : a.a.paused ? bk(b, "paused") : a.a.ended ? bk(b, "ended") : bk(b, "playing");
      }
    }
    ...
    function dl(a) {
      ...
      var b = a.o.variants.filter(function (c) {
        return rg(c);
      });
      b = a.ja.create(b);
    ...
    function wl(a) {
      var b;
      if (b = dl(a) ? a.l.chooseVariant() : null) yl(a, b, !0, !0, 0), Xk(a);
    }

    function yl(a, b, c, d, e) {
      var f = a.c.b;
      b != f && (fk(a.f.a, b, c), kj(a.c, b, d, e), c = null, f && (c = kg(f)), b = kg(b), Il(a, c, b));
    }

    function zl(a, b) {
      var c = Array.from(a.a.audioTracks).find(function (e) {
        return e.enabled;
      });
      b.enabled = !0;
      c = pg(c);
    ...
    function el(a, b, c) {
      a = Kf(a.i.preferredTextLanguage);
      b = Kf(b.language);
      c = Kf(c.language);
      return Jf(c, a) && !Jf(b, c);
    }
    ...
    function Rk(a, b) {
      if (a.c) {
          ...
          for (var f = c.next(); !f.done; f = c.next()) {
            ...
            for (var h = g.next(); !h.done; h = g.next()) {
              ...
              if (k.keyIds.size) {
                ...
                for (var l = k.next(); !l.done; l = k.next()) {
                  l = l.value, l = b[d ? "00" : l], f.allowedByKeySystem = f.allowedByKeySystem && !!l && !Rl.includes(l);
                }
              }
        ...
        e && dl(a);
        (d = a.c.b) && !d.allowedByKeySystem && wl(a);
        e && jl(a);
      }
    }
        ...
        for (var n = m.next(); !n.done; n = m.next()) {
          if (n = n.value, n.keyIds.size) {
            ...
            for (var p = n.next(); !p.done; p = n.next()) {
              p = p.value;
              var r = c[d ? "00" : p];
              r ? Rl.includes(r) && h.add(r) : g.add(p);
            }
          }
        }
    ...
    function il(a) {
      if (!a.variants.some(rg)) throw new L(2, 4, 4032);
    }

    function Kl(a, b) {
      J(function (c) {
        if (1 == c.a) return v(c, Promise.resolve(), 2);
        a.g != zk && a.dispatchEvent(b);
        z(c);
      });
    }
    ...
    function Bl(a) {
      ...
      for (var c = a.next(); !c.done; c = a.next()) {
        c = c.value, c.language ? b.add(Kf(c.language)) : b.add("und");
      }
    ...
    function Al(a) {
      ...
      for (var d = a.next(); !d.done; d = a.next()) {
        ...
        for (var g = f.next(); !g.done; g = f.next()) {
          g = g.value, b.get(e).add(g), d.label && (c.has(e) || c.set(e, new Map()), c.get(e).set(g, d.label));
        }
      }
    ...
    function vk(a, b, c, d, e, f) {
      return d == a && e.B == f.B && e.uri == f.uri && e.mimeType == f.mimeType ? b : c;
    }
    ...
    K("shaka.Player", U);
    U.prototype.setVideoContainer = U.prototype.ne;
    U.prototype.getManifestParserFactory = U.prototype.Pe;
    U.prototype.getManifest = U.prototype.Oe;
    U.prototype.retryStreaming = U.prototype.xd;
    U.prototype.setMaxHardwareResolution = U.prototype.Fd;
    U.prototype.addTextTrackAsync = U.prototype.ve;
    U.prototype.addTextTrack = U.prototype.addTextTrack;
    U.prototype.getStats = U.prototype.getStats;
    U.prototype.getBufferedInfo = U.prototype.rc;
    U.prototype.getPresentationStartTimeAsDate = U.prototype.Ud;
    U.prototype.getPlayheadTimeAsDate = U.prototype.Ve;
    U.prototype.setTextTrackVisibility = U.prototype.Df;
    U.prototype.isTextTrackVisible = U.prototype.jd;
    U.prototype.selectVariantsByLabel = U.prototype.xf;
    U.prototype.selectTextLanguage = U.prototype.Cd;
    U.prototype.selectAudioLanguage = U.prototype.Bd;
    U.prototype.getTextLanguages = U.prototype.Ze;
    U.prototype.getAudioLanguages = U.prototype.He;
    U.prototype.getTextLanguagesAndRoles = U.prototype.$e;
    U.prototype.getAudioLanguagesAndRoles = U.prototype.Ie;
    ...
    U.prototype.getImageTracks = U.prototype.Le;
    U.prototype.getTextTracks = U.prototype.ub;
    U.prototype.getVariantTracks = U.prototype.gd;
    U.prototype.cancelTrickPlay = U.prototype.ze;
    U.prototype.trickPlay = U.prototype.Ff;
    U.prototype.getPlaybackRate = U.prototype.Te;
    U.prototype.isBuffering = U.prototype.hd;
    U.prototype.getKeyStatuses = U.prototype.tc;
    U.prototype.getExpiration = U.prototype.Mb;
    U.prototype.drmInfo = U.prototype.drmInfo;
    U.prototype.keySystem = U.prototype.keySystem;
    U.prototype.seekRange = U.prototype.zd;
    U.prototype.isAudioOnly = U.prototype.df;
    U.prototype.isInProgress = U.prototype.eb;
    U.prototype.isLive = U.prototype.U;
    U.prototype.getAdManager = U.prototype.Td;
    U.prototype.getAssetUri = U.prototype.fd;
    U.prototype.getNetworkingEngine = U.prototype.Nb;
    U.prototype.getMediaElement = U.prototype.Re;
    U.prototype.getLoadMode = U.prototype.Ne;
    U.prototype.resetConfiguration = U.prototype.wf;
    ...
    U.prototype.unload = U.prototype.Kd;
    U.prototype.detach = U.prototype.detach;
    U.prototype.attach = U.prototype.Hb;

    U.probeSupport = function (a) {
      a = void 0 === a ? !0 : a;
      var b, c, d, e, f, g;
      return J(function (h) {
        if (1 == h.a) return b = {}, a ? v(h, bi(), 3) : h.m(2);
        2 != h.a && (b = h.b);
        var k = {};
        ...
        for (l = p.next(); !l.done; l = p.next()) {
          l = l.value, k[l] = $b() ? Ve(l) ? !0 : MediaSource.isTypeSupported(l) || Le(l) : ac(l), m = l.split(";")[0], k[m] = k[m] || k[l];
        }
    ...
    U.isBrowserSupported = function () {
      ...
      var a = gc();
      return a && 12 > a || !(window.MediaKeys && window.navigator && window.navigator.requestMediaKeySystemAccess && window.MediaKeySystemAccess && window.MediaKeySystemAccess.prototype.getConfiguration) ? !1 : $b() ? !0 : ac("application/x-mpegurl");
    };
    ...
    var Pl = "abrstatuschanged",
        Jl = "adaptation",
        Gl = "buffering",
        Tk = "drmsessionupdate",
        zj = "emsg",
        Ql = "error",
        Sl = "expirationupdated",
        Ek = "loaded",
        Ck = "loading",
        Ok = "manifestparsed",
        ql = "metadata",
    ...
    Ib = new function (a) {
      ...
      this.c = Jb;
      this.b = Kb;
    }(new Gb(Number(Vl[0]), Number(Vl[1])));
    var Rl = ["output-restricted", "internal-error"],
        Tl = {},
        lk = null;
    ...
    function V(a, b) {
      ...
      this.b = new ff();
      this.b.s(this.a, google.ima.AdEvent.Type.PAUSED, function () {
        c.f = !0;
      });
      this.b.s(this.a, google.ima.AdEvent.Type.RESUMED, function () {
        c.f = !1;
      });
    }
    ...
    q.getMinSuggestedDuration = function () {
      return this.c.getMinSuggestedDuration();
    };
    ...
    q.resize = function (a, b) {
      this.a.resize(a, b, document.fullscreenElement ? google.ima.ViewMode.FULLSCREEN : google.ima.ViewMode.NORMAL);
    };

    q.setMuted = function (a) {
      a ? (this.g = this.getVolume(), this.setVolume(0)) : this.setVolume(this.g);
    };
    ...
    function Xl(a, b, c, d) {
      ...
      a = new google.ima.AdDisplayContainer(this.h, this.a);
      a.initialize();
      this.g = new google.ima.AdsLoader(a);
      this.g.getSettings().setPlayerType("shaka-player");
      this.g.getSettings().setPlayerVersion("v3.1.0");
      this.c = null;
      this.b.qa(this.g, google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, function (f) {
        Yl(e, f);
      });
      this.b.s(this.g, google.ima.AdErrorEvent.Type.AD_ERROR, function (f) {
        Zl(e, f);
      });
    ...
    function Zl(a, b) {
      b.getError();
      $l(a, null);
      a.f(new O("ad-cue-points-changed", {
        cuepoints: []
      }));
    }

    function Yl(a, b) {
      a.f(new O("ads-loaded", {
        loadTime: Date.now() / 1E3 - a.l
      }));
      a.c = b.getAdsManager(a.a);
      a.f(new O("ima-ad-manager-loaded", {
        imaAdManager: a.c
      }));
      ...
      try {
        a.c.init(a.a.offsetWidth, a.a.offsetHeight, document.fullscreenElement ? google.ima.ViewMode.FULLSCREEN : google.ima.ViewMode.NORMAL), a.b.s(a.a, "loadeddata", function () {
          a.c.resize(a.a.offsetWidth, a.a.offsetHeight, document.fullscreenElement ? google.ima.ViewMode.FULLSCREEN : google.ima.ViewMode.NORMAL);
        }), a.c.start();
      } catch (f) {
        $l(a, null);
      }
    ...
    function bm(a) {
      a.b.s(a.c, google.ima.AdErrorEvent.Type.AD_ERROR, function (b) {
        Zl(a, b);
      });
      a.b.s(a.c, google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED, function (b) {
        cm(a, b);
      });
      a.b.s(a.c, google.ima.AdEvent.Type.STARTED, function (b) {
        cm(a, b);
      });
      a.b.s(a.c, google.ima.AdEvent.Type.FIRST_QUARTILE, function (b) {
        a.f(new O("ad-first-quartile", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.MIDPOINT, function (b) {
        a.f(new O("ad-midpoint", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.THIRD_QUARTILE, function (b) {
        a.f(new O("ad-third-quartile", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.COMPLETE, function (b) {
        a.f(new O("ad-complete", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED, function (b) {
        $l(a, b);
      });
      a.b.s(a.c, google.ima.AdEvent.Type.ALL_ADS_COMPLETED, function (b) {
        $l(a, b);
      });
      a.b.s(a.c, google.ima.AdEvent.Type.SKIPPED, function (b) {
        a.f(new O("ad-skipped", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.VOLUME_CHANGED, function (b) {
        a.f(new O("ad-volume-changed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.VOLUME_MUTED, function (b) {
        a.f(new O("ad-muted", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.PAUSED, function (b) {
        a.j.f = !0;
        a.f(new O("ad-paused", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.RESUMED, function (b) {
        a.j.f = !1;
        a.f(new O("ad-resumed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED, function (b) {
        a.f(new O("ad-skip-state-changed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.CLICK, function (b) {
        a.f(new O("ad-clicked", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.AD_PROGRESS, function (b) {
        a.f(new O("ad-progress", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.AD_BUFFERING, function (b) {
        a.f(new O("ad-buffering", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.IMPRESSION, function (b) {
        a.f(new O("ad-impression", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.DURATION_CHANGE, function (b) {
        a.f(new O("ad-duration-changed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.USER_CLOSE, function (b) {
        a.f(new O("ad-closed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.LOADED, function (b) {
        a.f(new O("ad-loaded", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.ALL_ADS_COMPLETED, function (b) {
        a.f(new O("all-ads-completed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.LINEAR_CHANGED, function (b) {
        a.f(new O("ad-linear-changed", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.AD_METADATA, function (b) {
        a.f(new O("ad-metadata", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.LOG, function (b) {
        a.f(new O("ad-recoverable-error", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.AD_BREAK_READY, function (b) {
        a.f(new O("ad-break-ready", {
          originalEvent: b
        }));
      });
      a.b.s(a.c, google.ima.AdEvent.Type.INTERACTION, function (b) {
        a.f(new O("ad-interaction", {
          originalEvent: b
        }));
      });
    }
    ...
    function cm(a, b) {
      var c = b.getAd();
      a.j = new V(c, a.c);
      a.f(new O("ad-started", {
        ad: a.j,
        sdkAdObject: c,
        originalEvent: b
      }));
      a.h.setAttribute("ad-active", "true");
      a.a.pause();
    }

    function $l(a, b) {
      a.f(new O("ad-stopped", {
        originalEvent: b
      }));
      a.h.removeAttribute("ad-active");
      a.a.play();
    }
    ...
    function dm(a, b, c, d) {
      ...
      a.setLocale(c);
      this.c = new google.ima.dai.api.StreamManager(this.a, this.v, a);
      this.f(new O("ima-stream-manager-loaded", {
        imaStreamManager: this.c
      }));
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.LOADED, function (f) {
        em(e, f);
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.ERROR, function () {
        e.l.length ? e.g.resolve(e.l) : e.g.reject("IMA Stream request returned an error and there was no backup asset uri provided.");
        e.g = null;
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.AD_BREAK_STARTED, function () {});
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.STARTED, function (f) {
        f = f.getAd();
        e.h = new X(f, e.a);
        e.A && (e.h.b = e.A);
        e.f(new O("ad-started", {
          ad: e.h
        }));
        e.v.setAttribute("ad-active", "true");
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.AD_BREAK_ENDED, function () {
        e.v.removeAttribute("ad-active");
        var f = e.a.currentTime;
        e.j && e.j > f && (e.a.currentTime = e.j, e.j = null);
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.AD_PROGRESS, function (f) {
        e.A = f.getStreamData().adProgressData;
        e.h && (e.h.b = e.A);
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.FIRST_QUARTILE, function () {
        e.f(new O("ad-first-quartile"));
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.MIDPOINT, function () {
        e.f(new O("ad-midpoint"));
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.THIRD_QUARTILE, function () {
        e.f(new O("ad-third-quartile"));
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.COMPLETE, function () {
        e.f(new O("ad-complete"));
        e.f(new O("ad-stopped"));
        e.v.removeAttribute("ad-active");
        e.h = null;
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.SKIPPED, function () {
        e.f(new O("ad-skipped"));
        e.f(new O("ad-stopped"));
      });
      this.b.s(this.c, google.ima.dai.api.StreamEvent.Type.CUEPOINTS_CHANGED, function (f) {
        var g = f.getStreamData();
        f = [];
        g = t(g.cuepoints);

        for (var h = g.next(); !h.done; h = g.next()) {
          h = h.value, f.push(new am(h.start, h.end));
        }

        e.f(new O("ad-cue-points-changed", {
          cuepoints: f
        }));
      });
    }
    ...
    dm.prototype.onCueMetadataChange = function (a) {
      if (a.key && a.data) {
        var b = {};
        b[a.key] = a.data;
    ...
    q.initClientSide = function (a, b) {
      var c = this;
      if (!window.google || !google.ima || !google.ima.AdsLoader) throw new L(2, 10, 1E4);
      this.b = new Xl(a, b, this.c, function (d) {
    ...
    q.initServerSide = function (a, b) {
      var c = this;
      if (!window.google || !google.ima || !google.ima.dai) throw new L(2, 10, 10002);
      this.a = new dm(a, b, this.c, function (d) {
        if (d && d.type) switch (d.type) {
          case "ads-loaded":
            c.f.a.push(d.loadTime);
            break;
    ...
    q.requestServerSideStream = function (a, b) {
      ...
      a.adTagParameters.mpv = "v3.1.0";
      c = this.a;
      var d = b;
      c.g ? c = Promise.reject(new L(1, 10, 10004)) : (a instanceof google.ima.dai.api.LiveStreamRequest && (c.C = !0), c.g = new Ge(), c.c.requestStream(a), c.l = d || "", c.D = Date.now() / 1E3, c = c.g);
      return c;
    };
      ...
      return JSON.stringify(a, function (b, c) {
        if ("function" != typeof c) {
          if (c instanceof Event || c instanceof O) {
            ...
            for (f in c) {
              var e = c[f];
              e && "object" == _typeof(e) ? "detail" == f && (d[f] = e) : f in Event || (d[f] = e);
            }
          ...
          } else if (c instanceof TimeRanges) for (f = {
            __type__: "TimeRanges",
            length: c.length,
            start: [],
            end: []
          }, d = t(je(c)), e = d.next(); !e.done; e = d.next()) {
            e = e.value;
            var g = e.end;
    ...
    function gm(a) {
      return JSON.parse(a, function (b, c) {
        if ("NaN" == c) var d = NaN;else if ("-Infinity" == c) d = -Infinity;else if ("Infinity" == c) d = Infinity;else if (c && "object" == _typeof(c) && "TimeRanges" == c.__type__) d = hm(c);else if (c && "object" == _typeof(c) && "Uint8Array" == c.__type__) d = new Uint8Array(c.entries);else if (c && "object" == _typeof(c) && "Error" == c.__type__) {
          d = c.contents;
    ...
    var im = "ended play playing pause pausing ratechange seeked seeking timeupdate volumechange".split(" "),
        jm = "buffered currentTime duration ended loop muted paused playbackRate seeking videoHeight videoWidth volume".split(" "),
        km = ["loop", "playbackRate"],
        lm = ["pause", "play"],
        mm = {
      getAssetUri: 2,
      getAudioLanguages: 4,
      ...
      getPresentationStartTimeAsDate: 20
        ...
        om = [["getConfiguration", "configure"]],
        pm = [["isTextTrackVisible", "setTextTrackVisibility"]],
        qm = "addTextTrack addTextTrackAsync cancelTrickPlay configure resetConfiguration retryStreaming selectAudioLanguage selectTextLanguage selectTextTrack selectVariantTrack selectVariantsByLabel setTextTrackVisibility trickPlay".split(" "),
        rm = ["attach", "detach", "load", "unload"];
    ...
    function sm(a, b, c, d, e, f) {
      ...
      this.A = function (h, k) {
        ...
        switch (l.type) {
          ...
          case "asyncComplete":
            if (n = l.id, l = l.error, p = g.c[n], delete g.c[n], p) if (l) {
    ...
    q.destroy = function () {
      ...
      this.M = this.C = null;
      this.b = this.h = !1;
      this.A = this.v = this.g = this.c = this.a = this.j = null;
      return Promise.resolve();
    };
    ...
    q.init = function () {
      if (this.T.length) if (window.chrome && chrome.cast && chrome.cast.isAvailable) {
        this.h = !0;
        this.f.Yb();
        var a = new chrome.cast.SessionRequest(this.T);
        a = new chrome.cast.ApiConfig(a, function (b) {
          for (var c = t(um), d = c.next(); !d.done; d = c.next()) {
            ym(d.value, b);
          }
        }, function (b) {
          for (var c = t(um), d = c.next(); !d.done; d = c.next()) {
            d = d.value, zm = "available" == b, d.f.Yb();
          }
        }, "origin_scoped");
        chrome.cast.initialize(a, function () {}, function () {});
        zm && this.f.N(Am);
        (a = wm) && a.status != chrome.cast.SessionStatus.STOPPED ? ym(this, a) : wm = null;
      } else window.__onGCastApiAvailable || (window.__onGCastApiAvailable = Bm), window.__onGCastApiAvailable != Bm && Ua("A global Cast SDK hook is already installed! Shaka Player will be unable to receive a notification when the Cast SDK is ready.");
    };
    ...
    q.get = function (a, b) {
      ...
      if ("video" == a) {
        if (lm.includes(b)) return function (d) {
          for (var e = [], f = 0; f < arguments.length; ++f) {
            e[f] = arguments[f];
          }

          return c.ee.apply(c, [a, b].concat(ia(e)));
        };
      } else if ("player" == a) {
        if (nm[b] && !this.get("player", "isLive")()) return function () {};
        if (qm.includes(b)) return function (d) {
          for (var e = [], f = 0; f < arguments.length; ++f) {
            e[f] = arguments[f];
          }
        ...
        if (rm.includes(b)) return function (d) {
          for (var e = [], f = 0; f < arguments.length; ++f) {
            e[f] = arguments[f];
          }

          return c.tf.apply(c, [a, b].concat(ia(e)));
        };
        if (mm[b]) return function () {
          return c.a[a][b];
        };
      }
    ...
    function Dm(a, b, c) {
      wm = c;
      c.addUpdateListener(a.v);
      c.addMessageListener("urn:x-cast:com.google.shaka.v2", a.A);
      tm(a);
      Cm(a, {
        type: "init",
        initState: b,
    ...
    function xm(a) {
      var b = wm;
      b.removeUpdateListener(a.v);
      b.removeMessageListener("urn:x-cast:com.google.shaka.v2", a.A);
    }

    function tm(a) {
      var b = wm ? "connected" == wm.status : !1;
      ...
      a.b = b;
      a.J = b ? wm.receiver.friendlyName : "";
      a.f.Yb();
    }
    ...
    function Cm(a, b) {
      ...
      try {
        ...
        throw c = new L(2, 8, 8005, e), d = new O("error", {
          detail: c
        }), a.C("player", d), a.qb(), c;
      }
    }
    ...
    q.cast = function () {
      var a = this,
          b;
      return J(function (c) {
        return 1 == c.a ? (b = Lm(a), v(c, a.a.cast(b), 2)) : a.c ? v(c, a.c.Kd(), 0) : c["return"]();
      });
    };
    ...
    q.Ae = function (a) {
      ...
      return J(function (c) {
        if (1 == c.a) {
          if (a == b.A) return c["return"]();
          b.A = a;
          b.a.qb();
          return v(c, b.a.destroy(), 2);
        }

        b.a = null;
        b.a = new sm(a, function () {
          return Hm(b);
        }, function () {
          return Im(b);
        }, function (d, e) {
    ...
    function Mm(a) {
      ...
      for (var b = t(im), c = b.next(); !c.done; c = b.next()) {
        a.b.s(a.f, c.value, function (f) {
          a.a.oa() || (f = new O(f.type, f), a.g.dispatchEvent(f));
        });
      }

      for (var d in Ul) {
        a.b.s(a.c, Ul[d], function (f) {
          a.a.oa() || a.j.dispatchEvent(f);
        });
      }
      ...
      for (var e in a.f) {
        b.Db = e, Object.defineProperty(a.h, b.Db, {
          configurable: !1,
          enumerable: !0,
          get: function (f) {
            return function () {
          ...
          set: function (f) {
            return function (g) {
              var h = f.Db;
              a.a.oa() ? a.a.set("video", h, g) : a.f[h] = g;
            };
          }(b)
        }), b = {
          Db: b.Db
    ...
    function Qm(a) {
      ...
      Om(a, function (c, d) {
        if (b.has(d)) {
          var e = b.get(d);
          c.length < e.length ? a.v.set(c, e) : a.v.set(e, c);
        } else b.set(d, c);
      });
    }
    ...
    function Om(a, b) {
      ...
      for (var g = Object.getPrototypeOf({}); f && f != g;) {
        for (var h = t(Object.getOwnPropertyNames(f)), k = h.next(); !k.done; k = h.next()) {
    ...
    function Lm(a) {
      ...
      for (var c = t(km), d = c.next(); !d.done; d = c.next()) {
      ...
      for (d = c.next(); !d.done; d = c.next()) {
        e = d.value, d = e[1], e = a.c[e[0]](), b.playerAfterLoad[d] = e;
      }
    ...
    function Im(a) {
      var b = new O(a.h.paused ? "pause" : "play");
      a.g.dispatchEvent(b);
    }

    function Km(a) {
      for (var b = t(om), c = b.next(); !c.done; c = b.next()) {
        var d = c.value;
        c = d[1];
      ...
      b.then(function () {
        if (a.f) {
          for (var h = t(km), k = h.next(); !k.done; k = h.next()) {
            k = k.value, a.f[k] = g[k];
          }
    ...
    function Nm(a, b) {
      ...
      if (a.a.oa() && 0 == Object.keys(a.a.a.video).length) {
        var c = a.f[b];
        if ("function" != typeof c) return c;
      }

      return a.a.oa() ? a.a.get("video", b) : (c = a.f[b], "function" == typeof c && (c = c.bind(a.f)), c);
    }

    function Pm(a, b) {
      a.v.has(b) && (b = a.v.get(b));
      ...
      if ("getSharedConfiguration" == b) return a.a.get("player", "getConfiguration");
      ...
      return a.a.oa() && 0 == Object.keys(a.a.a.video).length && mm[b] || !a.a.oa() ? a.c[b].bind(a.c) : a.a.get("player", b);
    }

    function Jm(a, b, c) {
      a.a.oa() && ("video" == b ? a.g.dispatchEvent(c) : "player" == b && a.j.dispatchEvent(c));
    }

    K("shaka.cast.CastProxy", Gm);
    Gm.prototype.changeReceiverId = Gm.prototype.Ae;
    Gm.prototype.forceDisconnect = Gm.prototype.qb;
    Gm.prototype.suggestDisconnect = Gm.prototype.Ef;
    Gm.prototype.setAppData = Gm.prototype.Dd;
    Gm.prototype.cast = Gm.prototype.cast;
    Gm.prototype.receiverName = Gm.prototype.vd;
    Gm.prototype.isCasting = Gm.prototype.oa;
    Gm.prototype.canCast = Gm.prototype.xe;
    Gm.prototype.getPlayer = Gm.prototype.Ue;
    Gm.prototype.getVideo = Gm.prototype.bf;
    Gm.prototype.destroy = Gm.prototype.destroy;
    ...
    q.destroy = function () {
      var a = this,
          ...
          c;
      return J(function (d) {
        if (1 == d.a) return a.b && (a.b.release(), a.b = null), b = [], a.c && (b.push(a.c.destroy()), a.c = null), a.H && (a.H.stop(), a.H = null), a.a = null, a.J = null, a.C = null, a.D = !1, a.j = !0, a.g = null, a.l = null, v(d, Promise.all(b), 2);
    ...
    function Xm(a) {
      ...
      for (var c = b.next(); !c.done; c = b.next()) {
        a.b.s(a.a, c.value, function (e) {
          return bn(a, "video", e);
        });
      }

      for (var d in Ul) {
        a.b.s(a.c, Ul[d], function (e) {
          return bn(a, "player", e);
        });
      }

      cast.__platform__ && cast.__platform__.canDisplayType('video/mp4; codecs="avc1.640028"; width=3840; height=2160') ? a.c.Fd(3840, 2160) : a.c.Fd(1920, 1080);
      a.b.s(a.a, "loadeddata", function () {
        a.A = !0;
      });
      a.b.s(a.c, "loading", function () {
        a.j = !1;
        cn(a);
      });
      a.b.s(a.a, "playing", function () {
        a.j = !1;
        cn(a);
      });
      a.b.s(a.a, "pause", function () {
        cn(a);
      });
      a.b.s(a.c, "unloading", function () {
        a.j = !0;
        cn(a);
      });
      a.b.s(a.a, "ended", function () {
        new M(function () {
          a.a && a.a.ended && (a.j = !0, cn(a));
        }).N(dn);
      });
    }
    ...
    function Ym(a) {
      a.h = 0;
      a.v = !0;
      a.D = 0 != cast.receiver.CastReceiverManager.getInstance().getSenders().length;
      cn(a);
    }
    ...
    function gn(a, b, c) {
      ...
      J(function (r) {
        switch (r.a) {
          case 1:
            for (d in b.player) {
              e = b.player[d], a.c[d](e);
            }

            a.C(c);
            f = a.a.autoplay;
            return b.manifest ? (a.a.autoplay = !1, A(r, 5), v(r, a.c.load(b.manifest, b.startTime), 7)) : v(r, Promise.resolve(), 3);
          ...
          case 5:
            return g = E(r), h = Ql, k = new O(h, {
              detail: g
            }), a.c && a.c.dispatchEvent(k), r["return"]();

          case 3:
            if (!a.c) return r["return"]();
    ...
    function Wm(a) {
      ...
      for (var b = {
        video: {},
        player: {}
      }, c = t(jm), d = c.next(); !d.done; d = c.next()) {
        d = d.value, b.video[d] = a.a[d];
      }

      if (a.c.U()) for (var e in nm) {
        0 == a.h % nm[e] && (b.player[e] = a.c[e]());
      }

      for (var f in mm) {
        0 == a.h % mm[f] && (b.player[f] = a.c[f]());
      }
    ...
    function en(a) {
      return a.v && (a.a.duration || a.c.U()) ? (jn(a), a.v = !1, !0) : !1;
    }

    function jn(a, b) {
      var c = {
        contentId: a.c.fd(),
        streamType: a.c.U() ? "LIVE" : "BUFFERED",
        contentType: ""
      };
      a.c.U() || (c.duration = a.a.duration);
      a.f && (c.metadata = a.f);
      fn(a, void 0 === b ? 0 : b, c);
    }
    ...
    function $m(a, b) {
      ...
      switch (c.type) {
        ...
        case "SEEK":
          ...
          e && "PLAYBACK_START" == e ? (a.a.play(), fn(a)) : e && "PLAYBACK_PAUSE" == e && (a.a.pause(), fn(a));
          break;

        case "STOP":
          a.c.Kd().then(function () {
            a.c && fn(a);
          });
          break;

        case "GET_STATUS":
          jn(a, Number(c.requestId));
          break;
    ...
    function Zm(a, b, c, d) {
      a.D && (a = fm(b), d ? c.getCastChannel(d).send(a) : c.broadcast(a));
    }
    ...
    function fn(a, b, c) {
      ...
      var d = {
        ...
        playerState: a.j ? ln : a.c.hd() ? mn : a.a.paused ? nn : on,
    ...
    K("shaka.cast.CastReceiver", Rm);
    Rm.prototype.destroy = Rm.prototype.destroy;
    Rm.prototype.setContentArtist = Rm.prototype.yf;
    Rm.prototype.setContentImage = Rm.prototype.zf;
    Rm.prototype.setContentTitle = Rm.prototype.Bf;
    Rm.prototype.clearContentMetadata = Rm.prototype.De;
    Rm.prototype.setContentMetadata = Rm.prototype.Af;
    Rm.prototype.isIdle = Rm.prototype.ef;
    Rm.prototype.isConnected = Rm.prototype.isConnected;
    var hn = .5,
        dn = 5,
        ln = "IDLE",
        on = "PLAYING",
    ...
    function pn(a) {
      ...
      this.b = [];
      this.data = [];
      new Qb().box("moov", Ub).S("pssh", function (c) {
        if (!(1 < c.version)) {
          var d = pb(c.reader.P, -12, c.size);
          b.data.push(d);
          b.a.push(oc(c.reader.Va(16)));
          ...
          if (0 < c.version) {
            ...
            for (var e = d.next(); !e.done; e = d.next()) {
              e = oc(c.reader.Va(16)), b.b.push(e);
            }
          }
        }
      }).parse(a);
    ...
    function qn(a) {
      var b = new Uint8Array([154, 4, 240, 121, 152, 64, 66, 134, 171, 146, 230, 91, 224, 136, 95, 149]),
          c = a.length,
          d = b.length + 16 + c,
          e = new Uint8Array(d),
          f = tb(e),
    ...
    function yn(a) {
      return Array.from(a.childNodes).every(zn) ? a.textContent.trim() : null;
    }
    ...
    function Ln(a, b, c) {
      ...
      }), f.length && (a = Nn(e, f, c), 0 == a.length && (a = [Ae("", e)])));
      if (d.length && (b || !f.length)) for (a = [], b = t(Object.values(c)), c = b.next(); !c.done; c = b.next()) {
        c = c.value, "org.w3.clearkey" != c && a.push(Ae(c, e));
      }
      if (g = Array.from(g)[0] || null) for (b = t(a), c = b.next(); !c.done; c = b.next()) {
    ...
    function On(a, b, c, d) {
      ...
      }), 0 == b.drmInfos.length)) throw new L(2, 4, 4008);
    ...
    function Rn(a) {
      a = un(a.node, "urn:microsoft:playready", "pro");
      if (!a) return "";
      a = mc(a.textContent);
      a = Pn(a).filter(function (b) {
        return b.type === Sn;
      })[0];
      if (!a) return "";
      a = xb(a.value, !0);
      return (a = Jn(a, "WRMHEADER")) ? Qn(a) : "";
    }
    ...
    function Nn(a, b, c) {
      ...
      for (var e = b.next(); !e.done; e = b.next()) {
        ...
        if (f) {
          var g;
          (g = un(e.node, "urn:microsoft:playready", "pro")) ? (g = mc(g.textContent), g = [{
            initData: qn(g),
            initDataType: "cenc",
            keyId: e.keyId
          }]) : g = null;
          g = Ae(f, e.init || a || g);
          if (f = Tn.get(f)) g.licenseServerUri = f(e);
          d.push(g);
        }
      }
    ...
    function Un(a) {
      var b = a.getAttribute("schemeIdUri"),
          c = xn(a, "urn:mpeg:cenc:2013", "default_KID"),
          d = vn(a, "urn:mpeg:cenc:2013", "pssh").map(yn);
      if (!b) return null;
      b = b.toLowerCase();
      if (c && (c = c.replace(/-/g, "").toLowerCase(), c.includes(" "))) throw new L(2, 4, 4009);
      var e = [];
    ...
    var Sn = 1,
        Tn = new Map().set("com.widevine.alpha", function (a) {
      return (a = un(a.node, "urn:microsoft", "laurl")) ? a.getAttribute("licenseUrl") || "" : "";
    }).set("com.microsoft.playready", Rn).set("com.microsoft.playready.recommendation", Rn).set("com.microsoft.playready.software", Rn).set("com.microsoft.playready.hardware", Rn);
    ...
    function Wn(a, b) {
      var c = Xn(a, b, "timescale"),
          d = 1;
      c && (d = Fn(c) || 1);
      var e = Xn(a, b, "duration");
      c = Fn(e || "");
      "image" == a.G.contentType && (c = Hn(e || ""));
      c && (c /= d);
      var f = Xn(a, b, "startNumber");
      e = Number(Xn(a, b, "presentationTimeOffset")) || 0;
      var g = Gn(f || "");
      if (null == f || null == g) g = 1;
      var h = Yn(a, b, "SegmentTimeline");
      f = null;

      if (h) {
        f = d;
        var k = a.O.duration || Infinity,
            l = tn(h, "S");
        h = [];
        var m = -e;
        l = t(lb(l));
        ...
        for (var n = l.next(); !n.done; n = l.next()) {
          ...
          if (0 > u) if (r) {
            r = An(r, "t", Gn);
            if (null == r) break;else if (p >= r) break;
            u = Math.ceil((r - p) / n) - 1;
          } else {
    ...
    function Xn(a, b, c) {
      return [b(a.G), b(a.ea), b(a.la)].filter(Nb).map(function (d) {
    ...
    function Zn(a, b, c, d, e, f) {
      for (var g = xn(a, "http://www.w3.org/1999/xlink", "href"), h = xn(a, "http://www.w3.org/1999/xlink", "actuate") || "onRequest", k = t(Array.from(a.attributes)), l = k.next(); !l.done; l = k.next()) {
        l = l.value, "http://www.w3.org/1999/xlink" == l.namespaceURI && a.removeAttributeNS(l.namespaceURI, l.localName);
      }

      if (5 <= f) return Qg(new L(2, 4, 4028));
      if ("onLoad" != h) return Qg(new L(2, 4, 4027));
      var m = ze([d], [g]);
      return e.request(0, eh(m, b)).W(function (n) {
        n = Kn(n.data, a.tagName);
        if (!n) return Qg(new L(2, 4, 4001, g));
    ...
    function $n(a, b, c, d, e, f) {
      ...
      if (xn(a, "http://www.w3.org/1999/xlink", "href")) {
        var g = Zn(a, b, c, d, e, f);
        c && (g = g.W(void 0, function () {
      ...
      for (var h = t(Array.from(a.childNodes)), k = h.next(); !k.done; k = h.next()) {
        k = k.value, k instanceof Element && ("urn:mpeg:dash:resolve-to-zero:2013" == xn(k, "http://www.w3.org/1999/xlink", "href") ? a.removeChild(k) : "SegmentTimeline" != k.tagName && g.push($n(k, b, c, d, e, f)));
      }

      return Ug(g).W(function () {
        return a;
      });
    }
    ...
    function bo(a, b, c, d, e, f, g) {
      ...
      if (0 == g.version) {
        var l = g.reader.I();
        var m = g.reader.I();
      } else l = g.reader.gb(), m = g.reader.gb();
      ...
      for (m = n.next(); !m.done; m = n.next()) {
        ...
        h.push(new oi(l / k + c, (l + r) / k + c, function () {
          return f;
        }, a, a + p - 1, b, c, d, e));
        l += r;
        a += p;
    ...
    function eo(a) {
      ...
      a: {
        ...
        for (var e = d.next(); !e.done; e = d.next()) {
          if (nb(b, new Uint8Array(e.value))) {
            d = !0;
            break a;
          }
        }
      ...
      if (d) b = a.b.byteLength - a.a.Z();else {
        ...
        for (var f = e.next(); !f.done; f = e.next()) {
          f = f.value;
          var g = f.item;
          d = 0 == f.ba ? g & (1 << 8 - b.length) - 1 : 256 * d + g;
        }
    ...
    var go = [[255], [127, 255], [63, 255, 255], [31, 255, 255, 255], [15, 255, 255, 255, 255], [7, 255, 255, 255, 255, 255], [3, 255, 255, 255, 255, 255, 255], [1, 255, 255, 255, 255, 255, 255, 255]];
    ...
    function io(a) {
      ...
      if (8 == a.a.byteLength && a.a.getUint8(0) & 224) throw new L(2, 3, 3001);

      for (var b = 0, c = t(ib(a.a.byteLength)), d = c.next(); !d.done; d = c.next()) {
    ...
    function jo(a, b, c, d, e, f, g, h, k) {
      ...
      for (var n = null, p = null; a.ha();) {
        ...
        if (187 == r.id) {
          var u = ko(r);
          u && (r = c * u.Kf, u = b + u.sf, null != n && m.push(new oi(n + g, r + g, l, p, u - 1, f, g, h, k)), n = r, p = u);
        }
      }

      null != n && m.push(new oi(n + g, d + g, l, p, null, f, g, h, k));
      return m;
    }
    ...
    function lo(a, b) {
      ...
      e = 0;
      var f = null;
      if (c = An(c, "range", Dn)) e = c.start, f = c.end;
      return new mi(function () {
        return d;
      }, e, f);
    }

    function mo(a, b) {
      var c = Number(Xn(a, no, "presentationTimeOffset")) || 0,
          d = Xn(a, no, "timescale"),
          e = 1;
      d && (e = Fn(d) || 1);
      var f = c / e || 0,
      ...
      return {
        rb: function rb() {
          var k = Yn(h, no, "RepresentationIndex"),
              l = h.G.ua;
          k && (k = k.getAttribute("sourceURL")) && (l = ze(h.G.ua, [k]));
          k = po(h);
          return qo(h, b, g, l, k.start, k.end, f);
        }
      };
    }

    function qo(a, b, c, d, e, f, g) {
      var h, k, l, m, n, p, r, u, x, w, y, D, C, B, F;
      return J(function (G) {
        if (1 == G.a) return h = a.presentationTimeline, k = !a.Za || !a.O.Xd, l = a.O.start, m = a.O.duration, n = a.G.mimeType.split("/")[1], p = b, r = null, u = [p(d, e, f), "webm" == n ? p(c.ga(), c.da, c.Y) : null], p = null, v(G, Promise.all(u), 2);
        x = G.b;
        w = x[0];
        y = x[1] || null;
        D = null;
        ...
        B = l;
        F = m ? l + m : Infinity;
        if ("mp4" == n) var H = ao(w, e, d, c, C, B, F);else {
          H = new co(y);
          if (440786851 != eo(H).id) throw new L(2, 3, 3008);
          var I = eo(H);
          if (408125543 != I.id) throw new L(2, 3, 3009);
          H = I.a.byteOffset;
          I = new co(I.a);
          ...
          if (!N) throw new L(2, 3, 3010);
          N = new co(N.a);
          T = 1E6;

          for (I = null; N.ha();) {
            var Q = eo(N);
            if (2807729 == Q.id) T = io(Q);else if (17545 == Q.id) if (4 == Q.a.byteLength) I = Q.a.getFloat32(0);else if (8 == Q.a.byteLength) I = Q.a.getFloat64(0);else throw new L(2, 3, 3003);
          }

          if (null == I) throw new L(2, 3, 3011);
          N = T / 1E9;
          I *= N;
          T = eo(new co(w));
          if (475249515 != T.id) throw new L(2, 3, 3007);
          H = jo(T, H, N, I, d, c, C, B, F);
        }
        D = H;
        h.yb(D);
        r = new S(D);
    ...
    function po(a) {
      var b = Yn(a, no, "RepresentationIndex");
      a = Xn(a, no, "indexRange");
      a = Dn(a || "");
      b && (a = An(b, "range", Dn, a));
      return a;
    }
    ...
    function oo(a, b) {
      ro(a, b);
      if (!po(a)) throw new L(2, 4, 4002);
    }

    function ro(a, b) {
      var c = a.G.mimeType.split("/")[1];
      if (a.G.contentType != Ee && "mp4" != c && "webm" != c) throw new L(2, 4, 4006);
    ...
    function so(a, b) {
      var c = lo(a, to),
          d = uo(a);
      if (!d.ca && !d.timeline && 1 < d.vb.length) throw new L(2, 4, 4002);
      if (!d.ca && !a.O.duration && !d.timeline && 1 == d.vb.length) throw new L(2, 4, 4002);
      if (d.timeline && 0 == d.timeline.length) throw new L(2, 4, 4002);
      var e = null,
          f = null;
      a.la.id && a.G.id && (f = a.la.id + "," + a.G.id, e = b[f]);
      c = vo(a.O.start, a.O.duration, a.G.ua, d, c);
      d = !e;
      e ? e.wb(c, a.presentationTimeline.Ua()) : (a.presentationTimeline.yb(c), e = new S(c), f && a.Za && (b[f] = e));
      a.Za && a.O.Xd || e.Sa(a.O.start, a.O.duration ? a.O.start + a.O.duration : Infinity, d);
      return {
        rb: function rb() {
    ...
    function uo(a) {
      ...
      0 == c && (c = 1);
      var d = 0;
      a.ca ? d = a.ca * (c - 1) : a.timeline && 0 < a.timeline.length && (d = a.timeline[0].start);
      return {
        ca: a.ca,
        startTime: d,
        Cb: c,
    ...
    function vo(a, b, c, d, e) {
      var f = d.vb.length;
      d.timeline && d.timeline.length != d.vb.length && (f = Math.min(d.timeline.length, d.vb.length));
      var g = a - d.Pa,
          h = b ? a + b : Infinity,
          k = [],
          l = d.startTime,
      ...
      for (var n = f.next(); !n.done; m = {
        ...
        m.Oc = ze(c, [p.hf]);
        var r = void 0;
        r = null != d.ca ? l + d.ca : d.timeline ? d.timeline[n].end : l + b;
        k.push(new oi(a + l, a + r, function (u) {
          return function () {
            return u.Oc;
          };
    ...
    function wo(a) {
      return [a.G.Wa, a.ea.Wa, a.la.Wa].filter(Nb).map(function (b) {
        return tn(b, "SegmentURL");
      }).reduce(function (b, c) {
        return 0 < b.length ? b : c;
      }).map(function (b) {
        b.getAttribute("indexRange") && !a.Vd && (a.Vd = !0);
        var c = b.getAttribute("media");
        b = An(b, "mediaRange", Dn, {
          start: 0,
          end: null
        });
        return {
    ...
    function xo(a, b, c, d, e) {
      ...
      Ao(g);
      var h = Yg(a);
      if (g.Rb) return ro(a, f), {
        rb: function rb() {
          var r = Vn(g.Rb, h.G.id, null, h.bandwidth || null, null);
          r = ze(h.G.ua, [r]);
          return qo(h, b, f, r, 0, null, g.Pa);
        }
      };
      if (g.ca) return d || (a.presentationTimeline.pd(g.ca), a.presentationTimeline.qd(a.O.start)), {
        rb: function rb() {
          return Bo(h, g, e, f);
        }
      };
      var k = null;
      d = null;
      a.la.id && a.G.id && (d = a.la.id + "," + a.G.id, k = c[d]);
      var l = Co(h, g, f),
          m = a.O.start,
          n = a.O.duration ? a.O.start + a.O.duration : Infinity,
          p = Infinity != n;
      k ? (p && new S(l).Sa(m, n, !0), k.wb(l, a.presentationTimeline.Ua())) : (a.presentationTimeline.yb(l), k = new S(l), d && a.Za && (c[d] = k));
      p && k.Sa(m, n);
      return {
        rb: function rb() {
    ...
    function Ao(a) {
      ...
      1 != b && (a.Rb && (a.timeline = null), a.ca = null);
      if (!a.Rb && !a.od) throw new L(2, 4, 4002);
    }
    ...
    function Bo(a, b, c, d) {
      function e(G) {
        var H = (G - n) * m,
            I = H + b.Pa;
        H += h;
        return new oi(H, Math.min(H + m, l), function () {
          var N = Vn(r, x, G, u, I * p);
          return ze(w, [N]);
        }, 0, null, d, y, h, l);
      }

      function f() {
        var G = [Math.max(g.Ua(), h), Math.min(g.Ta(), l)].map(function (H) {
          return H - h;
        });
        return [Math.ceil(G[0] / m), Math.ceil(G[1] / m) - 1].map(function (H) {
          return H + n;
        });
      }
      ...
      var g = a.presentationTimeline,
          ...
          y = h - b.Pa;
      k = f();
      a = a.Za ? Math.max(k[0], k[1] - c + 1) : k[0];
      c = k[1];
      k = [];
    ...
    function Co(a, b, c) {
      ...
      for (var g = [], h = {}, k = t(lb(b.timeline)), l = k.next(); !l.done; h = {
        Nc: h.Nc,
        Qc: h.Qc,
        Tc: h.Tc,
        Kc: h.Kc,
        ...
        h.Vc = p + b.Ld;
        h.Qc = a.G.id;
        h.Kc = a.bandwidth || null;
        h.Nc = b.od;
        h.Lc = a.G.ua;
        g.push(new oi(d + n, d + m, function (r) {
          return function () {
            var u = Vn(r.Nc, r.Qc, r.Tc, r.Kc || null, r.Vc);
            return ze(r.Lc, [u]).map(function (x) {
              return x.toString();
            });
          };
        }(h), 0, null, c, f, d, e));
    ...
    function yo(a) {
      var b = Xn(a, Do, "initialization");
      if (!b) return null;
      var c = a.G.id,
          d = a.bandwidth || null,
          e = a.G.ua;
      return new mi(function () {
        var f = Vn(b, c, null, d, null);
        return ze(e, [f]);
      }, 0, null);
    }
    ...
    Eo.prototype.release = function () {
      for (var a = t(this.a.concat(this.b, this.f, this.c)), b = a.next(); !b.done; b = a.next()) {
    ...
    function Fo(a, b, c) {
      var d, e, f, g, h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G, H, I, N, T, Q, W, P, ja, qa, ea, Za;
      return J(function (Da) {
        switch (Da.a) {
          case 1:
            d = Fe;
            Go(b);
            ...
            for (h = g.next(); !h.done; h = g.next()) {
              l = k = h.value, m = l.ba, n = l.item, a.h.has(n.id) || (a.h.add(n.id), -1 == f && (f = m));
            }
            ...
            return v(Da, Ko(a.a, p, f, Lo, Mo), 3);

          case 3:
            return v(Da, Ko(a.b, r, f, Lo, Mo), 4);

          case 4:
            return v(Da, Ko(a.f, u, f, Lo, Mo), 5);

          case 5:
            return v(Da, Ko(a.c, x, f, Lo, Mo), 2);

          case 2:
            C = 0;
            B = [];
            if (a.b.length && a.a.length) for (T = t(a.a), Q = T.next(); !Q.done; Q = T.next()) {
              for (W = Q.value, P = t(a.b), ja = P.next(); !ja.done; ja = P.next()) {
                qa = ja.value, ea = ei(W.drmInfos, qa.drmInfos), W.drmInfos.length && qa.drmInfos.length && !ea.length || (Za = C++, B.push({
                  id: Za,
                  language: W.language,
                  primary: W.primary,
                  audio: W,
                  video: qa,
                  bandwidth: (W.bandwidth || 0) + (qa.bandwidth || 0),
                  drmInfos: ea,
                  allowedByApplication: !0,
                  allowedByKeySystem: !0,
                  decodingInfos: []
            ...
            } else for (F = a.b.concat(a.a), G = t(F), H = G.next(); !H.done; H = G.next()) {
              I = H.value, N = C++, B.push({
                id: N,
                language: I.language,
                primary: I.primary,
                audio: I.type == d.Xa ? I : null,
                video: I.type == d.Ja ? I : null,
    ...
    function Go(a) {
      ...
      for (var b = a.next(); !b.done; b = a.next()) {
        ...
        for (var c = [], d = t(b.mc), e = d.next(); !e.done; e = d.next()) {
          e = e.value;

          for (var f = !1, g = t(c), h = g.next(); !h.done; h = g.next()) {
            h = h.value, e.id != h.id && e.channelsCount == h.channelsCount && e.language == h.language && e.bandwidth == h.bandwidth && e.label == h.label && e.codecs == h.codecs && e.mimeType == h.mimeType && wc(e.roles, h.roles) && e.audioSamplingRate == h.audioSamplingRate && e.primary == h.primary && (f = !0);
          }
    ...
    function Io(a) {
      ...
      for (var b = a.next(); !b.done; b = a.next()) {
        ...
        for (var c = [], d = t(b.textStreams), e = d.next(); !e.done; e = d.next()) {
          ...
          for (var f = !1, g = t(c), h = g.next(); !h.done; h = g.next()) {
            h = h.value, e.id != h.id && e.language == h.language && e.label == h.label && e.codecs == h.codecs && e.mimeType == h.mimeType && wc(e.roles, h.roles) && (f = !0);
          }
    ...
    function Ho(a) {
      ...
      for (var b = a.next(); !b.done; b = a.next()) {
        ...
        for (var c = [], d = t(b.Hc), e = d.next(); !e.done; e = d.next()) {
          e = e.value;

          for (var f = !1, g = t(c), h = g.next(); !h.done; h = g.next()) {
            h = h.value, e.id != h.id && e.width == h.width && e.frameRate == h.frameRate && e.codecs == h.codecs && e.mimeType == h.mimeType && e.label == h.label && wc(e.roles, h.roles) && qh(e.closedCaptions, h.closedCaptions) && e.bandwidth == h.bandwidth && (f = !0);
          }
    ...
    function No(a) {
      var b, c, d, e, f, g, h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G;
      return J(function (H) {
        switch (H.a) {
          case 1:
            b = Fe;
            ...
            return v(H, Ko([], c, 0, Oo, Po), 2);

          case 2:
            return k = H.b, v(H, Ko([], d, 0, Oo, Po), 3);

          case 3:
            return l = H.b, v(H, Ko([], e, 0, Oo, Po), 4);

          case 4:
            m = H.b;
            n = 0;
            if (l.length && k.length) for (w = t(k), y = w.next(); !y.done; y = w.next()) {
              for (D = y.value, C = t(l), B = C.next(); !B.done; B = C.next()) {
                F = B.value, G = n++, F.variantIds.push(G), D.variantIds.push(G);
              }
            } else for (p = l.concat(k), r = t(p), u = r.next(); !u.done; u = r.next()) {
              x = u.value, x.variantIds = [n++];
            }
            return H["return"](l.concat(k, m));
        }
      });
    }

    function Ko(a, b, c, d, e) {
      var f, g, h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G, H, I, N, T, Q, W;
      return J(function (P) {
        switch (P.a) {
          case 1:
            f = Fe;
            ...
            for (k = h.next(); !k.done; k = h.next()) {
              m = l = k.value, n = m.ba, p = m.item, n >= c ? g.push(new Set(p)) : g.push(new Set());
            }
          ...
          case 2:
            ...
            x = u.value;
            return v(P, Qo(x, b, c, e, g), 5);

          case 5:
            w = P.b;
            if (!w) throw new L(2, 4, 4037);
            u = r.next();
            P.m(2);
            break;
          ...
          case 8:
            ...
            for (D = I.next(); !D.done; D = I.next()) {
              for (N = D.value, T = {}, Q = t(N), F = Q.next(); !F.done; T = {
                ob: T.ob
              }, F = Q.next()) {
                if (T.ob = F.value, T.ob.type != f.$ || T.ob.language) if (W = a.some(function (ja) {
                  return function (qa) {
                    return qa.mimeType == ja.ob.mimeType && Te(qa.codecs) == Te(ja.ob.codecs);
                  };
                }(T))) throw new L(2, 4, 4037);
              }
            }
    ...
    function Qo(a, b, c, d, e) {
      var f;
      return J(function (g) {
        if (1 == g.a) return (f = So(b, a)) ? v(g, Promise.all(f.map(function (h) {
    ...
    function Ro(a, b, c, d, e) {
      var f, g;
      return J(function (h) {
        if (1 == h.a) return f = c(a), (g = So(b, f)) ? f.createSegmentIndex ? v(h, Promise.all(g.map(function (k) {
          return k.createSegmentIndex();
        })), 2) : h.m(2) : h["return"](null);
        To(f, g, 0, d, e);
        return h["return"](f);
      });
    }
    ...
    function To(a, b, c, d, e) {
      ...
      for (var f = b.next(); !f.done; f = b.next()) {
        ...
        if (f >= c) {
          d(a, g);
          var h = !0;
          "audio" == a.type && 0 == Of(a.language, g.language) && (h = !1);
          h && e[f]["delete"](g);
        }
      }
    }
    ...
    function Mo(a, b) {
      ...
      var c = b.keyIds;
      c = new Set(ia(a.keyIds).concat(ia(c)));
      a.keyIds = c;
      null == a.originalId ? a.originalId = b.originalId : a.originalId += "," + (b.originalId || "");
      c = ei(a.drmInfos, b.drmInfos);
      if (b.drmInfos.length && a.drmInfos.length && !c.length) throw new L(2, 4, 4038);
      a.drmInfos = c;
      ...
      a.segmentIndex.g.push(b.segmentIndex);
      b.trickModeVideo ? (a.trickModeVideo || (a.trickModeVideo = Lo(b.trickModeVideo), a.trickModeVideo.segmentIndex = a.segmentIndex.clone()), Mo(a.trickModeVideo, b.trickModeVideo)) : a.trickModeVideo && Mo(a.trickModeVideo, b);
    }
    ...
    function Uo(a, b) {
      ...
      if (!(c = b.mimeType != a.mimeType || Te(b.codecs) != Te(a.codecs)) && (c = a.drmInfos)) {
        c = a.drmInfos;
        var d = b.drmInfos;
        c = !(c.length && d.length ? 0 < ei(c, d).length : 1);
      }
    ...
    function Vo(a, b) {
      return a.language ? b.language ? 0 == Of(a.language, b.language) || b.kind != a.kind ? !1 : !0 : !0 : !1;
    }
    ...
    function Xo(a, b, c) {
      ...
      var d = Of(a.language, b.language),
          e = Of(a.language, c.language);
      if (e > d) return !0;
      if (e < d) return !1;
      ...
      d = ap(a.channelsCount, b.channelsCount, c.channelsCount);
      if (d == bp) return !0;
      if (d == cp) return !1;
      d = ap(a.audioSamplingRate, b.audioSamplingRate, c.audioSamplingRate);
      return d == bp ? !0 : d == cp ? !1 : a.bandwidth && dp(a.bandwidth, b.bandwidth, c.bandwidth) == bp ? !0 : !1;
    }

    function Yo(a, b, c) {
      if (a.id == c.id) return !0;
      var d = ap(a.width * a.height, b.width * b.height, c.width * c.height);
      if (d == bp) return !0;
      if (d == cp) return !1;

      if (a.frameRate) {
        d = ap(a.frameRate, b.frameRate, c.frameRate);
        if (d == bp) return !0;
        if (d == cp) return !1;
      }

      return a.bandwidth && dp(a.bandwidth, b.bandwidth, c.bandwidth) == bp ? !0 : !1;
    }
    ...
    function ap(a, b, c) {
      if (b == a && a != c) return cp;
      if (c == a && a != b) return bp;

      if (b > a) {
        if (c <= a || c - a < b - a) return bp;
        if (c - a > b - a) return cp;
      } else {
        if (c > a) return cp;
        if (a - c < a - b) return bp;
        if (a - c > a - b) return cp;
      }
    ...
    q.start = function (a, b) {
      var c = this,
          d;
      return J(function (e) {
        if (1 == e.a) return c.h = b.isLowLatencyMode(), c.b = [a], c.u = b, v(e, gp(c), 2);
        d = e.b;
        c.u && hp(c, d);
        if (!c.u) throw new L(2, 7, 7001);
        return e["return"](c.o);
      });
    };

    q.stop = function () {
      for (var a = t(Object.values(this.f)), b = a.next(); !b.done; b = a.next()) {
        b.value.release();
      }
    ...
    q.update = function () {
      var a = this,
          b;
      return J(function (c) {
        if (1 == c.a) return A(c, 2), v(c, gp(a), 4);
        if (2 != c.a) return wa(c, 0);
        b = E(c);
        if (!a.u || !b) return c["return"]();
        a.u.onError(b);
        z(c);
      });
    };
    ...
    function gp(a) {
      var b, c, d, e, f, g, h;
      return J(function (k) {
        if (1 == k.a) return b = eh(a.b, a.i.retryParameters), c = a.u.networkingEngine, d = Date.now(), e = c.request(0, b), $g(a.g, e), v(k, e.promise, 2);

        if (3 != k.a) {
          f = k.b;
          if (!a.u) return k["return"](0);
          f.uri && !a.b.includes(f.uri) && a.b.unshift(f.uri);
          return v(k, ip(a, f.data, f.uri), 3);
        }
    ...
    function ip(a, b, c) {
      ...
      return J(function (k) {
        if (1 == k.a) {
          ...
          if (e = a.i.dash.disableXlinkProcessing) return k["return"](jp(a, d, c));
          f = a.i.dash.xlinkFailGracefully;
          g = $n(d, a.i.retryParameters, f, c, a.u.networkingEngine);
          $g(a.g, g);
          return v(k, g.promise, 2);
        }

        h = k.b;
        return k["return"](jp(a, h, c));
      });
    }
    ...
    function jp(a, b, c) {
      ...
      return J(function (Da) {
        switch (Da.a) {
          case 1:
            d = [c];
            e = tn(b, "Location").map(yn).filter(Nb);
            0 < e.length && (f = ze(d, e), d = a.b = f);
            g = tn(b, "BaseURL");
            h = g.map(yn);
            k = ze(d, h);
            l = 0;
            g && g.length && (l = An(g[0], "availabilityTimeOffset", Hn) || 0);
            m = a.i.dash.ignoreMinBufferTime;
            n = 0;
            m || (n = An(b, "minBufferTime", Cn) || 0);
            a.l = An(b, "minimumUpdatePeriod", Cn, -1);
            p = An(b, "availabilityStartTime", Bn);
            r = An(b, "timeShiftBufferDepth", Cn);
            u = a.i.dash.ignoreSuggestedPresentationDelay;
            x = null;
            u || (x = An(b, "suggestedPresentationDelay", Cn));
            w = a.i.dash.ignoreMaxSegmentDuration;
            y = null;
            w || (y = An(b, "maxSegmentDuration", Cn));
            D = b.getAttribute("type") || "static";
            if (a.o) for (C = a.o.presentationTimeline, B = t(Object.values(a.f)), F = B.next(); !F.done; F = B.next()) {
              G = F.value, G.$a(C.Ua());
            } else H = a.i.defaultPresentationDelay || 1.5 * n, I = null != x ? x : H, C = new R(p, I, a.i.dash.autoCorrectDrift);
            N = b.getAttribute("profiles") || "";
            T = {
              Za: "static" != D,
            ...
            var Ia = An(b, "mediaPresentationDuration", Cn),
                Cc = [],
                jb = 0,
                Bb = tn(b, "Period");
            Bb = t(lb(Bb));

            for (var $a = Bb.next(); !$a.done; $a = Bb.next()) {
              var Pb = $a.value;
              $a = Pb.item;
              Pb = Pb.next;
              jb = An($a, "start", Cn, jb);
              var kf = An($a, "duration", Cn),
                  qb = null;

              if (Pb) {
                var Zd = An(Pb, "start", Cn);
                null != Zd && (qb = Zd - jb);
              } else null != Ia && (qb = Ia - jb);
            ...
            P = Q.periods;
            C.Xb("static" == D);
            "static" != D && Q.Qd || C.Fa(W || Infinity);
            a.c && !a.h && (ja = a.u.isAutoLowLatencyMode()) && (a.u.enableLowLatencyMode(), a.h = a.u.isLowLatencyMode());
            a.h ? C.ke(a.c) : a.c && Ua("Low-latency DASH live stream detected, but low-latency streaming mode is not enabled in Shaka Player. Set streaming.lowLatencyMode configuration to true, and see https://bit.ly/3clctcj for details.");
            (qa = C.U()) && !isNaN(a.i.availabilityWindowOverride) && (r = a.i.availabilityWindowOverride);
            null == r && (r = Infinity);
            C.Hd(r);
            C.pd(y || 1);
            return v(Da, Fo(a.a, P, T.Za), 2);

          case 2:
            if (a.o) {
              a.o.variants = a.a.g;
              a.o.textStreams = a.a.f;
              a.o.imageStreams = a.a.c;
              a.u.filter(a.o);
              Da.m(3);
              break;
            }
            ...
            ea = tn(b, "UTCTiming");
            return v(Da, lp(a, k, ea), 5);

          case 5:
            Za = Da.b;
            if (!a.u) return Da["return"]();
            C.le(Za);

          case 3:
            a.u.makeTextStreamsForClosedCaptions(a.o), z(Da);
        }
      });
    }

    function kp(a, b, c, d) {
      b.la = mp(d.node, null, c);
      b.O = d;
      b.la.pb = b.pb;
      b.la.id || (b.la.id = "__shaka_period_" + d.start);
      c = tn(d.node, "EventStream");
      c = t(c);

      for (var e = c.next(); !e.done; e = c.next()) {
        np(a, d.start, d.duration, e.value);
      }

      c = tn(d.node, "AdaptationSet").map(function (m) {
        return op(a, b, m);
      }).filter(Nb);
        ...
        for (var h = g.next(); !h.done; h = g.next()) {
          ...
          if (f.includes(k.id)) {
            ...
            for (var l = k.next(); !l.done; h = {
              ...
              h.dc = l.value, h.dc.trickModeVideo = e.streams.find(function (m) {
                return function (n) {
                  return Te(m.dc.codecs) == Te(n.codecs);
                };
              }(h));
            }
          }
      ...
      e = a.i.disableAudio ? [] : pp(d, "audio");
      g = a.i.disableVideo ? [] : pp(d, "video");
      f = a.i.disableText ? [] : pp(d, Ee);
      c = a.i.disableThumbnails ? [] : pp(d, "image");
      if (!g.length && !e.length) throw new L(2, 4, 4004);
      d = [];
      e = t(e);

      for (h = e.next(); !h.done; h = e.next()) {
        d.push.apply(d, ia(h.value.streams));
      }
      ...
      for (h = g.next(); !h.done; h = g.next()) {
        e.push.apply(e, ia(h.value.streams));
      }
      ...
      for (h = f.next(); !h.done; h = f.next()) {
        g.push.apply(g, ia(h.value.streams));
      }
      ...
      for (h = c.next(); !h.done; h = c.next()) {
        f.push.apply(f, ia(h.value.streams));
      }
    ...
    function op(a, b, c) {
      ...
      l = tn(c, "EssentialProperty");
      e = null;
      k = !1;
      l = t(l);

      for (var m = l.next(); !m.done; m = l.next()) {
        m = m.value, "http://dashif.org/guidelines/trickmode" == m.getAttribute("schemeIdUri") ? e = m.getAttribute("value") : k = !0;
      }

      l = tn(c, "Accessibility");
      var n = new Map();
      l = t(l);
        ...
        if ("urn:scte:dash:cc:cea-608:2015" == m) {
          if (m = 1, null != p) {
            ...
            for (var r = t(p), u = r.next(); !u.done; u = r.next()) {
              var x = u.value,
                  w = u = void 0;
              x.includes("=") ? (x = x.split("="), u = x[0].startsWith("CC") ? x[0] : "CC" + x[0], w = x[1]) : (u = "CC" + m, 2 == p.length ? m += 2 : m++, w = x);
              n.set(u, Kf(w));
            }
          } else n.set("CC1", "und");
        } else if ("urn:scte:dash:cc:cea-708:2015" == m) {
          if (m = 1, null != p) for (p = t(p.split(";")), u = p.next(); !u.done; u = p.next()) {
            u = u.value, x = r = void 0, u.includes("=") ? (u = u.split("="), r = "svc" + u[0], x = u[1].split(",")[0].split(":").pop()) : (r = "svc" + m, m++, x = u), n.set(r, Kf(x));
          } else n.set("svc1", "und");
        } else "urn:mpeg:dash:role:2011" == m && null != p && (f.push(p), "captions" == p && (g = "caption"));
      }

      if (k) return null;
      k = tn(c, "ContentProtection");
      var y = Ln(k, a.i.dash.ignoreDrmInfo, a.i.dash.keySystemsByURI),
          D = Kf(c.getAttribute("lang") || "und"),
          C = c.getAttribute("label");
      (k = tn(c, "Label")) && k.length && (k = k[0], k.textContent && (C = k.textContent));
      k = tn(c, "Representation");
      c = k.map(function (B) {
        return qp(a, b, y, g, D, C, d, f, n, B);
      }).filter(function (B) {
        return !!B;
      });

      if (0 == c.length) {
        e = "image" == b.ea.contentType;
        if (a.i.dash.ignoreEmptyAdaptationSet || h || e) return null;
        throw new L(2, 4, 4003);
      }

      if (!b.ea.contentType || "application" == b.ea.contentType) for (b.ea.contentType = rp(c[0].mimeType, c[0].codecs), h = t(c), l = h.next(); !l.done; l = h.next()) {
        l.value.type = b.ea.contentType;
      }
      h = t(c);

      for (l = h.next(); !l.done; l = h.next()) {
        for (l = l.value, m = t(y.drmInfos), p = m.next(); !p.done; p = m.next()) {
          p = p.value, p.keyIds = p.keyIds && l.keyIds ? new Set(ia(p.keyIds).concat(ia(l.keyIds))) : p.keyIds || l.keyIds;
        }
      }
    ...
    function qp(a, b, c, d, e, f, g, h, k, l) {
      b.G = mp(l, b.ea, null);
      a.c = Math.min(a.c, b.G.pb);
      if (!sp(b.G)) return null;
      var m = b.O.start;
      b.bandwidth = An(l, "bandwidth", Fn) || 0;
      var n = b.G.contentType,
          p = n == Ee || "application" == n;
      n = "image" == n;

      try {
        var r = function r(G, H, I) {
          return tp(a, G, H, I);
        };

        if (b.G.Vb) var u = mo(b, r);else if (b.G.Wa) u = so(b, a.f);else if (b.G.Wb) u = xo(b, r, a.f, !!a.o, a.i.dash.initialSegmentLimit);else {
          var x = b.G.ua,
              w = b.O.duration || 0;
          u = {
            rb: function rb() {
              return Promise.resolve(Mi(m, w, x));
            }
          };
        }
      } catch (G) {
      ...
      r = tn(l, "ContentProtection");
      r = On(r, c, a.i.dash.ignoreDrmInfo, a.i.dash.keySystemsByURI);
      r = new Set(r ? [r] : []);
      var y = !1;
      tn(l, "SupplementalProperty").some(function (G) {
        return "tag:dolby.com,2018:dash:EC3_ExtensionType:2018" == G.getAttribute("schemeIdUri") && "JOC" == G.getAttribute("value");
      }) && (b.G.mimeType = "audio/eac3-joc", y = !0);
      var D = !1;
      p && (D = h.includes("forced_subtitle"));
      var C;
      if (n && ((l = tn(l, "EssentialProperty").find(function (G) {
      ...
      var F = {
        ...
        createSegmentIndex: function createSegmentIndex() {
          ...
          return J(function (H) {
            if (1 == H.a) {
              if (F.segmentIndex) return H.m(0);
              G = F;
              return v(H, u.rb(), 3);
            }
        ...
        segmentIndex: null,
        mimeType: b.G.mimeType,
        codecs: b.G.codecs,
        frameRate: b.G.frameRate,
        pixelAspectRatio: b.G.pixelAspectRatio,
        bandwidth: b.bandwidth,
        width: b.G.width,
        height: b.G.height,
        kind: d,
        ...
        primary: g,
        trickModeVideo: null,
        emsgSchemeIdUris: b.G.emsgSchemeIdUris,
        roles: h,
        forced: D,
        channelsCount: b.G.rd,
        audioSamplingRate: b.G.audioSamplingRate,
        spatialAudio: y,
        closedCaptions: k,
        hdr: B,
        tilesLayout: C
    ...
    q.Sb = function () {
      ...
      return J(function (d) {
        switch (d.a) {
          ...
          case 2:
            c = E(d), a.u && (c.severity = 1, a.u.onError(c));

          case 3:
            if (!a.u) return d["return"]();
            hp(a, b);
            z(d);
        }
      });
    ...
    function hp(a, b) {
      0 > a.l || a.j.N(Math.max(3, a.l - b, Qa(a.v)));
    }
    ...
    function mp(a, b, c) {
      ...
      var d = tn(a, "BaseURL"),
          ...
          k = An(a, "frameRate", In) || b.frameRate,
          l = a.getAttribute("sar") || b.pixelAspectRatio,
          m = tn(a, "InbandEventStream"),
      ...
      m = tn(a, "AudioChannelConfiguration");
      m = up(m) || b.rd;
      p = An(a, "audioSamplingRate", Gn) || b.audioSamplingRate;
      f || (f = rp(g, h));
      var r = sn(a, "SegmentBase"),
          u = sn(a, "SegmentTemplate"),
          x = r ? An(r, "availabilityTimeOffset", Hn) || 0 : 0,
          w = u ? An(u, "availabilityTimeOffset", Hn) || 0 : 0;
      d = d && d.length ? An(d[0], "availabilityTimeOffset", Hn) || 0 : 0;
      d = b.pb + d + x + w;
      return {
        ua: ze(c, e),
        Vb: r || b.Vb,
        Wa: sn(a, "SegmentList") || b.Wa,
        Wb: u || b.Wb,
        width: An(a, "width", Gn) || b.width,
        height: An(a, "height", Gn) || b.height,
        contentType: f,
        mimeType: g,
        codecs: h,
        frameRate: k,
    ...
    function sp(a) {
      ...
      b += a.Wa ? 1 : 0;
      b += a.Wb ? 1 : 0;
      if (0 == b) return a.contentType == Ee || "application" == a.contentType ? !0 : !1;
      1 != b && (a.Vb && (a.Wa = null), a.Wb = null);
      return !0;
    }
    ...
    function vp(a, b, c, d) {
      var e, f, g, h, k, l;
      return J(function (m) {
        if (1 == m.a) return e = ze(b, [c]), f = eh(e, a.i.retryParameters), f.method = d, g = a.u.networkingEngine.request(4, f), $g(a.g, g), v(m, g.promise, 2);
        h = m.b;
      ...
      return J(function (n) {
        switch (n.a) {
          case 1:
            ...
            }), e = a.i.dash.clockSyncUri, !d.length && e && d.push({
          ...
          case 7:
            return v(n, vp(a, b, l, "HEAD"), 10);

          case 10:
            return n["return"](n.b);

          case 8:
            return v(n, vp(a, b, l, "GET"), 11);
    ...
    function np(a, b, c, d) {
      var e = d.getAttribute("schemeIdUri") || "",
          ...
          g = An(d, "timescale", Gn) || 1;
      d = t(tn(d, "Event"));

      for (var h = d.next(); !h.done; h = d.next()) {
        h = h.value;
        var k = An(h, "presentationTime", Gn) || 0,
            l = An(h, "duration", Gn) || 0;
        k = k / g + b;
        l = k + l / g;
    ...
    function tp(a, b, c, d) {
      var e, f, g, h, k;
      return J(function (l) {
        if (1 == l.a) return e = kh, f = Zi(b, c, d, a.i.retryParameters), g = a.u.networkingEngine, h = g.request(e, f), $g(a.g, h), v(l, h.promise, 2);
        k = l.b;
    ...
    function rp(a, b) {
      return Ve(Pe(a, b)) ? Ee : a.split("/")[0];
    }

    K("shaka.dash.DashParser", fp);

    ki.mpd = function () {
      return new fp();
    };

    ii["application/dash+xml"] = function () {
      return new fp();
    };

    ii["video/vnd.mpeg.dash.mpd"] = function () {
      return new fp();
    };
    ...
    xp.prototype.getAttribute = function (a) {
    ...
    function Ep(a, b, c) {
      c = void 0 === c ? 0 : c;
      return (a = Dp(a, b)) ? Number(a.value) : c;
    }
    ...
    function Ip(a) {
      return a.a == a.b.length ? null : (a = Hp(a, /[^ \t\n]*/gm)) ? a[0] : null;
    }
    ...
    function Kp(a, b, c) {
      ...
      for (var e = !0, f = t(d), g = f.next(); !g.done; g = f.next()) {
        if (g = g.value, /^#(?!EXT)/m.test(g) || e) e = !1;else if (g = Lp(a.a++, g), --a.a, Mp.includes(g.name)) {
          b = 1;
          break;
        ...
        if (/^#(?!EXT)/m.test(l) || e) e = !1;else {
          ...
          if (Np.includes(l.name)) {
            ...
            for (var m = k.next(); !m.done; m = k.next()) {
              m = m.value, /^(#EXT)/.test(m) ? (m = Lp(a.a++, m), Mp.includes(m.name) ? f.push(m) : "EXT-X-MAP" == m.name ? l = m : "EXT-X-PART" == m.name ? h.push(m) : "EXT-X-PRELOAD-HINT" == m.name ? "PART" == Z(m, "TYPE") ? h.push(m) : "MAP" == Z(m, "TYPE") && (m.name = "EXT-X-MAP", l = m) : g.push(m)) : /^#(?!EXT)/m.test(m) || (m = ze([d], [m.trim()])[0], l && g.push(l), e.push(new zp(m, g, h)), g = [], h = []);
            }

            h.length && (l && g.push(l), e.push(new zp("", g, h)));
            return new wp(c, b, f, e);
          }

          f.push(l);
          "EXT-X-STREAM-INF" == l.name && (l.a.push(new Ap("URI", k)), e = !0);
        }
      }
    ...
    function Lp(a, b) {
      ...
      if (e) {
        ...
        for (var h = /([^=]+)=(?:"([^"]*)"|([^",]*))(?:,|$)/g; g = Hp(e, h);) {
          c.push(new Ap(g[1], g[2] || g[3]));
        }
      }

      return new xp(a, d, c, f);
    }

    var Mp = "EXT-X-TARGETDURATION EXT-X-MEDIA-SEQUENCE EXT-X-DISCONTINUITY-SEQUENCE EXT-X-PLAYLIST-TYPE EXT-X-I-FRAMES-ONLY EXT-X-ENDLIST EXT-X-SERVER-CONTROL EXT-X-SKIP".split(" "),
        Np = "EXTINF EXT-X-BYTERANGE EXT-X-DISCONTINUITY EXT-X-PROGRAM-DATE-TIME EXT-X-KEY EXT-X-DATERANGE EXT-X-MAP".split(" ");
    ...
    q.start = function (a, b) {
      var c = this,
          ...
          e;
      return J(function (f) {
        if (1 == f.a) return c.u = b, c.c = b.isLowLatencyMode(), v(f, Tp(c, eh([a], c.i.retryParameters), 0), 2);
        if (3 != f.a) return d = f.b, c.H = d.uri, v(f, Up(c, d.data), 3);
        e = c.za;
        0 < e && c.j.N(e);
        return f["return"](c.o);
      });
    ...
    q.update = function () {
      ...
      return J(function (e) {
        if (1 == e.a) {
          if (a.f == Sp) return e["return"]();
          b = [];
          a.J = null;
          c = Array.from(a.b.values());
          return c.length ? v(e, Vp(a, c[0]), 2) : e.m(2);
        }
    ...
    function Vp(a, b) {
      ...
      return J(function (x) {
        if (1 == x.a) return c = Wp, d = b.ue, e = new me(d), a.c && b.ye && pe(e, new re("_HLS_skip=YES")), v(x, Tp(a, eh([e.toString()], a.i.retryParameters), 0), 2);

        if (3 != x.a) {
          f = x.b;
          g = Kp(a.T, f.data, f.uri);
          if (1 != g.type) throw new L(2, 4, 4017);
          h = Bp(g.R, "EXT-X-DEFINE");
          k = Xp(a, h);
          l = b.stream;
          return v(x, Yp(a, b.Gc, g, l.mimeType, b.nd, k, b.Fe), 3);
        }

        m = x.b;
        l.segmentIndex.wb(m, a.a.Ua());
        m.length && (n = Ep(g.R, "EXT-X-MEDIA-SEQUENCE", 0), p = b.nd.get(n), l.segmentIndex.$a(p));
        r = m[m.length - 1];
        if (u = Dp(g.R, "EXT-X-ENDLIST")) Zp(a, c.se), a.a.Fa(r.endTime);
        z(x);
      });
    }
    ...
    function Up(a, b) {
      var c, d, e, f, g, h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G, H, I, N, T;
      return J(function (Q) {
        switch (Q.a) {
          case 1:
            c = Kp(a.T, b, a.H);
            if (0 != c.type) throw new L(2, 4, 4022);
            d = Bp(c.R, "EXT-X-DEFINE");

            for (var W = t(d), P = W.next(); !P.done; P = W.next()) {
              var ja = P.value;
              P = Z(ja, "NAME");
              ja = Z(ja, "VALUE");
              P && ja && (a.l.has(P) || a.l.set(P, ja));
            }

            e = Bp(c.R, "EXT-X-MEDIA");
            f = Bp(c.R, "EXT-X-STREAM-INF");
            W = t(f);
            ...
            for (P = W.next(); !P.done; P = W.next()) {
              ...
              ja && (ea = Be("audio", qa), a.g.set(ja, ea));
              P && (ja = Be("video", qa), a.g.set(P, ja));
            }

            g = Bp(c.R, "EXT-X-SESSION-DATA");
            h = t(g);

            for (k = h.next(); !k.done; k = h.next()) {
              if (l = k.value, m = Z(l, "DATA-ID"), n = Z(l, "URI"), p = Z(l, "LANGUAGE"), r = Z(l, "VALUE"), u = {
                id: m
              }, n && (u.uri = ze([a.H], [n])[0]), p && (u.language = p), r && (u.value = r), x = new O("sessiondata", u), a.u) a.u.onEvent(x);
            }

            return v(Q, aq(a, e), 2);

          case 2:
            W = Cp(e, "CLOSED-CAPTIONS");
            W = t(W);

            for (P = W.next(); !P.done; P = W.next()) {
              ea = P.value, P = bq(ea), ja = yp(ea, "GROUP-ID"), ea = yp(ea, "INSTREAM-ID"), a.D.get(ja) || a.D.set(ja, new Map()), a.D.get(ja).set(ea, P);
            }

            return v(Q, cq(a, f), 3);

          case 3:
            return w = Q.b, v(Q, dq(a, e), 4);

          case 4:
            y = Q.b;
            if (!a.u) throw new L(2, 7, 7001);
            if (a.Ia && 0 == w.length) throw new L(2, 4, 4034);
            C = D = Infinity;
            B = t(a.b.values());

            for (F = B.next(); !F.done; F = B.next()) {
              G = F.value, D = Math.min(D, G.Yd), "text" != G.stream.type && (C = Math.min(C, G.gf - G.Yd));
            }

            a.f != Sp ? (a.a = new R(0, a.i.defaultPresentationDelay ? a.i.defaultPresentationDelay : a.M ? a.M : 3 * a.ja), a.a.Xb(!1)) : (a.a = new R(null, 0), a.a.Xb(!0));
            eq(a);
            if (a.f != Sp) a.za = a.v, H = Wp, a.f == H.re && (I = a.a.Cc, isNaN(a.i.availabilityWindowOverride) || (I = a.i.availabilityWindowOverride), a.a.Hd(I));else for (a.a.Fa(C), a.a.offset(-D), N = t(a.b.values()), F = N.next(); !F.done; F = N.next()) {
              T = F.value, T.stream.segmentIndex.offset(-D), T.stream.segmentIndex.Sa(0, C);
            }
            a.o = {
              presentationTimeline: a.a,
              variants: w,
              textStreams: y,
              imageStreams: [],
              offlineSessionIds: [],
            ...
            a.u.makeTextStreamsForClosedCaptions(a.o);
            z(Q);
        }
      });
    }
    ...
    function dq(a, b) {
      var c, d, e, f, g, h, k, l, m, n, p, r;
      return J(function (u) {
        if (1 == u.a) return c = Cp(b, "SUBTITLES"), d = c.map(function (x) {
          var w, y, D;
          return J(function (C) {
            if (1 == C.a) {
              if (w = a.i.disableText) return C["return"](null);
              A(C, 2);
              return v(C, fq(a, x), 4);
            }

            if (2 != C.a) return y = C.b, C["return"](y.stream);
            D = E(C);
            if (a.i.hls.ignoreTextStreamFailures) return C["return"](null);
            throw D;
          });
        }), v(u, Promise.all(d), 2);
        e = u.b;
        ...
        for (g = f.next(); !g.done; g = f.next()) {
          if (h = g.value, k = yp(h, "GROUP-ID"), l = a.g.get(k)) if (m = a.h.get(k)) for (n = t(m), p = n.next(); !p.done; p = n.next()) {
            r = p.value, r.stream.codecs = l;
          }
        }

        return u["return"](e.filter(function (x) {
          return x;
        }));
      });
    }
    ...
    function aq(a, b) {
      var c;
      return J(function (d) {
        if (1 == d.a) return b = b.filter(function (e) {
          var f = Z(e, "URI") || "";
          return "SUBTITLES" != Z(e, "TYPE") && "" != f;
        }), b.length ? v(d, fq(a, b[0]), 2) : d.m(2);
    ...
    function cq(a, b) {
      var c, d, e;
      return J(function (f) {
        if (1 == f.a) return c = b.map(function (g) {
          var h, k, l, m, n, p, r, u;
          return J(function (x) {
            return 1 == x.a ? (h = Z(g, "FRAME-RATE"), k = Number(yp(g, "BANDWIDTH")), l = Z(g, "RESOLUTION"), m = t(l ? l.split("x") : [null, null]), n = m.next().value, p = m.next().value, r = Z(g, "VIDEO-RANGE"), v(x, gq(a, g), 2)) : (u = x.b) ? x["return"](hq(a, u.audio, u.video, k, n, p, h, r)) : x["return"]([]);
          });
        }), v(f, Promise.all(c), 2);
        d = f.b;
        e = d.reduce(Lb, []);
    ...
    function gq(a, b) {
      var c, d, e, f, g, h, k, l, m, n, p, r, u, x;
      return J(function (w) {
        if (1 == w.a) return c = Fe, d = $p(a, b), e = Z(b, "AUDIO"), f = Z(b, "VIDEO"), h = (g = e || f) && a.h.has(g) ? a.h.get(g) : [], k = {
          audio: e ? h : [],
          video: f ? h : []
        }, m = !1, n = yp(b, "URI"), p = k.audio.find(function (y) {
          return y && y.Gc == n;
        }), r = Ce(c.Ja, d), (u = Ce(c.Xa, d)) && !r ? l = c.Xa : !h.length && u && r ? (l = c.Ja, d = [[r, u].join()]) : k.audio.length && p ? (l = c.Xa, m = !0) : l = k.video.length ? c.Xa : c.Ja, m ? w.m(2) : v(w, iq(a, b, d, l), 3);
        2 != w.a && (x = w.b);
        if (x) k[x.stream.type] = [x];else if (null === x) return w["return"](null);
        jq(k);
        return w["return"](k);
      });
    }
    ...
    function hq(a, b, c, d, e, f, g, h) {
      for (var k = t(c), l = k.next(); !l.done; l = k.next()) {
        l = l.value.stream;
        var m = f,
            n = g,
            p = h;
        l && (l.width = Number(e) || void 0, l.height = Number(m) || void 0, l.frameRate = Number(n) || void 0, l.hdr = p || void 0);
      }
      ...
      for (f = b.next(); !f.done; f = b.next()) {
        for (f = f.value, g = t(c), h = g.next(); !h.done; h = g.next()) {
          n = h.value, h = f ? f.stream : null, k = n ? n.stream : null, l = f ? f.stream.drmInfos : null, m = n ? n.stream.drmInfos : null, n = (n ? n.Gc : "") + " - " + (f ? f.Gc : ""), h && k && !(l.length && m.length ? 0 < ei(l, m).length : 1) || a.Aa.has(n) || (h = {
            id: a.Ya++,
    ...
    function fq(a, b) {
      ...
      return J(function (w) {
        if (1 == w.a) {
          c = yp(b, "GROUP-ID");
          d = "";
          var y = yp(b, "TYPE").toLowerCase();
          "subtitles" == y && (y = Ee);
          e = y;
          e != Ee && c && a.g.has(c) && (d = a.g.get(c));
          f = kq(yp(b, "URI"), a.l);
          if (a.b.has(f)) return w["return"](a.b.get(f));
          g = bq(b);
          h = Z(b, "NAME");
          k = b.getAttribute("DEFAULT");
          l = "YES" == k;
          y = "audio" == e ? (y = Z(b, "CHANNELS")) ? parseInt(y.split("/")[0], 10) : null : null;
          m = y;
          y = "audio" == e ? (y = Z(b, "CHANNELS")) ? y.includes("/JOC") : !1 : !1;
          n = y;
          p = Z(b, "CHARACTERISTICS");
          r = Z(b, "FORCED");
          u = "YES" == r;
          return v(w, lq(a, f, d, e, g, l, h, m, null, p, u, n), 2);
        }

        x = w.b;
        a.h.has(c) ? a.h.get(c).push(x) : a.h.set(c, [x]);
        if (null == x) return w["return"](null);
        if (a.b.has(f)) return w["return"](a.b.get(f));
        a.b.set(f, x);
        return w["return"](x);
      });
    ...
    function iq(a, b, c, d) {
      ...
      return J(function (k) {
        if (1 == k.a) {
          e = kq(yp(b, "URI"), a.l);
          if (a.b.has(e)) return k["return"](a.b.get(e));
          var l = Z(b, "CLOSED-CAPTIONS");
          f = "video" == d && l && "NONE" != l ? a.D.get(l) : null;
          g = Be(d, c);
          return v(k, lq(a, e, g, d, "und", !1, null, null, f, null, !1, !1), 2);
        }
    ...
    function lq(a, b, c, d, e, f, g, h, k, l, m, n) {
      var p, r, u, x, w, y, D, C, B, F, G, H, I, N, T, Q, W, P, ja, qa, ea, Za, Da, Ia, Cc, jb, Bb, $a, Pb, kf, qb, Zd, Gh, Hh, nf, Sm, Tm, Um, Vm;
      return J(function (ab) {
        switch (ab.a) {
          case 1:
            return p = ze([a.H], [b])[0], v(ab, Tp(a, eh([p], a.i.retryParameters), 0), 2);

          case 2:
            r = ab.b;
            p = r.uri;
            u = Kp(a.T, r.data, p);
            if (1 != u.type) throw new L(2, 4, 4017);
            x = [];
            if (u.segments) for (w = t(u.segments), y = w.next(); !y.done; y = w.next()) {
              D = y.value, C = Bp(D.R, "EXT-X-KEY"), x.push.apply(x, ia(C));
            }
            B = !1;
            F = [];
            G = new Set();
            ...
            for (I = H.next(); !I.done; I = H.next()) {
              if (N = I.value, T = yp(N, "METHOD"), "NONE" != T) {
                B = !0;
                if ("AES-128" == T) return a.Ia = !0, ab["return"](null);
                Q = yp(N, "KEYFORMAT");

                if (P = (W = mq[Q]) ? W(N) : null) {
                  if (P.keyIds) for (ja = t(P.keyIds), qa = ja.next(); !qa.done; qa = ja.next()) {
                    ea = qa.value, G.add(ea);
                  }
                  F.push(P);
                }
              }
            ...
            if (B && !F.length) throw new L(2, 4, 4026);
            Za = Bp(u.R, "EXT-X-DEFINE");
            Da = Xp(a, Za);
            nq(a, u);
            return v(ab, oq(a, d, c, u, Da), 3);

          case 3:
            return Ia = ab.b, pq.includes(Ia) && (c = ""), Cc = new Map(), jb = new Map(), A(ab, 4), v(ab, Yp(a, b, u, Ia, Cc, Da, jb), 6);
          ...
          case 4:
            $a = E(ab);
            if (4035 == $a.code) return Ua("Skipping unsupported HLS stream", Ia, b), ab["return"](null);
            throw $a;

          case 5:
            Pb = Bb[0].startTime;
            kf = Bb[Bb.length - 1].endTime;
            qb = new S(Bb);
            Zd = d == Ee ? "subtitle" : void 0;
            Gh = [];
            if (l) for (Hh = t(l.split(",")), nf = Hh.next(); !nf.done; nf = Hh.next()) {
              Sm = nf.value, Gh.push(Sm);
            }
            Um = (Tm = Dp(u.R, "EXT-X-SERVER-CONTROL")) ? null != Tm.getAttribute("CAN-SKIP-UNTIL") : !1;
            Vm = {
              id: a.Ya++,
              originalId: g,
              createSegmentIndex: function createSegmentIndex() {
    ...
    function nq(a, b) {
      var c = Dp(b.R, "EXT-X-PLAYLIST-TYPE"),
          d = Dp(b.R, "EXT-X-ENDLIST");
      d = c && "VOD" == c.value || d;
      c = c && "EVENT" == c.value && !d;
      c = !d && !c;
      if (d) Zp(a, Sp);else {
        c ? Zp(a, qq) : Zp(a, rq);
        d = Dp(b.R, "EXT-X-TARGETDURATION");
        if (!d) throw new L(2, 4, 4024, "EXT-X-TARGETDURATION");
        d = Number(d.value);
        c = Dp(b.R, "EXT-X-PART-INF");
        a.c && c ? (a.Ra = Number(yp(c, "PART-TARGET")), a.v = Math.min(a.Ra, a.v), c = Dp(b.R, "EXT-X-SERVER-CONTROL"), a.M = c ? Number(yp(c, "PART-HOLD-BACK")) : 0) : a.v = Math.min(d, a.v);
        a.ja = Math.max(d, a.ja);
      }
    }
    ...
    function sq(a, b, c, d) {
      ...
      a.X.has(b) || (c = tq(d, c), a.X.set(b, c));
      return a.X.get(b);
    }
    ...
    function uq(a, b, c, d, e, f, g, h) {
      ...
      if (a.c && d.b.length) {
        ...
        for (var u = d.next(); !u.done; a = {
          ...
          var x = u.ba;
          u = u.item;
          var w = 0 == x ? c : r[r.length - 1];
          x = 0 == x ? e : w.endTime;
          var y = Number(Z(u, "DURATION"));
          y = x + y;
          var D = 0,
              C = null;
          "EXT-X-PRELOAD-HINT" == u.name ? D = (w = Z(u, "BYTERANGE-START")) ? Number(w) : 0 : (D = Z(u, "BYTERANGE"), w = t(vq(w, D)), D = w.next().value, C = w.next().value);
          u = Z(u, "URI");
          a.Pc = ze([h], [u])[0];
          r.push(new oi(x, y, function (B) {
            return function () {
              return [B.Pc];
            };
          }(a), D, C, b, f, 0, Infinity));
        }
      } else if (!m) throw new L(2, 4, 4024, "EXTINF");

      m ? g = e + Number(m.value.split(",")[0]) : g = r[r.length - 1].endTime;
      (h = Dp(k, "EXT-X-BYTERANGE")) ? (c = t(vq(c, h.value)), n = c.next().value, p = c.next().value) : r.length && (n = r[0].da, p = r[r.length - 1].Y);
      return new oi(e, g, function () {
        return l.length ? [l] : [];
    ...
    function vq(a, b) {
      var c = 0,
          d = null;
      b && (c = b.split("@"), d = Number(c[0]), c = c[1] ? Number(c[1]) : a.Y + 1, d = c + d - 1);
      return [c, d];
    }

    function eq(a) {
      if (a.a) {
        for (var b = t(a.ka), c = b.next(); !c.done; c = b.next()) {
          a.a.yb(c.value);
        }
    ...
    function Yp(a, b, c, d, e, f, g) {
      var h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G, H, I, N, T, Q, W, P, ja, qa;
      return J(function (ea) {
        switch (ea.a) {
          case 1:
            h = c.segments;
            l = Ep(c.R, "EXT-X-MEDIA-SEQUENCE", 0);
            n = (m = Dp(c.R, "EXT-X-SKIP")) ? Number(Z(m, "SKIPPED-SEGMENTS")) : 0;
            p = l + n;
            ...
            k = sq(a, c.a, h[0].R, f);
            u = a;
            return v(ea, wq(a, b, k, d, p, !1, h[0], f), 4);
          ...
          case 2:
            x = h[0].a;
            Ya(x.split("/").pop());
            w = Ep(c.R, "EXT-X-DISCONTINUITY-SEQUENCE");
            if (a.c && (g.has(w) || g.set(w, p), n)) for (; g.has(w + 1) && g.get(w + 1) < p;) {
              w++;
            }
            y = a.C.get(w) || 0;
            D = [];
          ...
          case 5:
            ...
            w++;
            g.set(w, p);
            return v(ea, xq(a, w, b, k, d, p, N, f, Q), 9);

          case 9:
            y = ea.b;

          case 8:
            !a.c && (P = a.u.isAutoLowLatencyMode()) && (a.u.enableLowLatencyMode(), a.c = a.u.isLowLatencyMode());
            ja = Dp(N.R, "EXTINF");
            a.c || ja ? (qa = uq(a, k, T, N, Q, y, f, c.a), D.push(qa)) : a.c || Ua("Low-latency HLS live stream detected, but low-latency streaming mode is not enabled in Shaka Player. Set streaming.lowLatencyMode configuration to true, and see https://bit.ly/3clctcj for details.");
            F = B.next();
            ea.m(5);
            break;

          case 7:
            return a.ka.push(D), eq(a), ea["return"](D);
        }
      });
    }
    ...
    function xq(a, b, c, d, e, f, g, h, k) {
      var l, m;
      return J(function (n) {
        if (1 == n.a) return l = 0, a.C.has(b) ? (l = a.C.get(b), n.m(2)) : v(n, wq(a, c, d, e, f, !0, g, h), 3);
        2 != n.a && (m = n.b, l = k - m, a.C.set(b, l));
        return n["return"](l);
      });
    }
    ...
    function yq(a, b) {
      ...
      return J(function (k) {
        switch (k.a) {
          case 1:
            c = kh;
            d = Zi(b.ga(), b.da, b.Y, a.i.retryParameters);
            if (a.i.hls.useFullSegmentsForStartTime) return k["return"](Tp(a, d, c));
            e = Zi(b.ga(), b.da, b.da + 2048 - 1, a.i.retryParameters);
            A(k, 2);
            return v(k, Tp(a, e, c), 4);
          ...
          case 2:
            g = E(k);
            if (7001 == g.code) throw g;
            Ua("Unable to fetch the starting part of HLS segment! Falling back to a full segment request, which is expensive!  Your server should support Range requests and CORS preflights.", e.uris[0]);
            return v(k, Tp(a, d, c), 5);
    ...
    function wq(a, b, c, d, e, f, g, h) {
      ...
      return J(function (w) {
        switch (w.a) {
          case 1:
            k = uq(a, c, null, g, 0, 0, h, "");
            if (a.o && !f && (l = a.b.get(b), m = l.nd.get(e), void 0 != m)) return w["return"](m);
            d = d.toLowerCase();
            if (pq.includes(d)) throw Ua("Raw formats are not yet supported.  Skipping " + d), new L(1, 4, 4035);
            if ("video/webm" == d) throw Ua("WebM in HLS is not yet supported.  Skipping."), new L(1, 4, 4035);
            ...
            n = [yq(a, k)];
            c && n.push(yq(a, c));
            return v(w, Promise.all(n), 3);

          case 3:
            return p = w.b, r = p[0], u = p[1] || p[0], w["return"](zq(b, r.uri, r.data, u.data));
          ...
          case 5:
            return x = w.b, w["return"](Aq(b, x.uri, x.data));
    ...
    function zq(a, b, c, d) {
      var e = 0;
      new Qb().box("moov", Ub).box("trak", Ub).box("mdia", Ub).S("mdhd", function (h) {
        e = be(h.reader, h.version).timescale;
        h.parser.stop();
      }).parse(d, !0);
      if (!e) throw new L(2, 4, 4030, a, b);
      var f = 0,
          g = !1;
      new Qb().box("moof", Ub).box("traf", Ub).S("tfdt", function (h) {
        f = ae(h.reader, h.version).cd / e;
        g = !0;
        h.parser.stop();
      }).parse(c, !0);
    ...
    function Aq(a, b, c) {
      ...
      for (var f = new Db(c, 0), g = 0, h = 0;;) {
        if (g = f.Z(), h = f.V(), 71 != h && e(), c = f.Bb(), 8191 == (c & 8191)) d();else if (c & 16384) {
          if (c = (f.V() & 48) >> 4, 0 != c && 2 != c || e(), 3 == c && (c = f.V(), f.skip(c)), 1 != f.I() >> 8) d();else {
            f.skip(3);
            c = f.V() >> 6;
            0 != c && 1 != c || e();
            0 == f.V() && e();
      ...
      if (d) {
        ...
        for (var e = d.next(); !e.done; e = d.next()) {
          ...
          var f = e.slice(2, e.length - 1),
              g = b.get(f);
          if (g) c = c.replace(e, g);else throw new L(2, 4, 4039, f);
        }
      }
    ...
    function oq(a, b, c, d, e) {
      var f, g, h, k, l, m, n, p, r, u, x;
      return J(function (w) {
        if (1 == w.a) {
          f = Fe;
          g = kh;
          h = kq(d.segments[0].a, e);
          k = new me(h);
          l = k.sa.split(".").pop();
          m = Bq[b];
          if (n = m[l]) return w["return"](n);
          if (b == f.$) return c && "vtt" != c && "wvtt" != c ? w["return"]("application/mp4") : w["return"]("text/vtt");
          p = eh([h], a.i.retryParameters);
          p.method = "HEAD";
          return v(w, Tp(a, p, g), 2);
        }

        r = w.b;
        u = r.headers["content-type"];
        return u ? w["return"](u.split(";")[0]) : (x = m.mp4, w["return"](x));
      });
    }
    ...
    q.Sb = function () {
      ...
      return J(function (d) {
        ...
        if (2 != d.a) return b = a.za, a.j.N(b), wa(d, 0);
        c = E(d);
        if (!a.u) return d["return"]();
        c.severity = 1;
        a.u.onError(c);
    ...
    function Tp(a, b, c) {
      if (!a.A) throw new L(2, 7, 7001);
      b = a.u.networkingEngine.request(c, b);
      $g(a.A, b);
      return b.promise;
    }

    K("shaka.hls.HlsParser", Rp);
    var pq = ["audio/aac", "audio/ac3", "audio/ec3", "audio/mpeg"],
        Bq = {
      audio: {
        mp4: "audio/mp4",
        mp4a: "audio/mp4",
      ...
      "com.microsoft.playready": function comMicrosoftPlayready(a) {
        ...
        a = pb(a.data);
        a = qn(a);
        return Ae("com.microsoft.playready", [{
          initDataType: "cenc",
          initData: a
        }]);
      }
    ...
    ii["application/x-mpegurl"] = function () {
      return new Rp();
    };

    ii["application/vnd.apple.mpegurl"] = function () {
      return new Rp();
    };
    ...
    function Eq(a, b, c, d) {
      var e = new Fq();
      oh(b.headers).forEach(function (k, l) {
        e.append(l, k);
      });
      var f = new Gq(),
          g = {
    ...
    function Hq(a, b, c, d, e, f) {
      var g, h, k, l, m, n, p, r, u, x, w, y, D, C;
      return J(function (B) {
        switch (B.a) {
          case 1:
            return g = Iq, h = Jq, n = m = 0, p = Date.now(), A(B, 2), v(B, g(a, c), 4);

          case 4:
            return k = B.b, r = k.clone().body.getReader(), x = (u = k.headers.get("Content-Length")) ? parseInt(u, 10) : 0, w = function w(F) {
              function G() {
                var H, I;
                return J(function (N) {
                  switch (N.a) {
                    case 1:
                      return A(N, 2), v(N, r.read(), 4);
                    ...
                    case 3:
                      H.done || (m += H.value.byteLength, f && f(H.value));
                      I = Date.now();
                      if (100 < I - p || H.done) e(I - p, m - n, x - m), n = m, p = I;
          ...
          case 2:
            y = E(B);
            if (d.Md) throw new L(1, 1, 7001, a, b);
            if (d.oe) throw new L(1, 1, 1003, a, b);
            throw new L(1, 1, 1002, a, y, b);

          case 3:
            return D = {}, C = k.headers, C.forEach(function (F, G) {
              D[G.trim()] = F;
            }), B["return"](Cq(D, l, k.status, a, k.url, b));
        }
      });
    }
    ...
    K("shaka.net.HttpFetchPlugin", Dq);
    Dq.isSupported = Kq;
    Dq.parse = Eq;
    var Iq = window.fetch,
        Gq = window.AbortController,
        Jq = window.ReadableStream,
        Fq = window.Headers;
    Kq() && (bh("http", Eq, 2, !0), bh("https", Eq, 2, !0));
    ...
    function Mq(a, b, c, d) {
      var e = new Nq(),
        ...
        e.onload = function (n) {
          ...
          for (var u = p.next(); !u.done; u = p.next()) {
            u = u.value.split(": "), r[u[0].toLowerCase()] = u.slice(1).join(": ");
          }

          try {
            var x = Cq(r, n.response, n.status, a, n.responseURL, c);
            k(x);
          } catch (w) {
            l(w);
          }
      ...
      return new Pg(h, function () {
        e.abort();
        return Promise.resolve();
      });
    }

    K("shaka.net.HttpXHRPlugin", Lq);
    Lq.parse = Mq;
    var Nq = window.XMLHttpRequest;
    bh("http", Mq, 1, !0);
    bh("https", Mq, 1, !0);
    ...
    Oq.prototype.close = function (a, b) {
      if (this.c.has(a)) {
        var c = this.c.get(a);
        this.c["delete"](a);
        this.f += c;
    ...
    function Tq(a, b, c, d, e, f) {
      ...
      d = (a.a.get(b) || Promise.resolve()).then(function () {
        var h, k, l, m, n, p, r;
        return J(function (u) {
          if (1 == u.a) return v(u, Uq(a, c), 2);
          h = u.b;
          if (a.F.a) throw new L(2, 9, 7001);
          if (e) for (m in k = pb(h), l = new pn(k), l.data) {
            n = Number(m), p = l.data[n], r = l.a[n], a.ae(p, r);
          }
          a.Kb.close(g, h.byteLength);
          var x = a.Kb;
          a.be(0 == x.b ? 0 : x.f / x.b, a.Kb.a);
          return u["return"](f(h));
        });
      });
      a.a.set(b, d);
    ...
    function Wq(a) {
      return J(function (b) {
        return 1 == b.a ? v(b, Promise.all(a.a.values()), 2) : b["return"](a.Kb.a);
      });
    }
    ...
    function Uq(a, b) {
      var c, d, e, f;
      return J(function (g) {
        if (1 == g.a) return c = kh, d = a.K.request(c, b), e = function e() {
          return d.abort();
        }, a.b.push(e), v(g, d.promise, 2);
        f = g.b;
        vc(a.b, e);
        return g["return"](f.data);
      });
    ...
    Xq.prototype.store = function () {
      return this.b;
    };

    Xq.prototype.promise = function () {
      return this.a;
    };
    ...
    Zq.prototype.destroy = function () {
      return Promise.all(this.a.map(function (a) {
        return a.abort();
      }));
    };

    function $q(a, b) {
      return ar(a, b, "readwrite");
    }
    ...
    q.getSegments = function (a) {
      var b = this,
          c;
      return J(function (d) {
        if (1 == d.a) return v(d, er(b, b.c, a), 2);
        c = d.b;
    ...
    q.getManifests = function (a) {
      var b = this,
          c;
      return J(function (d) {
        if (1 == d.a) return v(d, er(b, b.a, a), 2);
        c = d.b;
    ...
    q.getAllManifests = function () {
      var a = this,
          ...
          c;
      return J(function (d) {
        return 1 == d.a ? (b = ar(a.b, a.a, "readonly"), c = new Map(), v(d, Yq(b, function (e, f) {
          var g;
          return J(function (h) {
            if (1 == h.a) return v(h, a.Jb(f), 2);
            g = h.b;
            c.set(e, g);
            z(h);
          });
        }), 2)) : 3 != d.a ? v(d, b.promise(), 3) : d["return"](c);
      });
    };
    ...
    function cr(a) {
      return Promise.reject(new L(2, 9, 9011, "Cannot add new value to " + a));
    }
      ...
      return J(function (m) {
        if (1 == m.a) {
          ...
          for (k = h.next(); !k.done; g = {
            ...
            l = k.value, g.cc = e.add(l), g.cc.onsuccess = function (n) {
              return function () {
                f.push(n.cc.result);
              };
            }(g);
    ...
    function dr(a, b, c, d) {
      ...
      for (var f = c.next(); !f.done; e = {
        ...
        e.bc = f.value, b["delete"](e.bc).onsuccess = function (g) {
          return function () {
            return d(g.bc);
          };
        }(e);
      ...
      return J(function (m) {
        if (1 == m.a) {
          ...
          for (l = k.next(); !l.done; h = {
            ...
            h.Eb = l.value, h.Gb = e.get(h.Eb), h.Gb.onsuccess = function (n) {
              return function () {
                void 0 == n.Gb.result && g.push(n.Eb);
                f[n.Eb] = n.Gb.result;
              };
            }(h);
          }
        ...
        if (g.length) throw new L(2, 9, 9012, "Could not find values for " + g);
    ...
    fr.prototype.getAll = function () {
      var a = this,
          b,
          c;
      return J(function (d) {
        return 1 == d.a ? (b = ar(a.a, "session-ids", "readonly"), c = [], v(d, Yq(b, function (e, f) {
          c.push(f);
        }), 2)) : 3 != d.a ? v(d, b.promise(), 3) : d["return"](c);
      });
    };
    ...
    fr.prototype.remove = function (a) {
      var b = this,
          c;
      return J(function (d) {
        return 1 == d.a ? (c = $q(b.a, "session-ids"), v(d, Yq(c, function (e, f, g) {
    ...
    gr.prototype.destroy = function () {
      for (var a = [], b = t(this.a.values()), c = b.next(); !c.done; c = b.next()) {
    ...
    gr.prototype.init = function () {
      var a = this;
      hr.forEach(function (e, f) {
        var g = e();
        g && a.a.set(f, g);
      });

      for (var b = [], c = t(this.a.values()), d = c.next(); !d.done; d = c.next()) {
        b.push(d.value.init());
      }
    ...
    function ir(a) {
      ...
      if (b) return b;
      throw new L(2, 9, 9013, "Could not find a cell that supports add-operations");
    }
    ...
    function kr(a, b, c) {
      a = a.a.get(b);
      if (!a) throw new L(2, 9, 9013, "Could not find mechanism with name " + b);
      b = a.getCells().get(c);
      if (!b) throw new L(2, 9, 9013, "Could not find cell with name " + c);
      return b;
    }
    ...
    function mr(a) {
      ...
      if (!b.length) throw new L(2, 9, 9E3, "No supported storage mechanisms found");
    ...
    function nr(a) {
      var b, c, d;
      return J(function (e) {
        return 1 == e.a ? (b = Array.from(a.a.values()), c = 0 < b.length, c || (d = hr, d.forEach(function (f) {
          (f = f()) && b.push(f);
        })), v(e, Promise.all(b.map(function (f) {
          return f.erase();
        })), 2)) : c ? e.m(0) : v(e, Promise.all(b.map(function (f) {
          return f.destroy();
        })), 0);
      });
    }
    ...
    K("shaka.offline.StorageMuxer", gr);

    gr.unregister = function (a) {
      hr["delete"](a);
    };
    ...
    pr.prototype.updateManifestExpiration = function (a, b) {
      var c = this,
          d,
          e,
          f;
      return J(function (g) {
        ...
        e.get(a).onsuccess = function (h) {
          (h = h.target.result) ? (h.expiration = b, e.put(h), f.resolve()) : f.reject(new L(2, 9, 9012, "Could not find values for " + a));
        };
      ...
      return J(function (h) {
        if (1 == h.a) {
          ...
          for (c = 0; c < a.periods.length; ++c) {
            d = c == a.periods.length - 1 ? a.duration : a.periods[c + 1].startTime, e = d - a.periods[c].startTime, f = qr(a.periods[c], e), b.push(f);
          }
    ...
    function qr(a, b) {
      ...
      return a.streams.map(function (e) {
        return sr(e, a.startTime, b);
      });
    }

    function sr(a, b, c) {
      var d = a.initSegmentUri ? tr(a.initSegmentUri) : null,
    ...
    function rr(a) {
      ...
      if (!b.every(function (h) {
        ...
        if (!a.length && b.length) for (e = c++, f = t(b), d = f.next(); !d.done; d = f.next()) {
          d.value.variantIds.push(e);
        }
        if (a.length && b.length) for (b = t(b), d = b.next(); !d.done; d = b.next()) {
      ...
      return J(function (h) {
        if (1 == h.a) {
          ...
          for (c = 0; c < a.periods.length; ++c) {
            ...
            for (var k = a.periods[c], l = [], m = t(k.streams), n = m.next(); !n.done; n = m.next()) {
              n = n.value, 0 != n.variantIds.length && l.push(vr(n, k.startTime, k.startTime + e));
            }
    ...
    wr.prototype.hasFixedKeySpace = function () {
      return !1;
    };

    wr.prototype.addSegments = function (a) {
      return this.add(this.c, a);
    };

    wr.prototype.addManifests = function (a) {
      return this.add(this.a, a);
    };

    wr.prototype.Jb = function (a) {
    ...
    q.init = function () {
      ...
      c.onsuccess = function () {
        ...
        e = e.contains("manifest") && e.contains("segment") ? new pr(d, "segment", "manifest") : null;
        a.a = e;
        e = d.objectStoreNames;
        e = e.contains("manifest-v2") && e.contains("segment-v2") ? new ur(d, "segment-v2", "manifest-v2") : null;
        a.b = e;
        e = d.objectStoreNames;
        e = e.contains("manifest-v3") && e.contains("segment-v3") ? new ur(d, "segment-v3", "manifest-v3") : null;
        a.c = e;
        e = d.objectStoreNames;
        e = e.contains("manifest-v5") && e.contains("segment-v5") ? new wr(d, "segment-v5", "manifest-v5") : null;
        a.f = e;
        d = d.objectStoreNames.contains("session-ids") ? new fr(d) : null;
        a.h = d;
        b.resolve();
      };

      c.onupgradeneeded = function () {
        for (var d = c.result, e = t(["segment-v5", "manifest-v5", "session-ids"]), f = e.next(); !f.done; f = e.next()) {
    ...
    q.erase = function () {
      ...
      return J(function (b) {
        switch (b.a) {
          ...
          case 8:
            return a.g && a.g.close(), v(b, yr(), 10);

          case 10:
            return a.g = null, a.a = null, a.b = null, a.c = null, a.f = null, v(b, a.init(), 0);
        }
      });
    };
    ...
    or("idb", function () {
      return ec() || !window.indexedDB ? null : new xr();
    });
    ...
    function Ar(a) {
      ...
      if (!c) return null;
      var d = a[3];
      return d && null != b ? new zr(b, c, d, Number(a[4])) : null;
    }
    ...
    function Cr(a, b) {
      ...
      if (b.drmInfo) for (var h = t(d.values()), k = h.next(); !k.done; k = h.next()) {
    ...
    function Dr(a, b, c, d) {
      ...
      for (e = b.next(); !e.done; e = b.next()) {
        for (e = e.value, g = Er(a, e, d), h = t(e.variantIds), e = h.next(); !e.done; e = h.next()) {
      ...
      for (b = c.next(); !b.done; b = c.next()) {
        for (e = b.value, b = Er(a, e, d), g = t(e.variantIds), e = g.next(); !e.done; e = g.next()) {
    ...
    function Fr(a, b) {
      var c = new zr("segment", a.b, a.a, b.dataKey);
      return new oi(b.startTime, b.endTime, function () {
        return [c.toString()];
      }, 0, null, null != b.initSegmentKey ? Gr(a, b.initSegmentKey) : null, b.timestampOffset, b.appendWindowStart, b.appendWindowEnd);
    }

    function Gr(a, b) {
      var c = new zr("segment", a.b, a.a, b);
      return new mi(function () {
        return [c.toString()];
      }, 0, null);
    }
      ...
      return J(function (m) {
        switch (m.a) {
          case 1:
            d = Ar(a);
            c.a = d;
            if (null == d || "manifest" != d.a) throw new L(2, 1, 9004, a);
            e = new gr();
            va(m);
            return v(m, e.init(), 4);

          case 4:
            return v(m, kr(e, d.Ea(), d.fa()), 5);

          case 5:
            return f = m.b, v(m, f.getManifests([d.key()]), 6);

          case 6:
            return g = m.b, h = g[0], k = new Br(d.Ea(), d.fa()), l = Cr(k, h), b.makeTextStreamsForClosedCaptions(l), m["return"](l);
    ...
    q.onExpirationUpdated = function (a, b) {
      ...
      return J(function (m) {
        switch (m.a) {
          case 1:
            return d = c.a, e = new gr(), A(m, 2, 3), v(m, e.init(), 5);

          case 5:
            return v(m, kr(e, d.Ea(), d.fa()), 6);

          case 6:
            return f = m.b, v(m, f.getManifests([d.key()]), 7);
    ...
    ii["application/x-offline-manifest"] = function () {
      return new Hr();
    };
    ...
    function Jr(a) {
      ...
      }, a = Sg(a)) : a = b && "segment" == b.a ? Kr(b.key(), b) : Qg(new L(2, 1, 9004, a));
      return a;
    }

    function Kr(a, b) {
      var c = new gr();
      return Sg(void 0).W(function () {
        return c.init();
      }).W(function () {
        return kr(c, b.Ea(), b.fa());
      }).W(function (d) {
    ...
    K("shaka.offline.OfflineScheme", Ir);
    Ir.plugin = Jr;
    bh("offline", Jr);
      ...
      return J(function (f) {
        switch (f.a) {
          case 1:
            ...
            }), A(f, 2), d.configure(a), v(f, zh(d, c.info.keySystem, c.info.licenseUri, c.info.serverCertificate, c.info.audioCapabilities, c.info.videoCapabilities), 4);
          ...
          case 7:
            return e = [], v(f, Promise.all(c.sessionIds.map(function (g) {
              return J(function (h) {
                if (1 == h.a) return A(h, 2), v(h, Mh(d, g), 4);
                if (2 != h.a) return e.push(g), wa(h, 0);
                E(h);
                z(h);
              });
            })), 10);
    ...
    function Mr(a, b) {
      ...
      return a.keySystem == b.keySystem && a.licenseUri == b.licenseUri && wc(a.audioCapabilities, b.audioCapabilities, c) && wc(a.videoCapabilities, b.videoCapabilities, c);
    }
    ...
    function Ur(a) {
      ...
      this.K = this.i = null;
      a ? (this.i = a.i, this.K = a.Nb()) : (this.i = Xj(), this.K = new ah());
      this.Ec = [];
      this.Tb = [];
      this.ud = [];
      var c = !a;
      this.F = new bf(function () {
        ...
        return J(function (k) {
          switch (k.a) {
            case 1:
              return v(k, Promise.all(b.ud.map(function (l) {
                return Sq(l);
              })), 2);
            ...
            case 3:
              ...
              return v(k, b.K.destroy(), 4);

            case 4:
              b.i = null, b.K = null, z(k);
          }
        });
      });
    }
    ...
    q.store = function (a, b, c) {
      var d = this,
          ...
          f = new Qq(this.K);
      this.ud.push(f);
      b = Wr(this, a, b || {}, function () {
        var h;
        return J(function (k) {
          if (1 == k.a) return v(k, hi(a, d.K, e.manifest.retryParameters, c || null), 2);
          h = k.b;
          return k["return"](Ob(h));
        });
      }, e, f);
      var g = new Pg(b, function () {
        return Sq(f);
      });
      g["finally"](function () {
        vc(d.ud, f);
    ...
    function Wr(a, b, c, d, e, f) {
      var g, h, k, l, m, n, p, r, u, x, w;
      return J(function (y) {
        switch (y.a) {
          case 1:
            return Yr(), h = g = null, k = new gr(), m = l = null, A(y, 2, 3), v(y, d(), 5);

          case 5:
            return g = y.b, v(y, Zr(a, b, g, e), 6);

          case 6:
            n = y.b;
            $r(a);
            p = !n.presentationTimeline.U() && !n.presentationTimeline.eb();
            if (!p) throw new L(2, 9, 9005, b);
            return v(y, as(a, n, function (D) {
              m = m || D;
            }, e), 7);
          ...
          case 7:
            ...
            $r(a);
            if (m) throw m;
            return v(y, a.qc(n, h, e), 8);

          case 8:
            return v(y, k.init(), 9);

          case 9:
            return $r(a), v(y, ir(k), 10);

          case 10:
            return l = y.b, $r(a), v(y, bs(a, l.fa, h, n, b, c, e, f), 11);

          case 11:
            r = y.b;
            $r(a);
            if (m) throw m;
            return v(y, l.fa.addManifests([r]), 12);

          case 12:
            return u = y.b, $r(a), x = new zr("manifest", l.path.Ea, l.path.fa, u[0]), y["return"](Qr(x, r));

          case 3:
            return xa(y), a.Ec = [], v(y, k.destroy(), 13);
          ...
          case 2:
            ...
            return v(y, l.fa.removeSegments(a.Ec, function () {}), 18);
    ...
    q.qc = function (a, b, c) {
      var d, e, f, g, h, k, l, m, n, p, r, u, x, w, y, D, C, B, F, G, H, I, N, T, Q;
      return J(function (W) {
        switch (W.a) {
          case 1:
            d = {
            ...
            Xf(a, c.restrictions, d);
            c.useMediaCapabilities ? bg(a, c.offline.usePersistentLicense) : (ag(a), $f(a, b));
            e = [];
            ...
            for (h = g.next(); !h.done; h = g.next()) {
              k = h.value, e.push(kg(k));
            }

            l = t(a.textStreams);

            for (m = l.next(); !m.done; m = l.next()) {
              n = m.value, e.push(lg(n));
            }

            p = t(a.imageStreams);

            for (r = p.next(); !r.done; r = p.next()) {
              u = r.value, e.push(mg(u));
            }

            return v(W, c.offline.trackSelectionCallback(e), 2);

          case 2:
            x = W.b;
            w = a.presentationTimeline.getDuration();
            y = 0;
            D = t(x);

            for (C = D.next(); !C.done; C = D.next()) {
              B = C.value, F = B.bandwidth * w / 8, y += F;
            }

            A(W, 3);
            return v(W, c.offline.downloadSizeCallback(y), 5);

          case 5:
            G = W.b;
            if (!G) throw new L(2, 9, 9014);
            wa(W, 4);
            break;

          case 3:
            throw E(W), new L(2, 9, 9015);
          ...
          case 4:
            ...
            for (C = T.next(); !C.done; C = T.next()) {
              Q = C.value, "variant" == Q.type && H.add(Q.id), "text" == Q.type && I.add(Q.id), "image" == Q.type && N.add(Q.id);
            }

            a.variants = a.variants.filter(function (P) {
              return H.has(P.id);
            });
            a.textStreams = a.textStreams.filter(function (P) {
              return I.has(P.id);
            });
            a.imageStreams = a.imageStreams.filter(function (P) {
              return N.has(P.id);
            });
            cs(a);
            z(W);
    ...
    function bs(a, b, c, d, e, f, g, h) {
      var k, l, m, n, p, r, u, x, w, y, D, C;
      return J(function (B) {
        switch (B.a) {
          case 1:
            return k = Or(e, d, f), l = g.offline.progressCallback, m = function m(F, G) {
              k.size = G;
              l(k, F);
            }, n = function n(F, G) {
              u && g.offline.usePersistentLicense && x == G && Kh(c, "cenc", F);
            }, Rq(h, m, n), p = d.variants.some(function (F) {
            ...
            }), u = p && !r, x = null, u && (w = c.c, x = ds.get(w.keySystem)), va(B), D = y = es(a, h, b, c, d, e, f, g), v(B, Wq(h), 4);
          ...
          case 4:
            ...
            if (p && g.offline.usePersistentLicense && !C.length) throw new L(2, 9, 9007);
            return B["return"](y);

          case 2:
            return xa(B), v(B, h.destroy(), 5);
      ...
      return J(function (k) {
        switch (k.a) {
          case 1:
            Yr();
            c = Ar(b);
            if (null == c || "manifest" != c.a) throw new L(2, 9, 9004, b);
            d = c;
            e = new gr();
            va(k);
            return v(k, e.init(), 4);
          ...
          case 4:
            return v(k, kr(e, d.Ea(), d.fa()), 5);

          case 5:
            return f = k.b, v(k, f.getManifests([d.key()]), 6);

          case 6:
            return g = k.b, h = g[0], v(k, Promise.all([hs(a, h, e), is(f, d, h)]), 2);
    ...
    function js(a, b) {
      for (var c = [], d = t(a.streams), e = d.next(); !e.done; e = d.next()) {
        e = e.value, b && "video" == e.type ? c.push({
          contentType: Pe(e.mimeType, e.codecs),
    ...
    function hs(a, b, c) {
      return J(function (d) {
        return v(d, ks(a.K, a.i.drm, c, b), 0);
      });
    }
    ...
    function ms(a) {
      ...
      return J(function (n) {
        switch (n.a) {
          case 1:
            return Yr(), b = a.K, c = a.i.drm, d = new gr(), e = !1, va(n), v(n, d.init(), 4);
          ...
          case 8:
            return l = n.b, v(n, Lr(c, b, l), 9);

          case 9:
            return m = n.b, v(n, k.remove(m), 10);
    ...
    function ns() {
      ...
      return J(function (d) {
        switch (d.a) {
          case 1:
            return Yr(), a = [], b = new gr(), va(d), v(d, b.init(), 4);

          case 4:
            return c = Promise.resolve(), jr(b, function (e, f) {
              c = c.then(function () {
                var g;
                return J(function (h) {
                  if (1 == h.a) return v(h, f.getAllManifests(), 2);
                  g = h.b;
                  g.forEach(function (k, l) {
                    var m = Qr(new zr("manifest", e.Ea, e.fa, l), k);
                    a.push(m);
                  });
                  z(h);
                });
    ...
    function Zr(a, b, c, d) {
      var e, f, g, h, k;
      return J(function (l) {
        if (1 == l.a) return e = null, f = a.K, g = {
          networkingEngine: f,
          ...
          enableLowLatencyMode: function enableLowLatencyMode() {}
        }, c.configure(d.manifest), $r(a), v(l, c.start(b, g), 2);
        if (3 != l.a) return h = l.b, $r(a), k = os(h), v(l, Promise.all(fb(k, function (m) {
        ...
        switch (f.a) {
          case 1:
            return e = new rh({
              ...
              onExpirationUpdated: function onExpirationUpdated() {},
              onEvent: function onEvent() {}
            }), e.configure(d.drm), v(f, wh(e, b.variants, d.offline.usePersistentLicense, d.useMediaCapabilities), 2);
    ...
    function es(a, b, c, d, e, f, g, h) {
      for (var k = new Rr(), l = t(e.variants), m = l.next(); !m.done; m = l.next()) {
        var n = k;
        m = m.value;
        var p = m.audio,
            r = m.video;
        p && !r && (n.a[p.id] = p.bandwidth || m.bandwidth);
        !p && r && (n.a[r.id] = r.bandwidth || m.bandwidth);

        if (p && r) {
          var u = p.bandwidth || 393216,
              x = r.bandwidth || m.bandwidth - u;
          0 >= x && (x = m.bandwidth);
          n.a[p.id] = u;
          n.a[r.id] = x;
        }
      ...
      for (n = l.next(); !n.done; n = l.next()) {
        n = n.value, k.a[n.id] = n.bandwidth || 2048;
      }
      ...
      for (r = p.next(); !r.done; r = p.next()) {
        r = r.value, u = ps(a, b, c, k, e, r, h, n, m), l.set(r.id, u);
      }

      a = t(e.variants);

      for (m = a.next(); !m.done; m = a.next()) {
        b = m.value, b.audio && l.get(b.audio.id).variantIds.push(b.id), b.video && l.get(b.video.id).variantIds.push(b.id);
      }
    ...
    function ps(a, b, c, d, e, f, g, h, k) {
      var l = {
        ...
        tilesLayout: f.tilesLayout
          ...
          m = f.id;
      qs(f, e.presentationTimeline.Ua(), function (n) {
        var p = rs(a, b, m, f.id, c, d, n.b, g, h),
            r = ss(a, b, m, f.id, c, d, n, g, k);
        Vq(b, m, function () {
          var u, x;
          return J(function (w) {
            if (1 == w.a) return v(w, p, 2);
            if (3 != w.a) return u = w.b, v(w, r, 3);
            x = w.b;
            l.segments.push({
              initSegmentKey: u,
    ...
    function rs(a, b, c, d, e, f, g, h, k) {
      ...
      h = Zi(g.ga(), g.da, g.Y, h.streaming.retryParameters);
      b = Tq(b, c, h, .5 * Tr(f, d), !0, function (l) {
        var m;
        return J(function (n) {
          if (1 == n.a) return v(n, e.addSegments([{
            data: l
          }]), 2);
          m = n.b;
          a.Ec.push(m[0]);
    ...
    function ss(a, b, c, d, e, f, g, h, k) {
      var l = [g.ga()[0], g.da, g.Y].join("-");
      if (k.has(l)) return k.get(l);
      h = Zi(g.ga(), g.da, g.Y, h.streaming.retryParameters);
      b = Tq(b, c, h, Sr(f, d, g), !1, function (m) {
        var n;
        return J(function (p) {
          if (1 == p.a) return v(p, e.addSegments([{
            data: m
          }]), 2);
          n = p.b;
          a.Ec.push(n[0]);
    ...
    function qs(a, b, c) {
      ...
      if (null != b) for (var d = a.segmentIndex.get(b); d;) {
    ...
    function Yr() {
      if (!Vr()) throw new L(2, 9, 9E3);
    }

    function fs(a, b) {
      return J(function (c) {
        if (1 == c.a) return a.Tb.push(b), va(c), v(c, b, 4);
        ...
        if (1 == h.a) {
          ...
          f = d.sessionIds.map(function (k) {
            return {
              ...
              audioCapabilities: js(d, !1),
              videoCapabilities: js(d, !0)
            };
          });
          return v(h, Lr(b, a, f), 2);
        }

        return 3 != h.a ? (g = h.b, v(h, e.remove(g), 3)) : v(h, e.add(f.filter(function (k) {
    ...
    function os(a) {
      for (var b = new Set(), c = t(a.textStreams), d = c.next(); !d.done; d = c.next()) {
        b.add(d.value);
      }
    ...
    K("shaka.offline.Storage", Ur);

    Ur.deleteAll = function () {
      var a;
      return J(function (b) {
        return 1 == b.a ? (a = new gr(), va(b), v(b, nr(a), 2)) : 5 != b.a ? (xa(b), v(b, a.destroy(), 5)) : ya(b, 0);
      });
    };

    Ur.prototype.list = Ur.prototype.list;
    Ur.prototype.removeEmeSessions = Ur.prototype.uf;
    Ur.prototype.remove = Ur.prototype.remove;
    Ur.prototype.getStoreInProgress = Ur.prototype.Ye;
    Ur.prototype.store = Ur.prototype.store;
    Ur.prototype.getNetworkingEngine = Ur.prototype.Nb;
    Ur.prototype.getConfiguration = Ur.prototype.getConfiguration;
    Ur.prototype.configure = Ur.prototype.configure;
    Ur.prototype.destroy = Ur.prototype.destroy;
    Ur.support = Vr;
    ...
    function us(a, b) {
      for (var c = {
        priority: b || 0,
        we: a
      }, d = t(lb(vs)), e = d.next(); !e.done; e = d.next()) {
        e = e.value;
        var f = e.ba;
    ...
    ts.installAll = function () {
      for (var a = t(vs), b = a.next(); !b.done; b = a.next()) {
        b = b.value;
    ...
    us(function () {
      if (window.Document) {
        ...
        document.addEventListener("webkitfullscreenchange", xs);
        document.addEventListener("webkitfullscreenerror", xs);
        document.addEventListener("mozfullscreenchange", xs);
        document.addEventListener("mozfullscreenerror", xs);
        document.addEventListener("MSFullscreenChange", xs);
        document.addEventListener("MSFullscreenError", xs);
      }
    });
    us(function () {});
    ...
    us(function () {
      !ec() && navigator.mediaCapabilities || !window.MediaSource || (navigator.mediaCapabilities = {}, navigator.mediaCapabilities.decodingInfo = ys);
    }, -1);
    ...
    us(function () {
      var a = gc();
      window.MediaSource && (window.cast && cast.__platform__ && cast.__platform__.canDisplayType ? Ds() : a ? (Bs(), 12 >= a ? (zs(), As()) : zs()) : (dc("Tizen 2") || dc("Tizen 3") || dc("Tizen 4")) && Cs());
      window.MediaSource && MediaSource.isTypeSupported('video/webm; codecs="vp9"') && !MediaSource.isTypeSupported('video/webm; codecs="vp09.00.10.08"') && Es();
    });
    ...
    us(function () {
      screen.orientation || void 0 != window.orientation && Fs();
    });
    ...
    function Js(a) {
      ...
      return (this.mediaKeys = a) ? Ks(a, this) : Promise.resolve();
    }
    ...
    function Is(a, b) {
      this.keySystem = a;
      if (a.startsWith("com.apple.fps")) for (var c = t(b), d = c.next(); !d.done; d = c.next()) {
        var e = d.value;
        if ("required" == e.persistentState) d = null;else {
          d = {
            audioCapabilities: [],
            videoCapabilities: [],
          ...
          var f = !1,
              g = !1;
          if (e.audioCapabilities) for (var h = t(e.audioCapabilities), k = h.next(); !k.done; k = h.next()) {
          ...
          if (e.videoCapabilities) for (e = t(e.videoCapabilities), k = e.next(); !k.done; k = e.next()) {
            h = k.value, h.contentType && (f = !0, WebKitMediaKeys.isTypeSupported(this.keySystem, h.contentType.split(";")[0]) && (d.videoCapabilities.push(h), g = !0));
          }
    ...
    Is.prototype.createMediaKeys = function () {
      var a = new Ms(this.keySystem);
      return Promise.resolve(a);
    };

    Is.prototype.getConfiguration = function () {
      return this.a;
    };
    ...
    Ms.prototype.createSession = function (a) {
      a = a || "temporary";
      if ("temporary" != a) throw new TypeError("Session type " + a + " is unsupported on this platform.");
      return new Ns(this.a, a);
    };

    Ms.prototype.setServerCertificate = function () {
    ...
    function Ks(a, b) {
      ...
      a.b.s(b, "webkitneedkey", Ls);

      try {
        return vi(b, HTMLMediaElement.HAVE_METADATA, a.b, function () {
    ...
    q.generateRequest = function (a, b) {
      ...
      try {
        var d = this.g.createSession("video/mp4", pb(b));
        this.f = d;
        this.sessionId = d.sessionId || "";
        this.b.s(this.f, "webkitkeymessage", function (e) {
          c.a && (c.a.resolve(), c.a = null);
          e = new O("message", {
            messageType: void 0 == c.keyStatuses.a ? "license-request" : "license-renewal",
            message: rb(e.message)
          });
          c.dispatchEvent(e);
        });
        this.b.s(d, "webkitkeyadded", function () {
          c.c && (Ps(c, "usable"), c.c.resolve(), c.c = null);
        });
        this.b.s(d, "webkitkeyerror", function () {
          var e = Error("EME PatchedMediaKeysApple key error");
          e.errorCode = c.f.error;
          if (null != c.a) c.a.reject(e), c.a = null;else if (null != c.c) c.c.reject(e), c.c = null;else switch (c.f.error.code) {
            case WebKitMediaKeyError.MEDIA_KEYERR_OUTPUT:
            case WebKitMediaKeyError.MEDIA_KEYERR_HARDWARECHANGE:
              Ps(c, "output-not-allowed");
              break;
    ...
    q.close = function () {
      try {
        this.f.close(), this.closed.resolve(), this.b.hb();
      } catch (a) {
    ...
    us(function () {
      window.HTMLVideoElement && window.WebKitMediaKeys && (delete HTMLMediaElement.prototype.mediaKeys, HTMLMediaElement.prototype.mediaKeys = null, HTMLMediaElement.prototype.setMediaKeys = Js, window.MediaKeys = Ms, window.MediaKeySystemAccess = Is, navigator.requestMediaKeySystemAccess = Hs);
    });
    ...
    function Rs(a, b) {
      ...
      for (var c = !1, d = t(b), e = d.next(); !e.done; e = d.next()) {
        ...
        if (e.videoCapabilities) for (h = t(e.videoCapabilities), k = h.next(); !k.done; k = h.next()) {
          k = k.value, k.contentType && (g = !0, MSMediaKeys.isTypeSupported(this.keySystem, k.contentType.split(";")[0]) && (f.videoCapabilities.push(k), c = !0));
        }
    ...
    function Us(a) {
      ...
      b && b != a && Vs(b, null);
      delete this.mediaKeys;
      return (this.mediaKeys = a) ? Vs(a, this) : Promise.resolve();
    }
    ...
    Ts.prototype.createSession = function (a) {
      a = a || "temporary";
      if ("temporary" != a) throw new TypeError("Session type " + a + " is unsupported on this platform.");
      return new Ws(this.a, a);
    };

    Ts.prototype.setServerCertificate = function () {
      return Promise.resolve(!1);
    };
    ...
    q.generateRequest = function (a, b) {
      ...
      try {
        this.f = this.g.createSession("video/mp4", pb(b), null), this.b.s(this.f, "mskeymessage", function (d) {
          c.a && (c.a.resolve(), c.a = null);
          d = new O("message", {
            messageType: void 0 == c.keyStatuses.a ? "license-request" : "license-renewal",
          ...
          c.dispatchEvent(d);
        }), this.b.s(this.f, "mskeyadded", function () {
          c.a ? (Ys(c, "usable"), c.a.resolve(), c.a = null) : c.c && (Ys(c, "usable"), c.c.resolve(), c.c = null);
        }), this.b.s(this.f, "mskeyerror", function () {
          var d = Error("EME PatchedMediaKeysMs key error");
          d.errorCode = c.f.error;
          if (null != c.a) c.a.reject(d), c.a = null;else if (null != c.c) c.c.reject(d), c.c = null;else switch (c.f.error.code) {
            case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:
            case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:
              Ys(c, "output-not-allowed");
              break;

            default:
              Ys(c, "internal-error");
          }
        }), Ys(this, "status-pending");
      } catch (d) {
        this.a.reject(d);
      }
    ...
    at.prototype.createSession = function () {};
    ...
    bt.prototype.getConfiguration = function () {};

    bt.prototype.createMediaKeys = function () {};
      ...
      for (var f = t(b), g = f.next(); !g.done; g = f.next()) {
        ...
        var h = {
          ...
          label: g.label
            ...
            k = !1;
        if (g.audioCapabilities) for (var l = t(g.audioCapabilities), m = l.next(); !m.done; m = l.next()) {
          m = m.value, m.contentType && (k = !0, e.canPlayType(m.contentType.split(";")[0], this.a) && (h.audioCapabilities.push(m), d = !0));
        }
        if (g.videoCapabilities) for (l = t(g.videoCapabilities), m = l.next(); !m.done; m = l.next()) {
          m = m.value, m.contentType && (k = !0, e.canPlayType(m.contentType, this.a) && (h.videoCapabilities.push(m), d = !0));
        }
        k || (d = e.canPlayType("video/mp4", this.a) || e.canPlayType("video/webm", this.a));
    ...
    ft.prototype.createMediaKeys = function () {
      var a = new it(this.a);
      return Promise.resolve(a);
    };

    ft.prototype.getConfiguration = function () {
      return this.b;
    };
    ...
    function ht(a, b) {
      ...
      a.b.hb();
      var c = dt;
      b && (a.b.s(b, c + "needkey", function (d) {
        var e = new CustomEvent("encrypted");
        e.initDataType = "cenc";
        e.initData = rb(d.initData);
        a.a.dispatchEvent(e);
      }), a.b.s(b, c + "keymessage", function (d) {
        var e = jt(a, d.sessionId);
        e && (d = new O("message", {
          messageType: void 0 == e.keyStatuses.a ? "licenserequest" : "licenserenewal",
          message: d.message
        }), e.b && (e.b.resolve(), e.b = null), e.dispatchEvent(d));
      }), a.b.s(b, c + "keyadded", function (d) {
        if (d = jt(a, d.sessionId)) kt(d, "usable"), d.a && d.a.resolve(), d.a = null;
      }), a.b.s(b, c + "keyerror", function (d) {
        var e = jt(a, d.sessionId);
        e && e.handleError(d);
      }));
    }

    it.prototype.createSession = function (a) {
      a = a || "temporary";
    ...
    function jt(a, b) {
      var c = a.f.get(b);
      return c ? c : (c = a.c.shift()) ? (c.sessionId = b, a.f.set(b, c), c) : null;
    }
    ...
    q.handleError = function (a) {
      ...
      b.errorCode = c;
      !a.sessionId && this.b ? (45 == a.systemCode && (b.message = "Unsupported session type."), this.b.reject(b), this.b = null) : a.sessionId && this.a ? (this.a.reject(b), this.a = null) : (b = a.systemCode, a.errorCode.code == MediaKeyError.MEDIA_KEYERR_OUTPUT ? kt(this, "output-restricted") : 1 == b ? kt(this, "expired") : kt(this, "internal-error"));
    };
    ...
    function nt(a, b, c) {
      ...
      try {
        if ("persistent-license" == a.g) {
          if (c) var d = pb(Ab("LOAD_SESSION|" + c));else {
            var e = Ab("PERSISTENT|");
            d = pc(e, b);
          }
        } else d = pb(b);
    ...
    q.generateRequest = function (a, b) {
      return nt(this, b, null);
    };

    q.load = function (a) {
      return "persistent-license" == this.g ? nt(this, null, a) : Promise.reject(Error("Not a persistent session."));
    };
    ...
    us(function () {
      if (!(!window.HTMLVideoElement || navigator.requestMediaKeySystemAccess && MediaKeySystemAccess.prototype.getConfiguration)) {
        if (HTMLMediaElement.prototype.webkitGenerateKeyRequest) dt = "webkit";else if (!HTMLMediaElement.prototype.generateKeyRequest) return;
        navigator.requestMediaKeySystemAccess = et;
        delete HTMLMediaElement.prototype.mediaKeys;
        HTMLMediaElement.prototype.mediaKeys = null;
        HTMLMediaElement.prototype.setMediaKeys = gt;
        window.MediaKeys = it;
        window.MediaKeySystemAccess = ft;
      }
    });
    ...
    us(function () {
      if (window.HTMLVideoElement) {
        ...
        a.requestPictureInPicture && document.exitPictureInPicture || !a.webkitSupportsPresentationMode || (document.pictureInPictureEnabled = !0, document.pictureInPictureElement = null, a.requestPictureInPicture = qt, Object.defineProperty(a, "disablePictureInPicture", {
          get: st,
          set: tt,
          enumerable: !0,
          configurable: !0
        }), document.exitPictureInPicture = rt, document.addEventListener("webkitpresentationmodechanged", pt, !0));
      }
    });
    ...
    us(function () {
      navigator.storage && navigator.storage.estimate || !navigator.webkitTemporaryStorage || !navigator.webkitTemporaryStorage.queryUsageAndQuota || ("storage" in navigator || (navigator.storage = {}), navigator.storage.estimate = ut);
    });
    us(function () {
    ...
    us(function () {
      if (window.HTMLVideoElement) {
        var a = HTMLVideoElement.prototype;
        !a.getVideoPlaybackQuality && "webkitDroppedFrameCount" in a && (a.getVideoPlaybackQuality = vt);
      }
    });
    ...
    us(function () {
      if (!window.VTTCue && window.TextTrackCue) {
        ...
        if (3 == b) a = wt;else if (6 == b) a = xt;else {
          try {
            var c = !!wt(1, 2, "");
          } catch (d) {
            c = !1;
    ...
    yt.prototype.parseInit = function () {};

    yt.prototype.parseMedia = function (a, b) {
      var c = null,
          d = [],
          e = wb(a).split(/\r?\n/);
      e = t(e);
      ...
      for (var f = e.next(); !f.done; f = e.next()) {
        if ((f = f.value) && !/^\s+$/.test(f) && (f = zt.exec(f))) {
          var g = At.exec(f[1]);
          g = 60 * parseInt(g[1], 10) + parseFloat(g[2].replace(",", "."));
          f = new yc(g, b.segmentEnd ? b.segmentEnd : g + 2, f[2]);
    ...
    K("shaka.text.LrcTextParser", yt);
    yt.prototype.parseMedia = yt.prototype.parseMedia;
    yt.prototype.parseInit = yt.prototype.parseInit;
    var zt = /^\[(\d{1,2}:\d{1,2}(?:[.,]\d{1,3})?)\](.*)/,
        At = /^(\d+):(\d{1,2}(?:[.,]\d{1,3})?)$/;

    We["application/x-subtitle-lrc"] = function () {
      return new yt();
    };
    ...
    Bt.prototype.parseMedia = function (a, b) {
      ...
      if (f) {
        if (c = f.getElementsByTagName("parsererror")[0]) throw new L(2, 2, 2005, c.textContent);
        var g = f.getElementsByTagName("tt")[0];
        if (!g) throw new L(2, 2, 2005, "TTML does not contain <tt> tag.");
        e = g.getElementsByTagName("body")[0];
        if (!e) return [];
        c = xn(g, "http://www.w3.org/ns/ttml#parameter", "frameRate");
        var h = xn(g, "http://www.w3.org/ns/ttml#parameter", "subFrameRate"),
            k = xn(g, "http://www.w3.org/ns/ttml#parameter", "frameRateMultiplier"),
            l = xn(g, "http://www.w3.org/ns/ttml#parameter", "tickRate"),
            m = xn(g, "http://www.w3.org/ns/ttml#parameter", "cellResolution");
        f = g.getAttribute("xml:space") || "default";
        var n = xn(g, "http://www.w3.org/ns/ttml#styling", "extent");
        if ("default" != f && "preserve" != f) throw new L(2, 2, 2005, "Invalid xml:space value: " + f);
        f = "default" == f;
        c = new Ct(c, h, k, l);
        m = m ? (m = /^(\d+) (\d+)$/.exec(m)) ? {
        ...
        h = (h = g.getElementsByTagName("metadata")[0]) ? wn(h) : [];
        ...
        for (var p = t(g), r = p.next(); !r.done; r = p.next()) {
          var u = r.value;
          r = new Ac();
          var x = u.getAttribute("xml:id");

          if (x) {
            r.id = x;
            var w = null;
            n && (w = Dt.exec(n) || Et.exec(n));
            x = w ? Number(w[1]) : null;
            w = w ? Number(w[2]) : null;
            var y, D;
            if (y = Ft(u, k, "extent")) y = (D = Dt.exec(y)) || Et.exec(y), null != y && (r.width = Number(y[1]), r.height = Number(y[2]), D || (null != x && (r.width = 100 * r.width / x), null != w && (r.height = 100 * r.height / w)), r.widthUnits = D || null != x ? Rc : 0, r.heightUnits = D || null != w ? Rc : 0);
            if (u = Ft(u, k, "origin")) y = (D = Dt.exec(u)) || Et.exec(u), null != y && (r.viewportAnchorX = Number(y[1]), r.viewportAnchorY = Number(y[2]), D || (null != w && (r.viewportAnchorY = 100 * r.viewportAnchorY / w), null != x && (r.viewportAnchorX = 100 * r.viewportAnchorX / x)), r.viewportAnchorUnits = D || null != x ? Rc : 0);
          } else r = null;

          r && l.push(r);
        }

        if (tn(e, "p").length) throw new L(2, 2, 2001, "<p> can only be inside <div> in TTML");
        e = t(tn(e, "div"));

        for (n = e.next(); !n.done; n = e.next()) {
          n = n.value;
          if (tn(n, "span").length) throw new L(2, 2, 2001, "<span> can only be inside <p> in TTML");
          if ((p = tn(n, "p")) && p.length) for (n = t(p), p = n.next(); !p.done; p = n.next()) {
            (p = Gt(p.value, b.periodStart, c, h, k, g, l, f, !1, m)) && d.push(p);
          } else (n = Gt(n, b.periodStart, c, h, k, g, l, f, !1, m)) && d.push(n);
        }
      }
    ...
    function Gt(a, b, c, d, e, f, g, h, k, l) {
      var m = a.parentNode;
      ...
      for (p = p.end; m && m.nodeType == Node.ELEMENT_NODE && "tt" != m.tagName;) {
        p = It(m, c, n, p), n = p.start, p = p.end, m = m.parentNode;
      }

      null == n && (n = 0);
      n += b;
      p = null == p ? Infinity : p + b;
      if ("br" == a.tagName) return d = new yc(n, p, ""), d.lineBreak = !0, d;
      var r = "";
      m = [];
      if (Array.from(a.childNodes).every(function (y) {
        return y.nodeType == Node.TEXT_NODE;
      })) r = a.textContent, h && (r = r.trim(), r = r.replace(/\s+/g, " "));else for (var u = t(a.childNodes), x = u.next(); !x.done; x = u.next()) {
        (x = Gt(x.value, b, c, d, e, f, g, h, !0, l)) && m.push(x);
      }
      b = new yc(n, p, r);
      b.nestedCues = m;
      l && (b.cellResolution = l);

      if ((f = Jt(a, "region", f, "")[0]) && f.getAttribute("xml:id")) {
      ...
      for (c = l.next(); !c.done && !(g = Jt(a, "backgroundImage", d, "#", c.value)[0]); c = l.next()) {
        ;
      }

      Lt(b, a, f, g, e, k, 0 == m.length);
      return b;
    }

    function Lt(a, b, c, d, e, f, g) {
      f = f || g;
      "rtl" == Mt(b, c, e, "direction", f) && (a.direction = "rtl");
      g = Mt(b, c, e, "writingMode", f);
      "tb" == g || "tblr" == g ? a.writingMode = "vertical-lr" : "tbrl" == g ? a.writingMode = "vertical-rl" : "rltb" == g || "rl" == g ? a.direction = "rtl" : g && (a.direction = zc);
      (g = Mt(b, c, e, "textAlign", f)) ? (a.positionAlign = Nt[g], a.lineAlign = Ot[g], a.textAlign = Lc[g.toUpperCase()]) : a.textAlign = "start";
      if (g = Mt(b, c, e, "displayAlign", f)) a.displayAlign = Mc[g.toUpperCase()];
      if (g = Mt(b, c, e, "color", f)) a.color = g;
      if (g = Mt(b, c, e, "backgroundColor", f)) a.backgroundColor = g;
      if (g = Mt(b, c, e, "border", f)) a.border = g;
      if (g = Mt(b, c, e, "fontFamily", f)) a.fontFamily = g;
      (g = Mt(b, c, e, "fontWeight", f)) && "bold" == g && (a.fontWeight = 700);
      g = Mt(b, c, e, "wrapOption", f);
      a.wrapLine = g && "noWrap" == g ? !1 : !0;
      (g = Mt(b, c, e, "lineHeight", f)) && g.match(Pt) && (a.lineHeight = g);
      (g = Mt(b, c, e, "fontSize", f)) && (g.match(Pt) || g.match(Qt)) && (a.fontSize = g);
      if (g = Mt(b, c, e, "fontStyle", f)) a.fontStyle = Qc[g.toUpperCase()];
      ...
      (d = Mt(b, c, e, "letterSpacing", f)) && d.match(Pt) && (a.letterSpacing = d);
      (d = Mt(b, c, e, "linePadding", f)) && d.match(Pt) && (a.linePadding = d);
      if (f = Mt(b, c, e, "opacity", f)) a.opacity = parseFloat(f);
      (c = Ft(c, e, "textDecoration")) && Rt(a, c);
      (b = St(b, e, "textDecoration")) && Rt(a, b);
    }
    ...
    function Rt(a, b) {
      for (var c = t(b.split(" ")), d = c.next(); !d.done; d = c.next()) {
        switch (d.value) {
          ...
          case "noUnderline":
            a.textDecoration.includes("underline") && vc(a.textDecoration, "underline");
            break;
          ...
          case "noLineThrough":
            a.textDecoration.includes("lineThrough") && vc(a.textDecoration, "lineThrough");
            break;
          ...
          case "noOverline":
            a.textDecoration.includes("overline") && vc(a.textDecoration, "overline");
        }
      }
    }
    ...
    function Mt(a, b, c, d, e) {
      e = void 0 === e ? !0 : e;
      return (a = St(a, c, d)) ? a : e ? Ft(b, c, d) : null;
    }

    function Ft(a, b, c) {
      if (!a) return null;
      var d = xn(a, "http://www.w3.org/ns/ttml#styling", c);
      return d ? d : Tt(a, b, c);
    }
    ...
    function Tt(a, b, c) {
      ...
      for (var d = null, e = 0; e < a.length; e++) {
        var f = xn(a[e], "urn:ebu:tt:style", c);
        f || (f = xn(a[e], "http://www.w3.org/ns/ttml#styling", c));
        f || (f = St(a[e], b, c));
        f && (d = f);
      }
    ...
    function Jt(a, b, c, d, e) {
      ...
      for (a = null; g && !(a = e ? xn(g, e, b) : g.getAttribute(b)) && (g = g.parentNode, g instanceof Element);) {
        ;
      }

      if (b = a) for (b = t(b.split(" ")), e = b.next(); !e.done; e = b.next()) {
    ...
    function Ht(a, b) {
      var c = Ut(a.getAttribute("begin"), b),
          d = Ut(a.getAttribute("end"), b),
          e = Ut(a.getAttribute("dur"), b);
      null == d && null != e && (d = c + e);
      return {
        start: c,
        end: d
    ...
    function Ut(a, b) {
      ...
      if (Vt.test(a)) {
        ...
        f += g / b.frameRate;
        c = f + 60 * e + 3600 * d;
      } else if (Wt.test(a)) c = Xt(Wt, a);else if (Yt.test(a)) c = Xt(Yt, a);else if (Zt.test(a)) c = Zt.exec(a), c = Number(c[1]) / b.frameRate;else if ($t.test(a)) c = $t.exec(a), c = Number(c[1]) / b.a;else if (au.test(a)) c = Xt(au, a);else if (a) throw new L(2, 2, 2001, "Could not parse cue time range in TTML");
    ...
    K("shaka.text.TtmlTextParser", Bt);
    ...
    var Dt = /^(\d{1,2}(?:\.\d+)?|100(?:\.0+)?)% (\d{1,2}(?:\.\d+)?|100(?:\.0+)?)%$/,
        Qt = /^(\d{1,2}(?:\.\d+)?|100)%$/,
        Pt = /^(\d+px|\d+em|\d*\.?\d+c)$/,
        Et = /^(\d+)px (\d+)px$/,
        Vt = /^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,
        Wt = /^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,
        Yt = /^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,
        Zt = /^(\d*(?:\.\d*)?)f$/,
        $t = /^(\d*(?:\.\d*)?)t$/,
        au = /^(?:(\d*(?:\.\d*)?)h)?(?:(\d*(?:\.\d*)?)m)?(?:(\d*(?:\.\d*)?)s)?(?:(\d*(?:\.\d*)?)ms)?$/,
        Ot = {
      left: Gc,
      center: "center",
      right: "end",
      ...
      right: "line-right"
        ...
        Kt = ["http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt", "http://www.smpte-ra.org/schemas/2052-1/2013/smpte-tt"];

    We["application/ttml+xml"] = function () {
      return new Bt();
    };
    ...
    bu.prototype.parseInit = function (a) {
      var b = !1;
      new Qb().box("moov", Ub).box("trak", Ub).box("mdia", Ub).box("minf", Ub).box("stbl", Ub).S("stsd", Wb).box("stpp", function (c) {
        b = !0;
        c.parser.stop();
      }).parse(a);
    ...
    bu.prototype.parseMedia = function (a, b) {
      var c = this,
          d = !1,
          e = [];
    ...
    K("shaka.text.Mp4TtmlParser", bu);
    bu.prototype.parseMedia = bu.prototype.parseMedia;
    bu.prototype.parseInit = bu.prototype.parseInit;

    We['application/mp4; codecs="stpp"'] = function () {
      return new bu();
    };

    We['application/mp4; codecs="stpp.ttml.im1t"'] = function () {
      return new bu();
    };
    ...
    cu.prototype.parseInit = function () {};

    cu.prototype.parseMedia = function (a, b) {
      var c = wb(a);
      c = c.replace(/\r\n|\r(?=[^\n]|$)/gm, "\n");
      var d = c.split(/\n{2,}/m);
      ...
      for (h = d.next(); !h.done; h = d.next()) {
        ...
        p = c;
        if (1 == h.length && !h[0] || /^NOTE($|[ \t])/.test(h[0]) || "STYLE" == h[0]) h = null;else {
          l = null;
          ...
          r = Hp(k, /[ \t]+--\x3e[ \t]+/g);
          n = du(k);
          if (null == m || null == r || null == n) throw new L(2, 2, 2001, "Could not parse cue time range in WebVTT");
          m += p;
          n += p;
          p = h.slice(1).join("\n").trim();
          e.has("global") ? (h = e.get("global").clone(), h.startTime = m, h.endTime = n, h.payload = "") : h = new yc(m, n, "");
          fu(p, h, e);
          Gp(k);

          for (m = Ip(k); m;) {
            gu(h, m, f), Gp(k), m = Ip(k);
          }
    ...
    function eu(a) {
      for (var b = t(Object.entries(Oc)), c = b.next(); !c.done; c = b.next()) {
        var d = t(c.value);
        c = d.next().value;
        d = d.next().value;
        var e = new yc(0, 0, "");
      ...
      b = t(Object.entries(Pc));

      for (c = b.next(); !c.done; c = b.next()) {
        d = t(c.value), c = d.next().value, d = d.next().value, e = new yc(0, 0, ""), e.backgroundColor = d, a.set(c, e);
      }
    }
      ...
      a: {
        ...
        for (var e = -1, f = "", g = 0; g < d.length; g++) {
          if ("/" === d[g]) {
            ...
            g += h.length + 1;
          } else "<" === d[g] ? e = g + 1 : ">" === d[g] && 0 < e && (a.push(d.substr(e, g - e)), e = -1), f += d[g];
        }

        a = f;
      }

      if (e = Jn("<span>" + a + "</span>", "span")) {
        d = [];
        e = e.childNodes;
    ...
    function hu(a, b, c, d) {
      var e = b.clone();
      if (a.nodeType === Node.ELEMENT_NODE && a.nodeName) for (var f = t(a.nodeName.split(/[ .]+/)), g = f.next(); !g.done; g = f.next()) {
        g = g.value;

        if (d.has(g)) {
          var h = d.get(g);
          h && (e.backgroundColor = iu(h.backgroundColor, e.backgroundColor), e.color = iu(h.color, e.color), e.fontFamily = iu(h.fontFamily, e.fontFamily), e.fontSize = iu(h.fontSize, e.fontSize), e.fontWeight = h.fontWeight, e.fontStyle = h.fontStyle, e.opacity = h.opacity, e.wrapLine = h.wrapLine);
        }
      ...
      if (zn(a)) for (f = !0, d = t(a.textContent.split("\n")), a = d.next(); !a.done; a = d.next()) {
        a = a.value, f || (f = b.clone(), f.lineBreak = !0, c.push(f)), 0 < a.length && (f = e.clone(), f.payload = a, c.push(f)), f = !1;
      } else for (b = t(a.childNodes), a = b.next(); !a.done; a = b.next()) {
        hu(a.value, e, c, d);
      }
    }
    ...
    function gu(a, b, c) {
      var d;
      if (d = /^align:(start|middle|center|end|left|right)$/.exec(b)) b = d[1], "middle" == b ? a.textAlign = Dc : a.textAlign = Lc[b.toUpperCase()];else if (d = /^vertical:(lr|rl)$/.exec(b)) a.writingMode = "lr" == d[1] ? "vertical-lr" : "vertical-rl";else if (d = /^size:([\d.]+)%$/.exec(b)) a.size = Number(d[1]);else if (d = /^position:([\d.]+)%(?:,(line-left|line-right|center|start|end))?$/.exec(b)) a.position = Number(d[1]), d[2] && (b = d[2], a.positionAlign = "line-left" == b || "start" == b ? "line-left" : "line-right" == b || "end" == b ? "line-right" : "center");else if (d = /^region:(.*)$/.exec(b)) {
        if (b = ju(c, d[1])) a.region = b;
      } else if (c = /^line:([\d.]+)%(?:,(start|end|center))?$/.exec(b)) a.lineInterpretation = 1, a.line = Number(c[1]), c[2] && (a.lineAlign = Nc[c[2].toUpperCase()]);else if (c = /^line:(-?\d+)(?:,(start|end|center))?$/.exec(b)) a.lineInterpretation = Fc, a.line = Number(c[1]), c[2] && (a.lineAlign = Nc[c[2].toUpperCase()]);
    }
    ...
    K("shaka.text.VttTextParser", cu);
    cu.prototype.parseMedia = cu.prototype.parseMedia;
    cu.prototype.parseInit = cu.prototype.parseInit;

    We["text/vtt"] = function () {
      return new cu();
    };

    We['text/vtt; codecs="vtt"'] = function () {
      return new cu();
    };

    We['text/vtt; codecs="wvtt"'] = function () {
      return new cu();
    };
    ...
    ku.prototype.parseInit = function (a) {
      var b = this,
          c = !1;
      new Qb().box("moov", Ub).box("trak", Ub).box("mdia", Ub).S("mdhd", function (d) {
        d = be(d.reader, d.version);
        b.a = d.timescale;
      }).box("minf", Ub).box("stbl", Ub).S("stsd", Wb).box("wvtt", function () {
        c = !0;
      }).parse(a);
    ...
    ku.prototype.parseMedia = function (a, b) {
      ...
      var c = 0,
          ...
          k = !1,
          l = null;
      new Qb().box("moof", Ub).box("traf", Ub).S("tfdt", function (B) {
        g = !0;
        c = ae(B.reader, B.version).cd;
      }).S("tfhd", function (B) {
        l = $d(B.reader, B.flags).Pd;
      }).S("trun", function (B) {
        h = !0;
        d = ce(B.reader, B.version, B.flags).ge;
      }).box("mdat", Xb(function (B) {
        k = !0;
        e = B;
      })).parse(a, !1);
      ...
      for (var m = c, n = new Db(e, 0), p = t(d), r = p.next(); !r.done; r = p.next()) {
        ...
        do {
          ...
          var D = n.I(),
              C = null;
          "vttc" == Yb(D) ? 8 < y && (C = n.Va(y - 8)) : n.skip(y - 8);
          u && C && (y = lu(C, b.periodStart + x / this.a, b.periodStart + m / this.a), f.push(y));
        } while (r.sampleSize && w < r.sampleSize);
      }
    ...
    function mu(a, b, c, d, e) {
      ...
      fu(a, d, new Map());
      b && (d.id = b);
      if (c) for (a = new Fp(c), b = Ip(a); b;) {
        gu(d, b, []), Gp(a), b = Ip(a);
      }
      return d;
    }

    K("shaka.text.Mp4VttParser", ku);
    ku.prototype.parseMedia = ku.prototype.parseMedia;
    ku.prototype.parseInit = ku.prototype.parseInit;

    We['application/mp4; codecs="wvtt"'] = function () {
      return new ku();
    };

    function nu() {}

    nu.prototype.parseInit = function () {};

    nu.prototype.parseMedia = function (a) {
      ...
      for (var c = b.next(); !c.done; c = b.next()) {
        ...
        var d = new Fp(c[0]),
            ...
            f = Hp(d, /,/g);
        d = ou(d);
        if (null == e || null == f || null == d) throw new L(2, 2, 2001, "Could not parse cue time range in SubViewer");
        a.push(new yc(e, d, c.slice(1).join("\n").trim()));
      }
    ...
    K("shaka.text.SbvTextParser", nu);
    nu.prototype.parseMedia = nu.prototype.parseMedia;
    nu.prototype.parseInit = nu.prototype.parseInit;

    We["text/x-subviewer"] = function () {
      return new nu();
    };
    ...
    pu.prototype.parseMedia = function (a, b) {
      var c = wb(a);
      c = qu(c);
      c = pb(Ab(c));
      return this.j.parseMedia(c, b);
    };
    ...
    ru.prototype.parseMedia = function (a) {
      var b = "",
          c = "";
      a = wb(a).split(/\r?\n\s*\r?\n/);
      a = t(a);
      ...
      for (var f = b.next(); !f.done; f = b.next()) {
        if (e = f.value, !/^\s*;/.test(e) && (f = tu.exec(e))) if (e = f[1].trim(), f = f[2].trim(), "Format" == e) d = f.split(uu);else if ("Style" == e) {
          e = f.split(uu);
          f = {};
      ...
      for (f = c.next(); !f.done; e = {
        ...
        if (f = f.value, !/^\s*;/.test(f) && (g = tu.exec(f))) if (f = g[1].trim(), g = g[2].trim(), "Format" == f) b = g.split(uu);else if ("Dialogue" == f) {
          g = g.split(uu);
          f = {};
          ...
          h = vu(f.Start);
          var k = vu(f.End);
          g = new yc(h, k, g.slice(b.length - 1).join(",").replace(/\\N/g, "\n").replace(/\{[^}]+\}/g, ""));
          e.Uc = f.Style;
          (f = a.find(function (l) {
            return function (m) {
              return m.Name == l.Uc;
    ...
    function wu(a, b) {
      ...
      if (c = b.PrimaryColour) if (c = xu(c)) a.color = c;
      if (c = b.BackColour) if (c = xu(c)) a.backgroundColor = c;
    ...
    */
    ...
    function Cu(a, b) {
      var c = this,
          d;
      return J(function (e) {
        if (1 == e.a) return console.assert(c == navigator, 'bad "this" for requestMediaKeySystemAccess'), v(e, Au.call(c, a, b), 2);
        d = e.b;
        if (Du(d)) return console.debug("EmeEncryptionSchemePolyfill: Native encryptionScheme support found."), navigator.requestMediaKeySystemAccess = Au, e["return"](d);
        console.debug("EmeEncryptionSchemePolyfill: No native encryptionScheme support found. Patching encryptionScheme support.");
        navigator.requestMediaKeySystemAccess = Eu;
        return e["return"](Eu.call(c, a, b));
      });
    }
    ...
    function Eu(a, b) {
      ...
      return J(function (r) {
        if (1 == r.a) {
          ...
          for (g = f.next(); !g.done; g = f.next()) {
            h = g.value, k = Gu(h.videoCapabilities, d), l = Gu(h.audioCapabilities, d), h.videoCapabilities && h.videoCapabilities.length && !k.length || h.audioCapabilities && h.audioCapabilities.length && !l.length || (m = Object.assign({}, h), m.videoCapabilities = k, m.audioCapabilities = l, e.push(m));
          }
          ...
          return v(r, Au.call(c, a, e), 2);
        }

        p = r.b;
        return r["return"](new Hu(p, d));
      });
    }
    ...
    K("EmeEncryptionSchemePolyfill", zu);
    zu.install = Bu;
    ...
    function Ku() {
      Ju ? console.debug("McEncryptionSchemePolyfill: Already installed.") : navigator.mediaCapabilities ? (Ju = navigator.mediaCapabilities.decodingInfo, console.debug("McEncryptionSchemePolyfill: Waiting to detect encryptionScheme support."), navigator.mediaCapabilities.decodingInfo = Lu) : console.debug("McEncryptionSchemePolyfill: MediaCapabilities not found");
    }
    ...
    function Lu(a) {
      var b = this,
          ...
          d;
      return J(function (e) {
        if (1 == e.a) return console.assert(b == navigator.mediaCapabilities, 'bad "this" for decodingInfo'), v(e, Ju.call(b, a), 2);
        c = e.b;
        if (!a.keySystemConfiguration) return e["return"](c);
        if ((d = c.keySystemAccess) && Du(d)) return console.debug("McEncryptionSchemePolyfill: Native encryptionScheme support found."), navigator.mediaCapabilities.decodingInfo = Ju, e["return"](c);
    ...
    function Mu(a) {
      ...
      return J(function (n) {
        switch (n.a) {
          case 1:
            return console.assert(b == navigator.mediaCapabilities, 'bad "this" for decodingInfo'), c = null, a.keySystemConfiguration && (d = a.keySystemConfiguration, e = d.keySystem, f = d.audio && d.audio.encryptionScheme, g = d.video && d.video.encryptionScheme, c = Fu(e), h = {
              powerEfficient: !1,
              smooth: !1,
              supported: !1,
              keySystemAccess: null,
              configuration: a
            }, f && f != c || g && g != c) ? n["return"](h) : v(n, Ju.call(b, a), 2);

          case 2:
            k = n.b;

            if (k.keySystemAccess) {
              k.keySystemAccess = new Hu(k.keySystemAccess, c);
              n.m(3);
              break;
            }
    ...
    K("McEncryptionSchemePolyfill", Iu);
    Iu.install = Ku;
    ...
    Hu.prototype.getConfiguration = function () {
      var a = this.b.getConfiguration();
      if (a.videoCapabilities) for (var b = t(a.videoCapabilities), c = b.next(); !c.done; c = b.next()) {
        c.value.encryptionScheme = this.a;
      }
      if (a.audioCapabilities) for (b = t(a.audioCapabilities), c = b.next(); !c.done; c = b.next()) {
        c.value.encryptionScheme = this.a;
      }
      return a;
    };

    Hu.prototype.createMediaKeys = function () {
    ...
    K("EncryptionSchemePolyfills", Nu);
    Nu.install = ws;
    "undefined" !== typeof module && module.exports && (module.exports = Nu);
  }).call(exportTo, innerGlobal, innerGlobal, undefined);
  if (true) for (var k in exportTo.shaka) {
