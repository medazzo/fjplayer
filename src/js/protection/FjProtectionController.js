...
function FjProtectionController(config) {
     ...
     */
    function FJXcreateKeySession(initData) {
     ...
     * @fires ProtectionController#KeySessionClosed
     */
    function FjcloseKeySession(sessionToken) {
    ...
    function selectKeySystem(supportedKS, fromManifest) {
        ...
        var ksConfig = new KeySystemConfiguration(
            ...
            (sessionType === 'temporary') ? 'optional' : 'required', [sessionType]);
    ...
    return {
        ...
        createKeySession: FJXcreateKeySession,
...
export default FjProtectionController;